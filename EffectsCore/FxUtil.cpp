const Flash::`vftable'; int __cdecl CL_GetLocalClientNum(void) {
  UNIMPLEMENTED();
}
...
public:
void __cdecl Effect::ClearFlags(int) { UNIMPLEMENTED(); }

public:
void __cdecl Effect::SetMin(float const *const) { UNIMPLEMENTED(); }

public:
void __cdecl Effect::SetMax(float const *const) { UNIMPLEMENTED(); }

public:
void __cdecl Effect::SetOrigin1(float const *const) { UNIMPLEMENTED(); }

public:
void __cdecl Effect::SetFlags(int) { UNIMPLEMENTED(); }

public:
void __cdecl Effect::SetGroupFlags(int) { UNIMPLEMENTED(); }
...
public:
void __cdecl Effect::SetFx(struct EffectTemplate const *) { UNIMPLEMENTED(); }

public:
void __cdecl Effect::SetPrimIndex(int) { UNIMPLEMENTED(); }

public:
int __cdecl Effect::GetTimeStart(void) { UNIMPLEMENTED(); }
...
public:
int __cdecl Effect::GetPrimIndex(void) { UNIMPLEMENTED(); }

public:
void __cdecl Light::SetRandomColorsWeight(float) { UNIMPLEMENTED(); }

public:
void __cdecl Light::SetRandomSizeWeight(float) { UNIMPLEMENTED(); }

public:
static void *__cdecl Light::operator new(unsigned int) { UNIMPLEMENTED(); }

public:
__cdecl Flash::Flash(void) { UNIMPLEMENTED(); }

public:
virtual __cdecl Flash::~Flash(void) { UNIMPLEMENTED(); }

public:
virtual bool __cdecl Flash::Cull(void) { UNIMPLEMENTED(); }

public:
void __cdecl Flash::SetMaterial(struct Material *) { UNIMPLEMENTED(); }

public:
virtual void *__cdecl Flash::`vector deleting destructor'(unsigned int) {
  UNIMPLEMENTED();
}

public:
virtual void *__cdecl Flash::`scalar deleting destructor'(unsigned int) {
  UNIMPLEMENTED();
}

public:
void __cdecl Particle::SetMaterial(struct Material *) { UNIMPLEMENTED(); }

public:
void __cdecl Particle::SetGravity(float) { UNIMPLEMENTED(); }

public:
void __cdecl Particle::SetRotation(float) { UNIMPLEMENTED(); }

public:
void __cdecl Particle::SetElasticity(float) { UNIMPLEMENTED(); }

public:
void __cdecl Particle::SetNonUniformScale(bool) { UNIMPLEMENTED(); }

public:
void __cdecl Particle::SetStartFrame(int) { UNIMPLEMENTED(); }

public:
void __cdecl Particle::SetPlayRate(float) { UNIMPLEMENTED(); }

public:
void __cdecl Particle::SetLoopMode(int) { UNIMPLEMENTED(); }

public:
void __cdecl Particle::SetLoopTimes(int) { UNIMPLEMENTED(); }

public:
void __cdecl Particle::SetRandomColorsWeight(float) { UNIMPLEMENTED(); }

public:
void __cdecl Particle::SetRandomAlphaWeight(float) { UNIMPLEMENTED(); }

public:
void __cdecl Particle::SetRandomSizeWeight(float) { UNIMPLEMENTED(); }

public:
void __cdecl Particle::SetRandomSize2Weight(float) { UNIMPLEMENTED(); }

public:
void __cdecl Particle::SetRandomRotationDeltaWeight(float) { UNIMPLEMENTED(); }

public:
void __cdecl Particle::SetWindWeight(float) { UNIMPLEMENTED(); }

public:
static void *__cdecl Particle::operator new(unsigned int) { UNIMPLEMENTED(); }

public:
static void *__cdecl Cloud::operator new(unsigned int) { UNIMPLEMENTED(); }

public:
void __cdecl Line::SetOrigin2(float *const) { UNIMPLEMENTED(); }

public:
static void *__cdecl Line::operator new(unsigned int) { UNIMPLEMENTED(); }

public:
void __cdecl OrientedParticle::SetNormal(float *const) { UNIMPLEMENTED(); }
...
public:
void __cdecl Tail::SetOldOrigin(float const *const) { UNIMPLEMENTED(); }

public:
static void *__cdecl Tail::operator new(unsigned int) { UNIMPLEMENTED(); }

public:
void __cdecl Cylinder::SetNormal(float *const) { UNIMPLEMENTED(); }

public:
static void *__cdecl Cylinder::operator new(unsigned int) { UNIMPLEMENTED(); }

public:
void __cdecl Emitter::SetModel(struct XModel *) { UNIMPLEMENTED(); }

public:
void __cdecl Emitter::SetAngles(float *const) { UNIMPLEMENTED(); }

public:
void __cdecl Emitter::SetAngleDelta(float *const) { UNIMPLEMENTED(); }

public:
void __cdecl Emitter::SetEmitterFx(struct EffectTemplate *) { UNIMPLEMENTED(); }

public:
void __cdecl Emitter::SetDensity(float) { UNIMPLEMENTED(); }

public:
void __cdecl Emitter::SetVariance(float) { UNIMPLEMENTED(); }

public:
void __cdecl Emitter::SetOldTime(int) { UNIMPLEMENTED(); }

public:
void __cdecl Emitter::SetLastOrg(float const *const) { UNIMPLEMENTED(); }

public:
void __cdecl Emitter::SetLastVel(float const *const) { UNIMPLEMENTED(); }

public:
void __cdecl Emitter::SetLastBindOrg(float const *const) { UNIMPLEMENTED(); }

public:
static void *__cdecl Emitter::operator new(unsigned int) { UNIMPLEMENTED(); }

public:
int __cdecl FxArchive::UsedBytes(void) { UNIMPLEMENTED(); }
...
public:
static void __cdecl FxScheduler::operator delete(void *) { UNIMPLEMENTED(); }

void __cdecl `vector constructor
    iterator'(void *,unsigned int,int,void * (__cdecl*)(void *)) {
  UNIMPLEMENTED();
}

public:
void *__cdecl FxMemMgr<class Light>::Alloc(unsigned int) { UNIMPLEMENTED(); }

public:
void *__cdecl FxMemMgr<class Particle>::Alloc(unsigned int) { UNIMPLEMENTED(); }

public:
void *__cdecl FxMemMgr<class Cloud>::Alloc(unsigned int) { UNIMPLEMENTED(); }

public:
void *__cdecl FxMemMgr<class Line>::Alloc(unsigned int) { UNIMPLEMENTED(); }
...
public:
void *__cdecl FxMemMgr<class Tail>::Alloc(unsigned int) { UNIMPLEMENTED(); }

public:
void *__cdecl FxMemMgr<class Cylinder>::Alloc(unsigned int) { UNIMPLEMENTED(); }

public:
void *__cdecl FxMemMgr<class Emitter>::Alloc(unsigned int) { UNIMPLEMENTED(); }

void __cdecl FX_InitServer() { g_effectVisArrayCount = 0; }

void __cdecl FX_FreeEffectList(void) { UNIMPLEMENTED(); }

void __cdecl FX_EffectList_SwitchToLocalClient(int) { UNIMPLEMENTED(); }
...
void __cdecl FX_SetSortGroup(class Effect *fx) {
  ...
  if (result) {
    result =
        FxHelper::IsMaterialRefractive(theFxHelper, *(Material **)a1->mRefEnt);
    if ((_BYTE)result)
      a1->mSortGroup = -1;
  }
  return result;
...
LABEL_2:
  while (v1 < v2) {
    while (1) {
      ...
      *v6 = *((_DWORD *)effectListNonBolt + privateEffectActiveCountNonBolt);
...
LABEL_3:
  ...
  if (cullEffectCountBolt < v1) {
    ...
    for (i = 4 * cullEffectCountBolt;; i = v13) {
      ...
      if (!*(_BYTE *)(fx_cull + 8) || !(*(unsigned __int8(__cdecl **)(float *))(
                                          *(_DWORD *)v11 + 16))(v11)) {
...
LABEL_3:
  ...
  if (v1 < v0) {
    do {
      ...
      v7 = *v5;
      v8 = 4 * privateEffectActiveCountNonBolt;
      *v5 = *((_DWORD *)effectListNonBolt + privateEffectActiveCountNonBolt);
      *(_DWORD *)((char *)effectListNonBolt + v8) = v7;
      (*(void(__cdecl **)(_BYTE *))(*(_DWORD *)v6 + 8))(v6);
      if ((v6[169] & 0x10) != 0)
        --effectBlockSightCount;
    ...
    if (cullEffectCountNonBolt < v0) {
      ...
      for (i = 4 * cullEffectCountNonBolt;; i = v13) {
        ...
        if (!*(_BYTE *)(fx_cull + 8) ||
          ...
          visibleEffectsNonBolt[2 * visibleEffectCountNonBolt] = (int)v11;
          dword_4B1EC4[2 * v12] =
              Vec3DistanceSq(v11 + 31, theFxHelper->mCamera.vieworg);
...
float __cdecl FX_GetServerVisibility(float const *const start,
  ...
  v4 = 0;
  do {
    v5 = (float)((float)((float)(*(float *)&g_effectVisArray[v4] - *a1) * v12) +
...
void __cdecl FX_Stop(void) { UNIMPLEMENTED(); }
...
void __cdecl FX_DrawAll() {
  ...
  if (fx_camera_valid) {
    ...
    if (privateEffectActiveCountNonBolt > cullEffectCountNonBolt) {
      ...
      for (i = 4 * cullEffectCountNonBolt;; i = v27) {
        ...
        if (!*(_BYTE *)(fx_cull + 8) ||
            !(*(unsigned __int8(__cdecl **)(float *))(*(_DWORD *)v20 + 16))(
                v20)) {
          v21 = visibleEffectCountNonBolt;
          visibleEffectsNonBolt[2 * visibleEffectCountNonBolt] = (int)v20;
          dword_4B1EC4[2 * v21] =
  ...
  if (cullEffectCountBolt < privateEffectActiveCountBolt) {
    ...
    for (j = 4 * cullEffectCountBolt;; j = v26) {
      ...
      if (!*(_BYTE *)(fx_cull + 8) ||
          !(*(unsigned __int8(__cdecl **)(float *))(*(_DWORD *)v5 + 16))(v5)) {
  ...
  if (*(_BYTE *)(fx_sort + 8)) {
    ...
    if ((int)effectClusterCount > 0) {
      ...
      do {
        __base[2 * v24] = v24;
        *(float *)&__base[2 * v24 + 1] = Vec3DistanceSq(
            (float *)effectClusters + 4 * v24, theFxHelper->mCamera.vieworg);
        ++v24;
        v12 = effectClusterCount;
...
bool __cdecl FX_GetBoneOrientation(struct FxBoltInfo const *bolt,
  ...
  if ((a1->boneIndex & 0x80000000) != 0) {
    ...
    if (ClientDObj &&
      ...
      MatrixTransformVector43((const float *)(v7 + 16), (const float(*)[3])v24,
                              a2->origin);
...
int __cdecl FX_Restore(struct MemoryFile *memFile) { UNIMPLEMENTED(); }

int __cdecl FX_Save(struct MemoryFile *) { UNIMPLEMENTED(); }
  ...
  if (*(_BYTE *)(fx_enable + 8)) {
    ...
    if (v1) {
      do {
        ...
        v3 = *(PrimitiveTemplate **)(*(_DWORD *)v1 + 4 * *((_DWORD *)v1 + 1) +
                                     8);
        ...
        *v0 = (void *)*((_DWORD *)v1 + 19);
        ...
        if (*((int *)v1 + 3) < 0) {
          ...
          FxScheduler::CreateEffect(theFxScheduler, v2, v3,
                                    (const FxBoltInfo *)(v1 + 12),
            ...
            if (effectActiveCountBolt > 0) {
              ...
              do {
                while (1) {
                  ...
                  if (*(_DWORD *)(v6 + 172) == effectClusterCount)
                    break;
            ...
            if (effectActiveCountBolt > 0) {
              ...
              do {
                while (1) {
                  ...
                  if (*(_DWORD *)(v49 + 172) == effectClusterCount)
                    break;
  ...
  LABEL_19:
    while (1) {
      ...
      while (1) {
        ...
        *v14 = *((_DWORD *)effectListNonBolt + privateEffectActiveCountNonBolt);
            ...
            if (effectActiveCountBolt > 0) {
              ...
              do {
                while (1) {
                  ...
                  if (*(_DWORD *)(v40 + 172) == effectClusterCount)
                    break;
            ...
            if (effectActiveCountBolt > 0) {
              ...
              do {
                while (1) {
                  ...
                  if (*(_DWORD *)(v31 + 172) == effectClusterCount)
                    break;
...
void __cdecl FX_UpdateServerVisibility(void) { UNIMPLEMENTED(); }
...
void __cdecl FX_FreeEffectNonBolt(class Effect *, bool) { UNIMPLEMENTED(); }

void __cdecl FX_SwapNonBolt(int, int) { UNIMPLEMENTED(); }

void __cdecl FX_SwapBolt(int, int) { UNIMPLEMENTED(); }

void __cdecl FX_FreeEffectInCluster(int) { UNIMPLEMENTED(); }

void __cdecl FX_CullAllNonBolt(void) { UNIMPLEMENTED(); }

void __cdecl FX_CullAllBolt(void) { UNIMPLEMENTED(); }

void __cdecl FX_Sort(struct SortedEffect *const, int) { UNIMPLEMENTED(); }

void __cdecl FX_CheckFreeMembersNonBolt(void) { UNIMPLEMENTED(); }

void __cdecl FX_CheckFreeMembersBolt(void) { UNIMPLEMENTED(); }

void __cdecl FX_FreeMemberNonBolt(int, bool) { UNIMPLEMENTED(); }

void __cdecl FX_FreeMemberBolt(int, bool) { UNIMPLEMENTED(); }
...
void __cdecl FX_UpdateAllBeforeDrawNonBolt(int) { UNIMPLEMENTED(); }

void __cdecl FX_UpdateAllBeforeDrawBolt(int) { UNIMPLEMENTED(); }
...
void __cdecl FX_AllocError(void) { UNIMPLEMENTED(); }
