void __cdecl Com_AbortDObj() { g_bDObjInited = 0; }

void __cdecl Com_ShutdownDObj() { g_bDObjInited = 0; }

void __cdecl Com_InitDObj() { UNIMPLEMENTED(); }
...
void __cdecl Com_ClientDObjClearAllSkel() { UNIMPLEMENTED(); }

void __cdecl Com_SafeServerDObjFree(int handle) { UNIMPLEMENTED(); }

void __cdecl Com_SafeClientDObjFree(int handle) { UNIMPLEMENTED(); }

void *__cdecl DB_LoadDObjs(void *) { UNIMPLEMENTED(); }

void *__cdecl DB_SaveDObjs(void *) { UNIMPLEMENTED(); }
...
int __cdecl Com_GetFreeDObjIndex(void) { UNIMPLEMENTED(); }
