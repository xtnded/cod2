...
unsigned __int64 __cdecl MSG_ReadInt64(struct msg_t *) { UNIMPLEMENTED(); }
...
int __cdecl MSG_GetUsedBitCount(struct msg_t const *) { UNIMPLEMENTED(); }
...
int __cdecl MSG_ReadDeltaKeyByte(struct msg_t *, int, int) { UNIMPLEMENTED(); }

void __cdecl MSG_WriteDeltaKeyByte(struct msg_t *, int, int, int) {
  UNIMPLEMENTED();
}

int __cdecl MSG_ReadKey(struct msg_t *, int, int) { UNIMPLEMENTED(); }

void __cdecl MSG_WriteKey(struct msg_t *, int, int, int) { UNIMPLEMENTED(); }

int __cdecl MSG_ReadDeltaKey(struct msg_t *, int, int, int) { UNIMPLEMENTED(); }
...
void __cdecl MSG_WriteAngle(struct msg_t *, float) { UNIMPLEMENTED(); }
...
int __cdecl MSG_ReadDeltaKeyShort(struct msg_t *, int, int) { UNIMPLEMENTED(); }

void __cdecl MSG_WriteDeltaKeyShort(struct msg_t *, int, int, int) {
  UNIMPLEMENTED();
}

float __cdecl MSG_ReadAngle16(struct msg_t *) { UNIMPLEMENTED(); }

void __cdecl MSG_WriteAngle16(struct msg_t *, float) { UNIMPLEMENTED(); }
...
void __cdecl MSG_initHuffman(void) { UNIMPLEMENTED(); }
    ...
    if ((v120 & 7) == 0) {
      ...
      LABEL_59:
        ...
        LABEL_64:
          ...
          v106 = (int)*(unsigned __int8 *)(a1->data + (v125 >> 3)) >> v62;
          a1->bit = v125 + 1;
          if ((v106 & 1) == 0) {
          LABEL_69:
              ...
              LABEL_72:
                ...
                LABEL_74:
                  ...
                  while (1) {
                    ...
                    if ((v126 & 7) == 0) {
                      ...
                      LABEL_80:
                        ...
                        LABEL_83:
                          ...
                          a1->overflowed = 1;
                          v81 = v80 + 2;
                          if (v80 + 2 <= (signed int)a1->cursize) {
                          LABEL_85:
                            v82 = *(_WORD *)(a1->data + v80);
                            a1->readcount = v81;
                            goto LABEL_86;
                          }
                        LABEL_139:
                      ...
                      LABEL_137:
                        v110 =
                            (int)*(unsigned __int8 *)(a1->data + (v127 >> 3)) >>
                            v79;
                        a1->bit = v127 + 1;
                        if ((v110 & 1) != 0) {
                          v80 = a1->readcount;
                      ...
                      LABEL_87:
                        LODWORD(a4->angles[2]) = LOWORD(v78);
                        v131 = a4->buttons & 1;
                        a4->buttons = v131;
                        v83 = a3->buttons >> 1;
                        v128 = a1->bit;
                        ...
                        if ((v128 & 7) != 0) {
                          ...
                          LABEL_90:
                            ...
                            while (1) {
                              ...
                              if ((v128 & 7) == 0) {
                                v88 = a1->readcount;
                                if (v88 >= (signed int)a1->cursize) {
                                  a1->overflowed = 1;
                                  v89 = -1;
                                LABEL_96:
                                  v83 = v89 ^ dword_312C48 & v137;
                                LABEL_97:
                                  a4->buttons = (2 * v83) | v131;
                                  weapon = a3->weapon;
                                  v129 = a1->bit;
                                  v91 = v129 & 7;
                                  if ((v129 & 7) != 0) {
                                    ...
                                    LABEL_100:
                                      ...
                                      while (1) {
                                        ...
                                        if ((v129 & 7) == 0) {
                                          v95 = a1->readcount;
                                          if (v95 >= (signed int)a1->cursize) {
                                            a1->overflowed = 1;
                                            v96 = -1;
                                          LABEL_106:
                                            weapon = v96 ^ dword_312C1C & v137;
                                          LABEL_107:
                                            a4->weapon = weapon;
                                            offHandIndex = a3->offHandIndex;
                                            v98 = a1->bit;
                                            v130 = v98;
                                            v99 = v98 & 7;
                                            if ((v98 & 7) == 0) {
                        ...
                        v116 =
                            (int)*(unsigned __int8 *)(a1->data + (v115 >> 3)) >>
                            v84;
                        a1->bit = ++v128;
                        if ((v116 & 1) == 0)
                          goto LABEL_97;
                    ...
                    v133 |=
                        (((int)*(unsigned __int8 *)(a1->data + (v126++ >> 3)) >>
                          v73) &
                         1)
                        << v72;
                    a1->bit = v126;
                ...
                v69 = 8 * v71;
              LABEL_133:
                v109 = (int)*(unsigned __int8 *)(a1->data + (v69 >> 3)) >> v70;
                a1->bit = ++v126;
                if ((v109 & 1) == 0) {
                  v76 = v68;
                  p_rightmove = &a4->rightmove;
...
LABEL_77:
  ...
  if (!memcmp((const char *)a2->objective, (const char *)a3->objective, 448)) {
    if (v103 < (signed int)a1->maxsize) {
      v89 = a1->bit;
      if ((v89 & 7) == 0) {
        a1->bit = 8 * v103;
        ...
        LABEL_9:
          ...
          if ((v13 & 1) == 0) {
            ...
            while (1) {
              ...
              v50 |=
                  (((int)*(unsigned __int8 *)(data + (v45++ >> 3)) >> v15) & 1)
                  << v14;
              a1->bit = v45;
              if (++v14 == 5)
                goto LABEL_15;
  ...
  LABEL_46:
    ...
    if ((v38 & 1) == 0) {
      ...
      while (1) {
        ...
        v55 |= (((int)*(unsigned __int8 *)(v48 + (v46++ >> 3)) >> v40) & 1)
               << v39;
        a1->bit = v46;
        if (++v39 == 2)
          goto LABEL_84;
...
void __cdecl MSG_ReadDeltaPlayerstate(struct msg_t *msg,
  ...
  if (cl_shownet && ((v4 = *(_DWORD *)(cl_shownet + 8), v4 > 1) || v4 == -2)) {
      ...
      LABEL_12:
        ...
        if (v11) {
          if (v11 == -100) {
            ...
            v97 = (int)*(unsigned __int8 *)(a1->data + (v98 >> 3)) >> v93;
            a1->bit = v98 + 1;
            if ((v97 & 1) == 0) {
              *v123 = 0.0;
              goto LABEL_86;
          ...
          LABEL_145:
            v113 |=
                (((int)*(unsigned __int8 *)(a1->data + (v98++ >> 3)) >> v114) &
                 1)
                << v71;
            a1->bit = v98;
            if (v112 == ++v71)
          ...
          LABEL_127:
            ...
            if ((v65 & 1) == 0) {
              ...
              while (1) {
                ...
                if ((v102 & 7) == 0) {
                  ...
                  LABEL_134:
                    ...
                    *v123 = (float)v56;
                    if (v109)
                    LABEL_137:
                      Com_Printf("%s:%i ", (const char *)*(v122 - 1), v56);
                    goto LABEL_86;
                  }
                  v102 = 8 * v68;
                  a1->bit = 8 * v68;
                ...
                v110 |=
                    (((int)*(unsigned __int8 *)(data + (v102++ >> 3)) >> v67) &
                     1)
                    << v66;
                a1->bit = v102;
                if (++v66 == 5) {
      ...
      if ((v99 & 7) == 0) {
        ...
        LABEL_36:
          ...
          for (m = 0; m != 16; ++m) {
            if (((v124 >> m) & 1) != 0) {
              v31 = a1->readcount;
              if ((signed int)(v31 + 2) > (signed int)a1->cursize) {
                a1->overflowed = 1;
                v32 = -1;
              } else {
...
LABEL_69:
  ...
  while (2) {
    ...
    while (2) {
      ...
      LABEL_74:
        v116 |=
            (((int)*(unsigned __int8 *)(a1->data + (v99++ >> 3)) >> v43) & 1)
            << v42;
        a1->bit = v99;
        if (++v42 == 3) {
          v45 = v116;
...
int *msg_hData;
short __cdecl LittleShort(short) { UNIMPLEMENTED(); }
