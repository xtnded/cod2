    ...
    if (a2->collAabbCount) {
      v14 = 0;
        while (1) {
            ...
            if (!CM_CullBox((int)a1,
                            (float *)(unk_1007E90 +
                                      32 * (v14 + a2->firstCollAabbIndex)),
                            (float *)(v6 + 12))) {
                if (*(_WORD *)(v6 + 26)) {
        ...
        if (v15 > 0.000099999997) {
          v16 = -v71;
            if ((float)-v71 < v14) {
              ...
              v31 =
                  (float)((float)((float)(v28 * a2[4]) + (float)(v29 * a2[5])) +
                          (float)(v30 * a2[6])) -
                  a2[7];
              v32 =
                  (float)((float)((float)(v28 * a2[8]) + (float)(v29 * a2[9])) +
                          (float)(v30 * a2[10])) -
                  a2[11];
              v90 = ((float)(v31 + v32) > 1.0) | (2 * (v31 < 0.0)) |
                    (4 * (v32 < 0.0));
                if (v90) {
                  v69 = v71 * v71;
                  v85 = a2;
                  v70 = 0;
                  v81 = (float *)(a3 + 4);
                  if (COERCE_UNSIGNED_INT(v31 + v32) <=
                    ...
                    if ((float)(v58 - v69) <= 0.0) {
                      ...
                      *(_DWORD *)a3 = 0;
                      ...
                      v61 = (float)(v44 * v44) - (float)(v59 * v60);
                        if (v61 > 0.0) {
                          v86 = (float)(COERCE_FLOAT(
                                            COERCE_UNSIGNED_INT(fsqrt(v61)) ^
                                            0x80000000) -
                                        v44) /
                                v60;
                            if (*(float *)a3 > v86 &&
                                fabs(
                                    (float)((float)((float)((float)(v89 +
                                                                    (float)(v78 *
                                                                            v86)) *
                                                            v36[9]) +
                                                    (float)((float)(v88 +
                              ...
                              *(float *)(a3 + 4) =
                                  (float)(v63 * v36[6]) + *(float *)(a3 + 4);
                              *(float *)(a3 + 8) =
                                  (float)(v63 * v36[7]) + v81[1];
                              v64 = (float)(v63 * v36[8]) + v81[2];
                              *(float *)(a3 + 12) = v64;
                                if (a2[2] >= 0.69999999 && v64 >= 0.0 &&
                                    v64 < 0.69999999 && v91 > v9) {
                                  *(float *)(a3 + 4) = *a2;
                                  *(_DWORD *)(a3 + 8) = *v76;
                                  *(_DWORD *)(a3 + 12) = *v77;
                                }
                                  ...
                                  *v46 = v47;
                                  ...
                                  v53 = (float)((float)(v49 * v52) +
                                    ...
                                    if (v53 < 0.0) {
                                      ...
                                      v73 = *(float *)(a1 + 52);
                                      v54 = (float)(v53 * v53) -
                                            (float)((float)(v72 - v69) * v73);
                                        if (v54 >= 0.0) {
                                          v55 = (float)((float)-fsqrt(v54) -
                                                        v53) /
                                                v73;
                                            if (*(float *)a3 > v55) {
              ...
              v17 = (float)((float)(a4 + a4) * v11) + v14;
                if (v16 < v17) {
                  ...
                  v19 = (float)((float)((float)(v83 * a2[4]) +
                                        (float)(v82 * a2[5])) +
                                (float)(v91 * a2[6])) -
                        a2[7];
                  v20 = (float)((float)((float)(v83 * a2[8]) +
                                        (float)(v82 * a2[9])) +
                                (float)(v91 * a2[10])) -
                        a2[11];
                  v68 = a2[6];
                  v21 = (float)(v68 * v18) + v19;
                    if (v21 >= 0.0 &&
                        (v22 = (float)(v18 * a2[10]) + v20, v22 >= 0.0) &&
                        (float)(v22 + v21) <= 1.0) {
                      *(float *)(a3 + 4) = v75;
                      *(float *)(a3 + 8) = a2[1];
                      *(float *)(a3 + 12) = a2[2];
