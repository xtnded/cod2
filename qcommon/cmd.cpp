void __cdecl Cmd_ForEach(void(__cdecl *)(char const *))
{
  UNIMPLEMENTED();
}
...
void __cdecl Cmd_Shutdown()
{
  void **i; // ebx
    ...
    for (i = (void **)cmd_functions; cmd_functions;
         i = (void **)cmd_functions) {
      cmd_functions = (int)*i;
      Z_FreeInternal(i[1]);
      Z_FreeInternal(i);
    }
...
void __cdecl Cbuf_InsertText(char const *)
{
  UNIMPLEMENTED();
}
...
void __cdecl Cbuf_SwitchToLocalClient(int)
{
  UNIMPLEMENTED();
}
...
cmd_function_s *__cdecl Cmd_AddCommand(char *__s1, void (*a2)(void))
{
  ...
  v2 = cmd_functions;
    if (cmd_functions) {
      ...
      if (a2)
        return (cmd_function_s *)Com_Printf(
...
bool __cdecl Cmd_ExecFromFastFile(char const *)
{
  UNIMPLEMENTED();
}

bool __cdecl Cmd_ExecFromDisk(char const *)
{
  UNIMPLEMENTED();
}
