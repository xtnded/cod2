...
void __cdecl CM_StoreLeafs(struct leafList_s *, int) { UNIMPLEMENTED(); }
...
int __cdecl CM_PointLeafnum_r(float const *const, int) { UNIMPLEMENTED(); }
      ...
      if (v16 == 4) {
        ...
        if (v25) {
          ...
          while (v20 != v25 - 1) {
            ...
            ++v20;
            v19 += 2;
            if ((float)((float)((float)(*a1 * *v21) + (float)(a1[1] * v21[1])) +
