    ...
    if (a1 == v4) {
      *((_WORD *)v3 + 4) =
      ...
      while (
          a1 !=
          (svEntity_s *)((char *)&sv +
                         372 * (unsigned __int16)v4->nextEntityInWorldSector +
                         8868))
        v4 =
            (svEntity_s *)((char *)&sv +
                           372 * (unsigned __int16)v4->nextEntityInWorldSector +
    ...
    while (1) {
      ...
      if (v7) {
        for (i = (svEntity_s *)((char *)&sv + 372 * v7 + 8868);;
             i = (svEntity_s *)((char *)&sv + 372 * nextEntityInWorldSector +
                                8868)) {
  ...
  if (*(_QWORD *)(v4 + 32)) {
    ...
    while (1) {
      ...
      if (!v23->worldSector) {
        ...
        for (j = *v15; (unsigned __int16)v14 >= (unsigned __int16)(*v15 - 1);
             j = *v15)
      ...
      a1->worldSector = 0;
      v26 = (svEntity_s *)((char *)&sv + 372 * *((unsigned __int16 *)v25 + 4) +
                           8868);
      if (a1 == v26) {
      ...
      while (1) {
        ...
        for (k = *((_WORD *)v25 + 4); k; k = v30->nextEntityInWorldSector) {
    ...
    if (a1 == v8) {
      *((_WORD *)v7 + 4) = a1->nextEntityInWorldSector;
      ...
      while (
          a1 !=
          (svEntity_s *)((char *)&sv +
                         372 * (unsigned __int16)v8->nextEntityInWorldSector +
                         8868))
        v8 =
            (svEntity_s *)((char *)&sv +
                           372 * (unsigned __int16)v8->nextEntityInWorldSector +
    ...
    while (1) {
      ...
      if (v11) {
        for (m = (svEntity_s *)((char *)&sv + 372 * v11 + 8868);;
             m = (svEntity_s *)((char *)&sv + 372 * nextEntityInWorldSector +
                                8868)) {
...
void __cdecl CM_LinkWorld() { UNIMPLEMENTED(); }
    ...
    if (nextEntityInWorldSector) {
      do {
        ...
        if ((*(_DWORD *)(v7 + 284) & v2[6]) != 0) {
          ...
          if (*(float *)(v7 + 288) <= *v8) {
            v9 = (float *)v2[1];
            if (*v9 <= *(float *)(v7 + 300) && *(float *)(v7 + 292) <= v8[1] &&
                v9[1] <= *(float *)(v7 + 304) &&
                *(float *)(v7 + 296) <= v8[2] &&
                v9[2] <= *(float *)(v7 + 308)) {
              v12 = v2[4];
              ...
              *(_DWORD *)(v2[3] + 4 * v12) =
                  1062196213 * (((char *)v6 - (char *)&unk_16A3318) >> 2);
              ++v2[4];
            }
          }
        }
...
void __cdecl CM_ClearWorld(void) { UNIMPLEMENTED(); }

void __cdecl CM_LinkStaticModel(struct cStaticModel_s *) { UNIMPLEMENTED(); }
...
void __cdecl CM_LinkStaticModels(void) { UNIMPLEMENTED(); }
