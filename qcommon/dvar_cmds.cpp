void __cdecl Dvar_ForEach(void(__cdecl *)(char const *)) { UNIMPLEMENTED(); }
...
void __cdecl SV_SetConfig(int start, int max, int bit) { UNIMPLEMENTED(); }
...
void __cdecl Dvar_Dump_f() { Com_DvarDump(PMSG_CONSOLE); }
...
void __cdecl Dvar_GetCombinedString(char *const, int) { UNIMPLEMENTED(); }
...
bool __cdecl Dvar_ToggleSimple(struct dvar_s const *) { UNIMPLEMENTED(); }
  ...
  if (Cmd_Argc() <= 1) {
    ...
    if (Var) {
      if (Cmd_Argc() == 2) {
        switch (*((_BYTE *)Var + 6)) {
        case 0:
          Dvar_SetBoolFromSource((dvar_s *)Var, *((_BYTE *)Var + 8) == 0,
        ...
        case 1:
          ...
          if (v11 > 0.0 || *((float *)Var + 6) < 1.0) {
            if (v11 == *((float *)Var + 2))
              Dvar_SetFloatFromSource((dvar_s *)Var, *((float *)Var + 6),
                                      DVAR_SOURCE_EXTERNAL);
            else
              Dvar_SetFloatFromSource((dvar_s *)Var, v11, DVAR_SOURCE_EXTERNAL);
            result = 1;
          } else {
            if (*((float *)Var + 2) == 0.0)
              Dvar_SetFloatFromSource((dvar_s *)Var, 1.0, DVAR_SOURCE_EXTERNAL);
            else
              Dvar_SetFloatFromSource((dvar_s *)Var, 0.0, DVAR_SOURCE_EXTERNAL);
            result = 1;
          }
          break;
        case 2:
        ...
        case 5:
          ...
          if (v12 > 0 || (int)Var[6] <= 0) {
            if ((const char *)v12 == Var[2])
              ...
              Dvar_SetIntFromSource((dvar_s *)Var, v12, DVAR_SOURCE_EXTERNAL);
            result = 1;
          } else {
            if (Var[2])
              Dvar_SetIntFromSource((dvar_s *)Var, 0, DVAR_SOURCE_EXTERNAL);
            else
              Dvar_SetIntFromSource((dvar_s *)Var, 1, DVAR_SOURCE_EXTERNAL);
            result = 1;
          }
          break;
        case 6:
          v13 = (int)Var[5];
          if (v13)
            Dvar_SetIntFromSource((dvar_s *)Var, (int)(Var[2] + 1) % v13,
                                  DVAR_SOURCE_EXTERNAL);
          result = 1;
          break;
        default:
        ...
        for (i = 2;; i = v2) {
          ...
          v4 = v3;
          if (*((_BYTE *)Var + 6) == 6) {
            v5 = Dvar_IndexStringToEnumString((const dvar_s *)Var, v3);
