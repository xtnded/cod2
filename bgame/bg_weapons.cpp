    ...
    if (*(int *)(v4 + 484) < 0) {
      ...
      v12 = bg_iNumWeapons;
        if (bg_iNumWeapons > 0) {
          ...
          v6 = bg_weaponDefs;
            while (1) {
              if (((*(int *)&a1->weapons[4 * (v5 >> 5)] >> (v5 & 0x1F)) & 1) ==
                  0)
                goto LABEL_4;
              v7 = (_DWORD *)v6[1];
    ...
    if (v3 < 0) {
      ...
      v10 = bg_iNumWeapons;
        if (bg_iNumWeapons > 0) {
          ...
          v5 = bg_weaponDefs;
            while (1) {
              if (((*(int *)&a1->weapons[4 * (v4 >> 5)] >> (v4 & 0x1F)) & 1) ==
                  0)
                goto LABEL_4;
              v6 = (_DWORD *)v5[1];
              if (v6[121] != v2[121])
        ...
        LABEL_19:
            if (*(_DWORD *)(v13 + 136)) {
              if (bg_iNumWeapons <= 0)
                goto LABEL_32;
              v9 = 1;
                while (((*(int *)&weapons[4 * (v9 >> 5)] >> (v9 & 0x1F)) & 1) ==
                       0) {
                LABEL_35:
                  if (bg_iNumWeapons < ++v9)
                    goto LABEL_32;
                }
                if (((*(int *)&a1->weapons[4 * (v9 >> 5)] >> (v9 & 0x1F)) &
                     1) != 0) {
                  v12 = v9;
                  v10 = v9;
                    do {
...
void __cdecl BG_WeaponFireRecoil(struct playerState_s const *ps,
                                 float *const vGunSpeed, float *const kickAVel)
{
        ...
        LABEL_17:
            if (v4[171] == 0.0) {
              ...
              v15 = 2;
                do {
                  v13 = AngleSubtract(
                      (float)*(int *)&v11->cmd[12] * 0.0054931641,
                      (float)*(int *)&v11->oldcmd[12] * 0.0054931641);
                  v9 = v9 + (float)((float)((float)(fabs(v13) * 0.0099999998) *
                                            v4[171]) /
                                    *(float *)&a2->frametime);
...
LABEL_17:
  ...
  if (!*(_DWORD *)(v14 + 632))
    ...
    if (*(_DWORD *)(v14 + 812)) {
      v15 = *(float *)(ps + 220);
      v16 = (float)((float)(*(float *)(v14 + 712) - *(float *)(v14 + 716)) *
                    v15) +
            *(float *)(v14 + 716);
      v17 = (float)((float)(*(float *)(v14 + 720) - *(float *)(v14 + 724)) *
                    v15) +
            *(float *)(v14 + 724);
    }
    else {
  ...
  fLastIdleFactor = a1->fLastIdleFactor;
    if (v19 != fLastIdleFactor) {
        if (v19 <= fLastIdleFactor) {
          a1->fLastIdleFactor = fmaxf(
              v19, fLastIdleFactor - (float)(0.5 * *(float *)&a1->frametime));
        }
        else {
  ...
  v32 = bg_weaponDefs[v28];
    if (*(_DWORD *)(v32 + 632)) {
      ...
      *(float *)&v33 = *(float *)&v33 + 0.7853981633974483 + 6.283185307179586;
      ...
      v35 = *(_DWORD *)(ps + 244);
        if (v35 == 11) {
          v34.f32[0] = (float)(0.16 * a1->xyspeed) *
                       *(float *)(bg_bobAmplitudeProne + 8);
        }
        else {
              ...
              *(float *)&v58 = v58 + v58 + 6.283185307179586;
              ...
              v60 = *(_DWORD *)(ps + 244);
                if (v60 == 11) {
                  ...
                  xyspeed_low.f32[0] =
                      xyspeed * *(float *)(bg_bobAmplitudeProne + 8);
                }
                else {
                  xyspeed_low = (__m128)LODWORD(a1->xyspeed);
                  if (v60 == 40)
              ...
              LODWORD(v78) = _mm_andnot_ps(v62, xyspeed_low).u32[0] |
                             v62.i32[0] & 0x42340000;
              v76 = sinf(v91 + v91);
...
LABEL_52:
  v39 = bg_weaponDefs[v38];
    ...
    LABEL_74:
      v51 = *(float *)(v4 + 220);
      v40 = (float)((float)(*(float *)(v39 + 712) - *(float *)(v39 + 716)) *
                    v51) +
            *(float *)(v39 + 716);
      v41 = (float)((float)(*(float *)(v39 + 720) - *(float *)(v39 + 724)) *
                    v51) +
            *(float *)(v39 + 724);
      v42 = *(_DWORD *)(v4 + 160);
      if ((v42 & 8) == 0)
    ...
    LABEL_106:
      ...
      v90 = (float)(int)(a1->time - damageTime);
        if (v88 > v90) {
          ...
          *a2 = (float)((float)((float)(v119 * v87) *
                                *(float *)&a1->v_dmg_pitch) *
                        0.5) +
                *a2;
          *v122 =
              *v122 - (float)((float)(v119 * v87) * *(float *)&a1->v_dmg_roll);
          *v121 =
              (float)((float)((float)(v119 * v87) * *(float *)&a1->v_dmg_roll) *
                      0.5) +
              *v121;
          v82 = a1->ps;
        }
          ...
          v91 = 1.0 - (float)((float)(v90 - v88) / v89);
            if (v91 > 0.0) {
              ...
              v80 = a1;
              *a2 = (float)((float)(v92 * *(float *)&a1->v_dmg_pitch) * 0.5) +
                    *a2;
              *v122 = *v122 - (float)(v92 * *(float *)&a1->v_dmg_roll);
              *v121 = (float)((float)(v92 * *(float *)&a1->v_dmg_roll) * 0.5) +
                      *v121;
              goto LABEL_112;
            }
        }
...
LABEL_116:
  v95 = bg_weaponDefs[v94];
    if (*(_DWORD *)(v95 + 812)) {
      v96 = *(float *)(v82 + 220);
      v129 = *(float *)(v95 + 1240) +
             (float)((float)(*(float *)(v95 + 1168) - *(float *)(v95 + 1240)) *
                     v96);
