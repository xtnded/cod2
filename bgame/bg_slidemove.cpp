    ...
    if (v26 && *(int *)(ps + 4) <= 5) {
      ...
      v12 = a1->ps;
        if ((*(_BYTE *)(a1->ps + 12) & 1) == 0 ||
            (Footsteps = BG_CheckProne(
                 *(_DWORD *)(v12 + 204), (const float *)(v12 + 20),
                 *(float *)(v12 + 1400), 30.0, *(float *)(v12 + 1412),
                 (float *)(v12 + 1448), (float *)(v12 + 1452),
                 (float *)(v12 + 1456), 1, 1, 0, a1->handler, PCT_CLIENT,
                 66.0)) != 0) {
          v13 = *(float *)(ps + 28) - v49;
            if (fabs(v13) > 0.5) {
              v24 = floorf(v13 + 0.5);
              Footsteps = (int)v24;
                if ((int)v24) {
                  ...
                  BG_AddPredictableEventToPlayerstate(143, v14,
                                                      (playerState_s *)ps);
                  v15 =
                      (float)((float)(1.0 -
                                      (float)(fabs(*(float *)(ps + 28) - v52) /
                                              v53[0])) *
                              0.80000001) +
                      0.19999999;
                  *v6 = v15 * *v6;
                      ...
                      Footsteps = PM_ShouldMakeFootsteps(a1);
                        if (Footsteps) {
                          ...
                          *(_DWORD *)(ps + 8) = (unsigned __int8)(int)v19;
                          LOBYTE(Footsteps) =
                              PM_FootstepEvent(a1, a2, v18, (int)v19, 1);
                        }
                    }
                }
            }
...
int __cdecl PM_VerifyPronePosition(struct pmove_t *, float *const, float *const)
{
  UNIMPLEMENTED();
}
