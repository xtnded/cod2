      ...
      if (numtouch == 32)
        ...
        if (numtouch > 0) {
            ...
            LABEL_10:
              ...
              return ((int(__cdecl *)(float *, int, int))
...
void __cdecl PM_FootstepEvent(struct pmove_t *pm, struct pml_t *pml,
                              int iOldBobCycle, int iNewBobCycle, int bFootStep)
{
  int32_t ps;            // ebx
  char result;           // al
  uint32_t surfaceFlags; // eax
              ...
              v19 = (unsigned __int8)v20;
                if ((_BYTE)v20) {
                  v21 = *(_DWORD *)(ps + 12);
                    if ((v21 & 1) != 0) {
                      v8 = v19 + 47;
                      return BG_AddPredictableEventToPlayerstate(
                          v8, 0, (playerState_s *)ps);
                    }
      ...
      result = a5;
        if (a5) {
            if ((*(_BYTE *)(ps + 12) & 0x20) != 0) {
              ...
              v28 = _mm_andnot_ps(v13, (__m128)0x41000000u).u32[0] |
                    v12 & v13.i32[0];
                ...
                if (v22.entityNum != 1022) {
                  numtouch = a1->numtouch;
                    if (numtouch != 32) {
                        if (numtouch <= 0) {
                        LABEL_31:
                          *(_DWORD *)&a1->touchents[4 * numtouch] =
                              v22.entityNum;
                          a1->numtouch = numtouch + 1;
                          goto LABEL_19;
                        }
  ...
  v8 = AngleDelta(v6, *(float *)(ps + 1416));
    if (v8 != 0.0) {
      if (fabs(v8) <= (float)(70.0 * *(float *)&a2->frametime))
        ...
        *(float *)(ps + 1416) =
            (float)((float)(70.0 * *(float *)&a2->frametime) *
                    (float)(-2 * (v8 < 0.0) + 1)) +
            *(float *)(ps + 1416);
    ...
    LABEL_45:
        ...
        LABEL_47:
          *((_DWORD *)p_viewAngleClampRange - 48) +=
          ...
          if (v21 <= 0.0)
            *((float *)p_viewAngleClampRange - 11) = AngleNormalize360Accurate(
                *((float *)p_viewAngleClampRange - 2) +
        ...
        if (v35 <= v10 && (float)-v10 <= v35 &&
          ...
          origin = a1->origin;
            ...
            if (BG_CheckProne(a1->clientNum, origin, a1->maxs[0], 30.0,
                              ...
                              a1->groundEntityNum != 1023, 0, a4, PCT_CLIENT,
                              45.0) &&
                BG_CheckProne(a1->clientNum, origin, a1->maxs[0], 30.0, v48, 0,
                              0, 0, 1, a1->groundEntityNum != 1023, 0, a4,
                              PCT_CLIENT, 45.0)) {
    ...
    LABEL_56:
      ...
      v22 = v41;
        if (v41 != 0.0) {
          ...
          v25 = 1;
            while (1) {
              v28 = BG_CheckProne(a1->clientNum, a1->origin, a1->maxs[0], 30.0,
                                  v23, 0, 0, 0, 1, a1->groundEntityNum != 1023,
                                  0, v24, PCT_CLIENT, 45.0);
                if (v28) {
    ...
    LABEL_69:
      v30 = *(float *)(bg_prone_yawcap + 8);
        ...
        LABEL_72:
          ...
          if (v31 <= 0.0)
            a1->viewangles[1] =
                AngleNormalize360Accurate(*(float *)&a1->proneDirection +
                                          *(float *)(bg_prone_yawcap + 8));
          else
            a1->viewangles[1] =
                AngleNormalize360Accurate(*(float *)&a1->proneDirection -
                                          *(float *)(bg_prone_yawcap + 8));
      ...
      v43 = AngleDelta(*(float *)&a1->proneTorsoPitch, a1->viewangles[0]);
        ...
        LABEL_78:
          ...
          if (v32 <= 0.0)
            a1->viewangles[0] = AngleNormalize180Accurate(
                *(float *)&a1->proneTorsoPitch + 45.0);
          else
            a1->viewangles[0] = AngleNormalize180Accurate(
                *(float *)&a1->proneTorsoPitch - 45.0);
        }
                        ...
                        if ((*(_DWORD *)(ps + 12) & 1) != 0) {
                          v13 = *(_DWORD *)(ps + 244);
                            if (v13 == 60) {
                              ...
                              *(_DWORD *)(ps + 244) = 11;
                              a1->proneChange = 1;
                              BG_PlayAnim((playerState_s *)ps, 0, ANIM_BP_TORSO,
                                          0, 0, 1, 1);
                          ...
                          *(_DWORD *)(ps + 244) = 40;
                          a1->proneChange = 1;
                          BG_PlayAnim((playerState_s *)ps, 0, ANIM_BP_TORSO, 0,
                                      0, 1, 1);
                        }
                        else {
                          *(_DWORD *)(ps + 244) =
                              (*(_DWORD *)(ps + 12) & 2) == 0 ? 60 : 40;
                        }
                    }
                  PM_ViewHeightAdjust(a1, a2);
                  v6 = *(_DWORD *)(ps + 244);
                    ...
                    if ((v7 & 1) != 0 && !v14) {
                      ...
                      v17 = *(float *)(ps + 20) +
                            (float)((float)(v17 - *(float *)(ps + 20)) *
                                    v16.fraction);
                      v18 = *(float *)(ps + 24) +
                            (float)((float)(v18 - *(float *)(ps + 24)) *
                                    v16.fraction);
                      v19 = *(float *)(ps + 28) +
                            (float)(v16.fraction *
                                    (float)(v19 - *(float *)(ps + 28)));
                      ((void(__cdecl *)(float *, int, int))
                           pmoveHandlers[3 * (unsigned __int8)a1->handler])(
                          &v16.fraction, (int)&v17, (int)a1->mins);
                      fraction = v16.fraction;
                      *(float *)(ps + 20) =
                          v17 + (float)((float)(*(float *)(ps + 20) - v17) *
                                        v16.fraction);
                      *(float *)(ps + 24) =
                          v18 + (float)((float)(*(float *)(ps + 24) - v18) *
                                        fraction);
                      *(float *)(ps + 28) =
                          v19 + (float)(fraction *
                                        (float)(*(float *)(ps + 28) - v19));
                      *(_DWORD *)(ps + 1412) = *(_DWORD *)(ps + 236);
                      ...
                      if (v16.startsolid || v16.fraction >= 1.0)
                        ...
                        *(float *)(ps + 1416) = PitchForYawOnNormal(
                            *(float *)(ps + 1412), v16.normal);
                      v15 = AngleDelta(*(float *)(ps + 1416),
                                       *(float *)(ps + 232));
                        if (v15 >= -45.0) {
                          if (v15 <= 45.0)
        ...
        if ((v10 & 0x20) != 0) {
          v11 = *(_DWORD *)&a1->cmd[4];
            ...
            LABEL_31:
                            ...
                            if (v16.allsolid) {
                              if ((a1->cmd[5] & 0x20) == 0)
                                BG_AddPredictableEventToPlayerstate(
                                    142, 2u, (playerState_s *)ps);
                            }
                            else {
                              BG_AnimScriptEvent((playerState_s *)ps,
                                                 ANIM_ET_PRONE_TO_CROUCH, 0, 0);
                              *(_DWORD *)(ps + 12) =
                                  *(_DWORD *)(ps + 12) & 0xFFFFFFFC | 2;
                            }
                        }
                        else {
                          BG_AnimScriptEvent((playerState_s *)ps,
                                             ANIM_ET_STAND_TO_CROUCH, 0, 0);
                          *(_DWORD *)(ps + 12) |= 2u;
                        }
                      goto LABEL_7;
                    }
                        ...
                        if ((v10 & 2) != 0) {
                          ...
                          ((void(__cdecl *)(float *, int, int))
                            ...
                            if (v16.allsolid) {
                              if ((a1->cmd[5] & 0x20) == 0)
                                BG_AddPredictableEventToPlayerstate(
                                    141, 1u, (playerState_s *)ps);
                            }
                            else {
                              BG_AnimScriptEvent((playerState_s *)ps,
                                                 ANIM_ET_CROUCH_TO_STAND, 0, 0);
                              *(_DWORD *)(ps + 12) &= ~2u;
                            }
                        }
                      goto LABEL_7;
              ...
              if (*(_DWORD *)(ps + 96) == 1023)
                goto LABEL_7;
                if (!BG_CheckProne(*(_DWORD *)(ps + 204),
                                   (const float *)(ps + 20), a1->maxs[0], 30.0,
                                   *(float *)(ps + 236), (float *)(ps + 1448),
                                   (float *)(ps + 1452), (float *)(ps + 1456),
                                   0, 1, 0, a1->handler, PCT_CLIENT, 66.0)) {
                    if (*(_DWORD *)(ps + 96) != 1023) {
                      ...
                      *(_DWORD *)(ps + 12) = v12;
                        if ((a1->cmd[5] & 0x20) == 0) {
                          if ((v12 & 2) != 0)
                            BG_AddPredictableEventToPlayerstate(
                                141, 0, (playerState_s *)ps);
                          else
                            BG_AddPredictableEventToPlayerstate(
                                140, 0, (playerState_s *)ps);
                        }
                    }
                  goto LABEL_7;
                }
