float __cdecl acos(float) { UNIMPLEMENTED(); }
...
void __cdecl Mantle_ShutdownAnims() { s_mantleAnims = 0; }
  ...
  if (*(_BYTE *)(mantle_enable + 8)) {
    ...
    if (v2.f32[0] < v5) {
      ...
      a1->viewangles[1] = AngleNormalize360Accurate(
          COERCE_FLOAT(_mm_andnot_ps(v4, v2).u32[0] | LODWORD(v3) & v4.i32[0]) +
...
void __cdecl Mantle_Move(struct pmove_t *pm, struct playerState_s *ps,
  ...
  if (*(_BYTE *)(mantle_enable + 8)) {
    ...
    v9 = XAnimGetLengthMsec(s_mantleAnims,
                            *(&s_mantleTrans + 3 * a2->mantleState.transIndex));
    if ((a2->mantleState.flags & 1) != 0)
...
void __cdecl Mantle_RegisterDvars() { UNIMPLEMENTED(); }
          ...
          if ((double)acos(v10) * 57.29577951308232 <=
            ...
            *(float *)&v12[2] = v20;
            ...
            if ((v13.surfaceFlags & 0x4000000) != 0)
              v12[12] |= 1u;
            if (!(unsigned __int8)Mantle_CheckLedge(a1, (int)v12, 60.0) &&
                !(unsigned __int8)Mantle_CheckLedge(a1, (int)v12, 40.0)) {
...
int __cdecl Mantle_GetOverLength(struct MantleState *) { UNIMPLEMENTED(); }

int __cdecl Mantle_GetUpLength(struct MantleState *) { UNIMPLEMENTED(); }

int __cdecl Mantle_GetAnim(struct MantleState *) { UNIMPLEMENTED(); }

int __cdecl Mantle_FindTransition(float, float) { UNIMPLEMENTED(); }
...
void __cdecl Mantle_GetAnimDelta(struct MantleState *, int, float *const) {
  ...
  if ((*(_BYTE *)(a1 + 12) & 1) != 0)
    ...
    v7 = 0;
  if (LengthMsec < a2) {
    XAnimGetAbsDelta(s_mantleAnims, *(&s_mantleTrans + 3 * *(_DWORD *)(a1 + 8)),
                     v9, v8, 1.0);
    XAnimGetAbsDelta(s_mantleAnims, *(&dword_30AAA4 + 3 * *(_DWORD *)(a1 + 8)),
                     v9, a3, (float)(a2 - LengthMsec) / (float)v7);
    *a3 = *a3 + v8[0];
    a3[1] = a3[1] + v8[1];
    a3[2] = a3[2] + v8[2];
    ...
    XAnimGetAbsDelta(s_mantleAnims, *(&s_mantleTrans + 3 * *(_DWORD *)(a1 + 8)),
                     v9, a3, (float)a2 / (float)LengthMsec);
    VectorAngleMultiply(a3, *(float *)a1);
  }
}
...
void __cdecl Mantle_DebugPrint(char const *) { UNIMPLEMENTED(); }
