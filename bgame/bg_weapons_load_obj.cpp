...
char const *__cdecl BG_GetWeaponTypeName(enum weapType_t) { UNIMPLEMENTED(); }

void __cdecl BG_LoadWeaponStrings() { UNIMPLEMENTED(); }

void __cdecl BG_LoadPlayerAnimTypes() { UNIMPLEMENTED(); }
...
BG_LoadDefaultWeaponDef() { UNIMPLEMENTED(); }
