void __cdecl MemFile_Shutdown(struct MemoryFile *) { UNIMPLEMENTED(); }
...
void __cdecl MemFile_ReadData(struct MemoryFile *memFile, int bytes,
                              void *data) {
  int32_t bytesUsed; // ecx
  void *result;      // eax
...
void __cdecl MemFile_SkipData(struct MemoryFile *, int) { UNIMPLEMENTED(); }
...
bool __cdecl MemFile_IsReading(struct MemoryFile *) { UNIMPLEMENTED(); }
...
bool __cdecl MemFile_IsWriting(struct MemoryFile *) { UNIMPLEMENTED(); }
