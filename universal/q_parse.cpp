...
char const *__cdecl Com_GetLastTokenPos() { return dword_30F124; }
...
void __cdecl Com_ParseSetMark(char const **text,
                              struct com_parse_mark_t *mark) {
  char *v2;   // edx
  int result; // eax
...
void __cdecl Com_SetScriptErrorPrefix(char const *) { UNIMPLEMENTED(); }

char const *__cdecl Com_ParseRestOfLine(char const **) { UNIMPLEMENTED(); }
...
int const __cdecl Com_SkipBracedSection(char const **, int) { UNIMPLEMENTED(); }
...
int marker_q_parse;
void __cdecl Com_InitParseInfo(struct parseInfo_t *) { UNIMPLEMENTED(); }

struct ParseThreadInfo *__cdecl Com_GetParseThreadInfo(void) {
  UNIMPLEMENTED();
}

char *__cdecl Com_ParseCSV(char const **, int) { UNIMPLEMENTED(); }

char const *__cdecl SkipWhitespace(char const *, int *) { UNIMPLEMENTED(); }

char *__cdecl Com_ParseExt(char const **, int) { UNIMPLEMENTED(); }
