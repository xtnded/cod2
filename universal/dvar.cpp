                                 ...
                                 unsigned char a)
{
  ...
  v14 = *(&dvarHashTable + v13);
    if (v14) {
      ...
      Dvar_SetColorFromSource(v14, (float)a9, (float)a10, (float)a11,
                              (float)a12, DVAR_SOURCE_INTERNAL);
    }
    else {
    LABEL_8:
      HIDWORD(v19) = a12;
...
void __cdecl Dvar_SetStringByName(char const *dvarName, char const *value)
{
  ...
  v14 = *(_DWORD *)(v4 + 20);
    if (v14 > 0) {
      v8 = 0;
        while (
            stricmp(__src, *(const char **)(*(_DWORD *)(v4 + 24) + 4 * v8))) {
          ++v8;
          v14 = *v13;
          if (v8 >= *v13)
            goto LABEL_14;
...
struct dvar_s const *__cdecl Dvar_RegisterVec3(char const *dvarName, float x,
                                               ...
                                               float max, unsigned short flags)
{
  ...
  v4 = *(_BYTE *)(a1 + 6);
    ...
    if (v4 <= 3u) {
      ...
      *(_DWORD *)(a1 + 16) = 0;
      v9 = *(_DWORD *)(a1 + 8);
        if (v9 && (a2 == v9 ||
                   !strcmp((const char *)a2, *(const char **)(a1 + 8))) ||
            (v9 = *(_DWORD *)(a1 + 12)) != 0 &&
                (a2 == v9 ||
    ...
    if (v14 > 3u) {
      ...
      v20 = (char *)a1[2];
        if (v20 != a1[3] && v20 != a1[4]) {
          v21 = *v20;
            if (*v20) {
              if ((v20[1] || v21 <= 47 || v21 > 57) &&
                  v20 != dvarOnOffStrings[0] && v20 != off_30A3E4)
      ...
      v32 = *(_BYTE *)LODWORD(a2);
        ...
        LABEL_59:
            if (v23 != a1[2] && v23 != a1[4]) {
              v24 = *v23;
                if (*v23) {
                  if ((v23[1] || v24 <= 47 || v24 > 57) &&
                      v40 != dvarOnOffStrings[0] && v40 != off_30A3E4)
                    Z_FreeInternal(v40);
                }
            }
          a1[3] = a1[2];
...
void __cdecl Dvar_Reregister(struct dvar_s *, char const *, unsigned char,
                             unsigned short, union DvarValue, union DvarLimits)
{
  UNIMPLEMENTED();
}
...
dvar_s *__usercall Dvar_RegisterVariant
    @<eax>(char *a1 @<eax>, int8_t a2 @<dl>, unsigned __int16 a3 @<cx>,
           DvarValue a4, DvarSetSource a5, int32_t a6)
{
  char *v7;             // edx
  char v8;              // al
  int v9;               // eax
  ...
  v10 = (int)*(&dvarHashTable + v9);
    ...
    LABEL_8:
      v11 = a2;
      if (dvarCount > 1279)
        Com_Error(0, "Can't create dvar '%s': %i dvars already exist",
                  (char)a1);
      v12 = 9 * dvarCount;
  ...
  if (((HIBYTE(v31) ^ HIBYTE(a3)) & 0x70) == 0)
    ...
    if ((v31 & 0x4000) != 0) {
      ...
      *(_DWORD *)v10 = a1;
      *(_WORD *)(v10 + 4) &= ~0x4000u;
      Dvar_MakeExplicitType((dvar_s *)a3, (const char *)a4.integer, a5, a6, v50,
                            v51);
      v31 = *(_WORD *)(v10 + 4);
    LABEL_53:
