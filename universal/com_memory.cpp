...
void *__cdecl LargeLocalGetBuf(int)
{
  UNIMPLEMENTED();
}

void __cdecl LargeLocalEnd(int)
{
  UNIMPLEMENTED();
}

int __cdecl LargeLocalBegin(int)
{
  UNIMPLEMENTED();
}
...
public:
void *__cdecl LargeLocal::GetBuf()
{
  UNIMPLEMENTED();
}

public:
__cdecl LargeLocal::~LargeLocal()
{
  UNIMPLEMENTED();
}

public:
__cdecl LargeLocal::LargeLocal(int size)
{
  UNIMPLEMENTED();
}

void *__cdecl XenonHunkMalloc(unsigned int)
{
  UNIMPLEMENTED();
}
...
void __cdecl Z_MallocFailed(int)
{
  UNIMPLEMENTED();
}
