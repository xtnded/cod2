char const *__cdecl GetBspExtension() { UNIMPLEMENTED(); }
...
int __cdecl FS_Delete(char const *) { UNIMPLEMENTED(); }
...
void __cdecl FS_Flush(int f) { return fflush(*(&fsh + 71 * a1)); }
  ...
  if (dword_FF8258[71 * a1]) {
    ...
    LABEL_3:
      ...
      if (a3) {
        ...
        LABEL_12:
          if (unzReadCurrentFile((int)*(&fsh + 71 * a1), 0, (unsigned int)v3))
            return 0;
          return -1;
        }
        if (a3 != 2)
        ...
        unzSetCurrentFileInfoPosition(*(&fsh + 71 * a1), dword_FF8250[71 * a1]);
        unzOpenCurrentFile((int)*(&fsh + 71 * a1));
      } else if (a2 < 0) {
        unzSetCurrentFileInfoPosition(*(&fsh + 71 * a1), dword_FF8250[71 * a1]);
        unzOpenCurrentFile((int)*(&fsh + 71 * a1));
...
void __cdecl FS_InitFilesystem() { UNIMPLEMENTED(); }

int com_fileAccessed;
int marker_com_files;
int fs_loadStack;
void __cdecl FS_ReplaceSeparators(char *) { UNIMPLEMENTED(); }
...
FS_Initialized() { UNIMPLEMENTED(); }

FS_UseSearchPath(searchpath_s const *pSearch) { UNIMPLEMENTED(); }

FS_LanguageHasAssets(int) { UNIMPLEMENTED(); }

FS_HandleForFile(int streamThread) { UNIMPLEMENTED(); }

FS_Remove(char const *osPath) { UNIMPLEMENTED(); }

FS_FilenameCompare(char const *s1, char const *s2) { UNIMPLEMENTED(); }

FS_PureIgnoresExtension(char const *extension) { UNIMPLEMENTED(); }

FS_ShutdownServerIwdNames() { UNIMPLEMENTED(); }

FS_ShutdownServerReferencedIwds() { UNIMPLEMENTED(); }

FS_RegisterDvars() { UNIMPLEMENTED(); }

FS_ClearIwdReferences() { UNIMPLEMENTED(); }

FS_Shutdown(int closemfp) { UNIMPLEMENTED(); }

FS_FileExists(char const *file) { UNIMPLEMENTED(); }

FS_ShortOSFilePath(char const *filename) { UNIMPLEMENTED(); }

FS_GetFileOsPath(char const *filename, char *ospath) { UNIMPLEMENTED(); }

FS_DisplayPath(int bLanguageCull) { UNIMPLEMENTED(); }

FS_Path_f() { UNIMPLEMENTED(); }

FS_FullPath_f() { UNIMPLEMENTED(); }
...
FS_SortFileList(char const **filelist, int numfiles) { UNIMPLEMENTED(); }

FS_OpenFileOverwrite(char const *qpath) { UNIMPLEMENTED(); }

FS_CopyFile(char *fromOSPath, char *toOSPath) { UNIMPLEMENTED(); }

FS_TouchFile(char const *name) { UNIMPLEMENTED(); }

FS_Startup(char const *gameName) { UNIMPLEMENTED(); }

FS_Restart(int checksumFeed) { UNIMPLEMENTED(); }

FS_ConditionalRestart(int checksumFeed) { UNIMPLEMENTED(); }
