...
void __cdecl CalcScreenX(float *x, int horzAlign) {
  ...
  case 7:
    *a1 = (float)(*a1 * *(float *)&spGlob) +
    ...
    break;
  default:
    *a1 = (float)((float)(*a1 * *(float *)&spGlob) + *(float *)&dword_F2F5C4) +
          *(float *)&dword_F2F598;
    break;
  }
  return result;
...
float __cdecl GetRealViewportHeight(void) { UNIMPLEMENTED(); }

float __cdecl GetRealViewportWidth(void) { UNIMPLEMENTED(); }

float __cdecl GetVirtualViewportHeight(void) { UNIMPLEMENTED(); }

float __cdecl GetVirtualViewportWidth(void) { UNIMPLEMENTED(); }
...
void __cdecl SetScreenScalingTypecast(float, float, float, float, float,
                                      float) {
  UNIMPLEMENTED();
}
