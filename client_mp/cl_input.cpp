...
void __cdecl CL_FinishMove(struct usercmd_s *)
{
  UNIMPLEMENTED();
}

void __cdecl CL_UpdateCmdButton(int *, int, int)
{
  UNIMPLEMENTED();
}
...
void __cdecl CL_StanceButtonUpdate(void)
{
  UNIMPLEMENTED();
}
...
float __cdecl CL_KeyState(struct kbutton_t *)
{
  UNIMPLEMENTED();
}
...
void __cdecl IN_SwitchToLocalClient(int)
{
  UNIMPLEMENTED();
}
...
void __cdecl IN_ToggleSpec_Up(void)
{
  UNIMPLEMENTED();
}

void __cdecl IN_SpecNext_Up(void)
{
  UNIMPLEMENTED();
}
...
void __cdecl IN_Crouch_Up(void)
{
  UNIMPLEMENTED();
}
...
void __cdecl IN_BreathBinoculars_Up()
{
  UNIMPLEMENTED();
}

void __cdecl IN_Binoculars_Up()
{
  UNIMPLEMENTED();
}
...
{
  return IN_KeyUp((kbutton_t *)((char *)kb + 40));
}
...
void __cdecl CL_MouseMove(struct usercmd_s *cmd)
{
  ...
  __m128 v30; // xmm1
    ...
    if (*(_BYTE *)(m_filter + 8)) {
      a2.f32[0] =
          (float)(*((_DWORD *)cl + 8567) + *((_DWORD *)cl + 8566)) * 0.5;
        ...
        if (*((__int16 *)v11 + 32) >= 0) {
          ...
          v13.i32[0] = 0;
            if (v12.f32[0] != 0.0 || a1.f32[0] != 0.0) {
                if (BYTE2(kb[9].msec)) {
                  a3->rightmove = ClampChar(
                      (int)(float)(v12.f32[0] * *(float *)(m_side + 8)) +
                      a3->rightmove);
                  a1 = (__m128)a1.u32[0];
                }
                else {
                  ...
                  v15 = v11[8579];
                    if (v15 != 0.0) {
                      ...
                      LODWORD(v18) = _mm_andnot_ps(v17, v12).u32[0] |
                                     v14.i32[0] & v17.i32[0];
                      v19 = _mm_xor_ps(v12, (__m128)xmmword_302D40);
                      v20 = v19;
                      v20.f32[0] = v19.f32[0] - v18;
                      v21 = _mm_cmplt_ss(v20, v13);
                      v14.i32[0] = _mm_andnot_ps(v21, v19).u32[0] |
                                   LODWORD(v18) & v21.i32[0];
                    }
...
void __cdecl IN_ToggleSpec_Down(void)
{
  UNIMPLEMENTED();
}

void __cdecl IN_SpecNext_Down(void)
{
  UNIMPLEMENTED();
}
...
void __cdecl IN_Crouch_Down(void)
{
  UNIMPLEMENTED();
}
...
{
  IN_KeyDown((kbutton_t *)((char *)kb + 460));
}
...
{
  IN_KeyDown((kbutton_t *)((char *)kb + 420));
}

void __cdecl IN_Activate_Down()
{
  IN_KeyDown((kbutton_t *)((char *)kb + 400));
}
...
void __cdecl IN_Binoculars_Down()
{
  IN_KeyDown(kb + 20);
}
...
{
  IN_KeyDown((kbutton_t *)((char *)kb + 340));
}

void __cdecl IN_Frag_Down()
{
  IN_KeyDown((kbutton_t *)((char *)kb + 320));
}
...
{
  IN_KeyDown((kbutton_t *)((char *)kb + 160));
}
...
{
  IN_KeyDown((kbutton_t *)((char *)kb + 140));
}

void __cdecl IN_MoveleftDown()
{
  IN_KeyDown((kbutton_t *)((char *)kb + 120));
}

void __cdecl IN_LookdownDown()
{
  IN_KeyDown((kbutton_t *)((char *)kb + 100));
}
...
{
  IN_KeyDown((kbutton_t *)((char *)kb + 60));
}

void __cdecl IN_ForwardDown()
{
  IN_KeyDown((kbutton_t *)((char *)kb + 40));
}
...
void __cdecl CL_GamepadMove(struct usercmd_s *)
{
  UNIMPLEMENTED();
}
...
int __cdecl CL_ReadyToSendPacket(void)
{
  UNIMPLEMENTED();
}
