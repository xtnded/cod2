        ...
        if (dword_14C13F8) {
          v2 = 0;
            for (i = dword_14C13F4; v2 < i; i = dword_14C13F4) {
              ...
              dword_14C13F4 = i - 1;
              *(_BYTE *)(v2 + dword_14C13FC) =
                  *(_BYTE *)(dword_14C13FC + i - 1);
              memcpy((void *)(dword_14C13F8 + (v2 << 7)),
                     (const void *)(dword_14C13F8 + (dword_14C13F4 << 7)),
                     0x80u);
            }
        LABEL_7:
    ...
    do {
        for (i = 28960; i != 28964; ++i) {
          ...
          *(_QWORD *)&v6.type = __PAIR64__(v9, 3);
          v6.port = v10;
          result =
              CL_Netchan_SendOOBPacket(15, "\xFF\xFF\xFF\xFFgetinfo xxx", v6);
        }
      --v3;
    }
  while (v3);
