...
void __cdecl CL_SetWeaponInfoMemory() { return Com_SetWeaponInfoMemory(2); }
...
void __cdecl CL_GetWorldBounds(float *const, float *const) { UNIMPLEMENTED(); }
...
void __cdecl CL_IssueDelayedDrawing(int marker) { return unk_121C728(); }

void __cdecl CL_EndDelayedDrawing(int marker) { return unk_121C724(); }

int __cdecl CL_BeginDelayedDrawing() { return unk_121C720(); }

void __cdecl CL_RenderScene(struct refdef_s const *fd) { return unk_121C71C(); }

void __cdecl CL_SwitchFog(int, int) { return unk_121C708(); }
...
void __cdecl CL_ClearScene() { return unk_121C6E8(); }
...
void __cdecl CL_SetIgnorePrecacheErrors(int) { UNIMPLEMENTED(); }

void __cdecl CL_FinishLoadingModels() { return unk_121C6C4(); }
...
char const *__cdecl CL_SurfaceTypeToName(int) { UNIMPLEMENTED(); }

int __cdecl CL_SurfaceTypeFromName(char const *) { UNIMPLEMENTED(); }

int __cdecl CL_GetUserCmdInShellshock(void) { UNIMPLEMENTED(); }
...
int __cdecl CL_GetCurrentCmdNumber() { return *((_DWORD *)cl + 75031); }
...
void __cdecl CL_GetGameState(struct gameState_t *) { UNIMPLEMENTED(); }
...
void __cdecl CL_SetViewAngles(float *const) { UNIMPLEMENTED(); }
...
void __cdecl CL_FreeWeaponInfoMemory() { Com_FreeWeaponInfoMemory(2); }
...
void __cdecl CL_SetFullScreenViewport() { UNIMPLEMENTED(); }
...
void __cdecl CL_ShutdownCGame() { UNIMPLEMENTED(); }
...
int __cdecl CL_GetSnapshot(int snapshotNumber, struct snapshot_t *snapshot) {
  ...
  *(_DWORD *)a2->serverCommandSequence = v2[2486 * v3 + 77613];
  ...
  if (v5 > 0) {
    ...
    do {
      memcpy(v6->entities,
             (char *)cl + 240 * ((v4[2483] + v7++) & 0x7FF) + 864480, 0xF0u);
  ...
  if (v8 > 0) {
    ...
    do {
      memcpy(v9->clients,
             (char *)cl + 92 * ((v4[2484] + v10++) & 0x7FF) + 1356000, 0x5Cu);
...
void __cdecl CL_CM_LoadMap(char const *mapname) { UNIMPLEMENTED(); }
...
int __cdecl CL_DObjCreateSkelForBones(struct DObj_s const *obj,
  ...
  if (v6) {
    ...
    if (SkelTimeStamp !=
      ...
      CL_DObjCreateSkelForBones(DObj_s const *, int *, int)::warnCount =
          SkelTimeStamp;
      Com_Printf("^3WARNING: CL_SKEL_MEMORY_SIZE exceeded - not calculating "
                 "skeleton\n");
    }
    return 1;
  }
...
int __cdecl CL_DObjCreateSkelForBone(struct DObj_s *obj, int boneIndex,
  ...
  if (v6) {
    ...
    if (SkelTimeStamp !=
      ...
      CL_DObjCreateSkelForBone(DObj_s *, int, int)::warnCount = SkelTimeStamp;
      Com_Printf("^3WARNING: CL_SKEL_MEMORY_SIZE exceeded - not calculating "
                 "skeleton\n");
    }
    return 1;
...
void __cdecl CL_FirstSnapshot(void) { UNIMPLEMENTED(); }
...
void __cdecl CL_SetCGameTime() { UNIMPLEMENTED(); }

char const *__cdecl CL_TimeDemoLogBaseName(void) { UNIMPLEMENTED(); }

void __cdecl CL_UpdateColorInternal(char const *, float *const) {
  UNIMPLEMENTED();
}

void __cdecl CL_UpdateTimeDemo(void) { UNIMPLEMENTED(); }

CL_SetExpectedHunkUsage(char const *mapname) { UNIMPLEMENTED(); }

CL_Material_Duplicate(Material *mtlCopy, char const *name) { UNIMPLEMENTED(); }

CL_DuplicateFont(Font_s *fontCopy, char const *name) { UNIMPLEMENTED(); }

CL_LoadSoundAliases(char const *loadspec) { UNIMPLEMENTED(); }

CL_UpdateLevelHunkUsage() { UNIMPLEMENTED(); }
