void __cdecl CL_ParseCommandString(struct msg_t *)
{
  UNIMPLEMENTED();
}
...
void __cdecl SHOWNET(struct msg_t *, char *)
{
  UNIMPLEMENTED();
}
...
LABEL_17:
    ...
    if (number != (msg_t *)&loc_1869F) {
        do {
          ...
          __src = (entityState_s
                       *)((char *)&loc_D30E0 +
                          (_DWORD)&v17[60 * ((*((_DWORD *)v35 + 2483) + v37) &
                                             0x7FF)]);
          number = (msg_t *)__src->number;
        }
...
LABEL_41:
  v19 = a8;
        ...
        while (MSG_ReadBit(v19)) {
          ...
          if ((signed int)a8->readcount > (signed int)a8->cursize)
            ...
            while ((int)v20 > (int)clientIndex) {
              ...
              v40 = (clientState_s
                         *)((char *)&loc_14B0E0 +
                            (_DWORD)&v21[23 * ((*((_DWORD *)v35 + 2484) + v39) &
                                               0x7FF)]);
              clientIndex = (msg_t *)v40->clientIndex;
            }
        LABEL_50:
    ...
    if (clientIndex != (msg_t *)&loc_1869F && !a8->overflowed) {
        do {
          ...
          v40 = (clientState_s
                     *)((char *)&loc_14B0E0 +
                        (_DWORD)&v23[23 * ((*((_DWORD *)v35 + 2484) + v39) &
                                           0x7FF)]);
          clientIndex = (msg_t *)v40->clientIndex;
  ...
  *((_DWORD *)cl + 2496) = *((_DWORD *)cl + 8);
  ...
  v31 = 1;
    while (1) {
      v32 = &v30[3 * (((unsigned __int8)*(_DWORD *)((char *)&loc_407C8 +
                                                    (_DWORD)clc) -
                       (_BYTE)v31) &
                      0x1F)];
      ...
      if (Byte == 7)
        ...
        while (Byte != 2) {
            if (Byte == 3) {
              ...
              memset(&__b, 0, sizeof(__b));
              MSG_ReadDeltaEntity(
                  a8, &__b, (entityState_s *)cl + (_DWORD)v12 + 2578, v12);
              goto LABEL_2;
            }
          Com_Error(a1, *(float *)&a2, a3, a4, a5, a6, a7, 1,
