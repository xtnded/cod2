int __cdecl UI_ClientIsInGame() { return *(_DWORD *)clc == 8; }

bool __cdecl IsPartyMemberReady(int) { UNIMPLEMENTED(); }

unsigned __int64 __cdecl GetPartyMemberXuid(int) { UNIMPLEMENTED(); }

char const *__cdecl GetPartyMemberName(int) { UNIMPLEMENTED(); }

int __cdecl GetOurPartyMemberCount(void) { UNIMPLEMENTED(); }
...
int __cdecl Key_GetCatcher() { return *((_DWORD *)cl + 1); }
...
void __cdecl LAN_CleanHostname(char const *, char *) { UNIMPLEMENTED(); }
...
bool __cdecl IsPartyMemberMuted(int) { UNIMPLEMENTED(); }
...
bool __cdecl IsPartyMemberTalking(int) { UNIMPLEMENTED(); }
...
int __cdecl CL_ShutdownUI() { UNIMPLEMENTED(); }

void __cdecl CL_XenonHudIsOffscreen(void) { UNIMPLEMENTED(); }
...
UI_LoadSoundAliases() { UNIMPLEMENTED(); }
