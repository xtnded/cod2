...
{
  return *(_DWORD *)key_overstrikeMode;
}
...
void __cdecl Field_AdjustScroll(struct field_t *edit)
{
  ...
  buffer = (char *)a1->buffer;
    if (widthInPixels >
        (float)((float)dword_121C7B4(a1->buffer, 0, v11) * v13)) {
      a1->scroll = 0;
        ...
        LABEL_9:
            while (1) {
              ...
              v6 = (float)((float)v5 * v13) -
                   (float)((float)dword_121C7B4(&buffer[a1->cursor], 0, v11) *
                           v13);
              if (v6 >= 0.0)
                break;
              scroll = a1->scroll;
        ...
        if (a2 > 31) {
          result = (int32_t)key_overstrikeMode;
            if (*(_DWORD *)key_overstrikeMode) {
              ...
              memmove(&buffer[a1->cursor + 1], &buffer[a1->cursor],
                      v5 - a1->cursor);
              cursor = a1->cursor;
              a1->buffer[cursor] = a2;
              v6 = cursor + 1;
        ...
        default:
            if (a2 == 165 || __tolower(a2) == 97 && *((_DWORD *)keys + 477)) {
              a1->cursor = 0;
                     ...
                     __tolower(a2) == 101 && *((_DWORD *)keys + 477)) {
              a1->cursor = v2;
            }
            else if (a2 == 161) {
              *(_DWORD *)key_overstrikeMode =
                  *(_DWORD *)key_overstrikeMode == 0;
            }
          break;
        }
    }
    ...
    if (a8 != 13 && a8 != 191) {
      ...
      memcpy(__dst, &g_consoleField, 0x118u);
        if (matchCount != 1 &&
          ...
          Com_sprintf((char *)g_consoleField.buffer, 0x100u, "\\%s",
                      shortestMatch);
        ...
        if (Cmd_Argc() == 1) {
          ...
          if (Cmd_Argc() != 2)
            ...
            if (v12 - 1 == v13 - 1) {
              ...
              if (!v46[0])
                goto LABEL_58;
              Con_AutoCompleteFromList(AutoCompleteFileList, v46[0], v27, __src,
                                       256);
                  ...
                  v42 = 0;
                    while (1) {
                      ...
                      if (!((v38 & 0xFFFFFF80) != 0
                                ...
                                : (_DefaultRuneLocale.__runetype[v38] >> 14) &
                                      1))
                        break;
                      ++v42;
                      --v36;
                  ...
                  v43 = 0;
                    while (1) {
                      ...
                      if (!((v34 & 0xFFFFFF80) != 0
                                ...
                                : (_DefaultRuneLocale.__runetype[v34] >> 14) &
                                      1))
                        break;
                      ++v43;
                      --v32;
...
LABEL_30:
      ...
      if (!a9)
        ...
        LABEL_21:
            ...
            LABEL_23:
              ...
              v15 = cl_bypassMouseInput &&
                    *(_BYTE *)(cl_bypassMouseInput + 8) &&
    ...
    if (a9 &&
        ((*((_BYTE *)cl + 4) & 1) != 0 || *(_BYTE *)(com_sv_running + 8) ||
          ...
          v13 = v3;
            if (v0 == 2) {
              ...
              v4 = 2;
                ...
                if (v13 != -1) {
                  ReplaceStringInternal((const char **)keys + 3 * v13 + 2,
                                        __src);
                  dvar_modifiedFlags |= 1u;
                }
            }
    ...
    if (Cmd_Argc() == 2) {
      ...
      v1 = Key_StringToKeynum((int)v0);
        if (v1 == -1) {
          ...
          ReplaceStringInternal((const char **)keys + 3 * v1 + 2,
                                (char *)&inData);
          dvar_modifiedFlags |= 1u;
        }
    }
