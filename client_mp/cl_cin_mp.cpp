void __cdecl CIN_CloseAllVideos() { UNIMPLEMENTED(); }

void __cdecl SCR_RunCinematic() { return ROQ_RunCinematic(); }

void __cdecl SCR_DrawCinematic() { return ROQ_DrawCinematic(); }
...
bool __cdecl XenonPlayCinematicCallback(void) { UNIMPLEMENTED(); }

void __cdecl CIN_UploadCinematic(int handle) {
  return ROQ_UploadCinematicFromHandle(a1);
}

void __cdecl CIN_SetLooping(int, int) { UNIMPLEMENTED(); }
...
void __cdecl CIN_PlayAttractModeMovie(void) { UNIMPLEMENTED(); }

void __cdecl CL_PlayCinematic_f() { UNIMPLEMENTED(); }
