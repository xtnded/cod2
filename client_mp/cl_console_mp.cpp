float __cdecl ceil(float) { UNIMPLEMENTED(); }

void __cdecl Vec4Scale(float const *const, float, float *const) {
  UNIMPLEMENTED();
}

int __cdecl I_strlen(char const *) { UNIMPLEMENTED(); }

bool __cdecl Con_IsActive() { return *((_BYTE *)cl + 4) & 1; }
...
void __cdecl Con_ToggleConsoleOutput() { byte_EFB21C = byte_EFB21C == 0; }
...
void __cdecl Con_OpenConsoleOutput(void) { UNIMPLEMENTED(); }

void __cdecl Con_ToggleConsole_f() { UNIMPLEMENTED(); }

void __cdecl Con_SwitchToLocalClient(int) { UNIMPLEMENTED(); }
...
void __cdecl Con_ClearSubtitles() { UNIMPLEMENTED(); }

void __cdecl Con_ClearNotify() { UNIMPLEMENTED(); }

void __cdecl Con_CloseConsole(void) { UNIMPLEMENTED(); }

void __cdecl Con_OpenConsole(void) { UNIMPLEMENTED(); }

void __cdecl Con_Close() { UNIMPLEMENTED(); }

char const *__cdecl Con_TokenizeInput() { UNIMPLEMENTED(); }
...
void __cdecl Con_DrawSolidConsole(void) { UNIMPLEMENTED(); }
...
void __cdecl Con_DrawConsole() { UNIMPLEMENTED(); }
...
LABEL_10:
  ...
  if (*a3) {
    do {
      ...
      word_EDB204[(_DWORD)qword_EFB208 + dword_EFB214 * v45] = v26 | (v53 << 8);
...
void __cdecl CL_ConsolePrint(enum print_msg_type_t type, char const *txt,
  ...
  if (a1 == PMSG_BOLDGAME) {
    v11 =
        floorf((float)(1000.0 * *(float *)(con_boldgamemessagetime + 8)) + 0.5);
    v4 = (int)v11;
    goto LABEL_6;
  }
  if (a1 == PMSG_SUBTITLE) {
...
void __cdecl Con_DrawSay(int y) {
  ...
  if ((*((_BYTE *)cl + 4) & 0x10) != 0) {
    ...
    return (void *)Field_Draw(chatField, (int)(float)((float)v7 * v8) + v5, a1,
                              1, 1, 1);
  }
  return result;
}

void __cdecl Con_Init() { UNIMPLEMENTED(); }
...
int __cdecl ConDrawInput_TextFieldFirstArgChar(void) { UNIMPLEMENTED(); }

void __cdecl ConDrawInput_Over(int) { UNIMPLEMENTED(); }

void __cdecl ConDrawInput_Newline(void) { UNIMPLEMENTED(); }

void __cdecl ConDrawInput_TextLimitChars(char const *, int,
                                         float const *const) {
  UNIMPLEMENTED();
}
...
int __cdecl ConDrawInput_TextWidth(char const *) { UNIMPLEMENTED(); }

int __cdecl ConDrawInput_TextHeight(struct Font_s *) { UNIMPLEMENTED(); }

void __cdecl CL_AddDeathMessageText(char const *, int) { UNIMPLEMENTED(); }

void __cdecl CL_AddConsoleInfoChar(int, int) { UNIMPLEMENTED(); }
...
void __cdecl Con_ClearMessageWindow(struct MessageWindow *) { UNIMPLEMENTED(); }
...
void __cdecl Con_ChatModeTeam_f(void) { UNIMPLEMENTED(); }

void __cdecl Con_ChatModePublic_f(void) { UNIMPLEMENTED(); }

void __cdecl CL_ShutdownHudMsgIconMaterials(void) { UNIMPLEMENTED(); }

char const *__cdecl Con_GetVersionString(void) { UNIMPLEMENTED(); }
...
void __cdecl Con_InitMessageBuffer(void) { UNIMPLEMENTED(); }

void __cdecl Con_UpdateMessageWindowLine(struct MessageWindow *, int, int) {
  UNIMPLEMENTED();
}

void __cdecl Con_ClearMiniConsole(void) { UNIMPLEMENTED(); }

void __cdecl Con_DrawOutputVersion(float, float, float, float) {
  UNIMPLEMENTED();
}

void __cdecl Con_DrawOutputText(float, float, float, float) { UNIMPLEMENTED(); }
...
void __cdecl ConDrawInput_CmdMatch(char const *) {
  ...
  if (!result) {
    dword_121C7BC(a1, 0x7FFFFFFF, dword_14C13C0, dword_F00250,
                  *(float *)&dword_F00254 + *(float *)&dword_F0025C, 1065353216,
                  1065353216, &con_inputCommandMatchColor, 0);
    *(float *)&dword_F00254 = *(float *)&dword_F00254 + *(float *)&dword_F0025C;
    result = dword_F00258;
...
void __cdecl ConDrawInput_DvarMatch(char const *) {
  ...
  if (!result) {
    dword_121C7BC(a1, 24, dword_14C13C0, dword_F00250,
                  *(float *)&dword_F00254 + *(float *)&dword_F0025C, 1065353216,
                  1065353216, &con_inputDvarMatchColor, 0);
    *(float *)&dword_F00250 = *(float *)&dword_F00250 + 200.0;
    ...
    dword_121C7BC(VariantString, 40, dword_14C13C0, dword_F00250,
                  *(float *)&dword_F00254 + *(float *)&dword_F0025C, 1065353216,
                  1065353216, &con_inputDvarValueColor, 0);
    *(float *)&dword_F00254 = *(float *)&dword_F00254 + *(float *)&dword_F0025C;
    result = dword_F00258;
    dword_F00250 = dword_F00258;
  }
...
void __cdecl ConDrawInput_Box(int, float const *const) { UNIMPLEMENTED(); }
...
void __cdecl Con_CheckResize(void) {
  ...
  if (v1 - 2 != dword_EFB214) {
    if (v2 <= 0) {
      ...
      v13 = &con;
      do {
        *((_WORD *)v13 + 2) = ((unsigned __int16)ColorIndex(55) << 8) | 0x20;
        v13 = (int *)((char *)v13 + 2);
      ...
      v5 = &con;
      do {
        *((_WORD *)v5 + 2) = ((unsigned __int16)ColorIndex(55) << 8) | 0x20;
        v5 = (int *)((char *)v5 + 2);
      ...
      if (v17 > 0) {
        for (i = 0; i != v17; ++i) {
          if (v18 > 0) {
            ...
            do {
              word_EDB204[v6 + v7] = *((_WORD *)__dst + v6 + v20 * (v8 % v16));
              ++v6;
            } while (v18 != v6);
          }
        }
      ...
      v9 = dword_EFB230;
      memset(*(void **)dword_EFB230, 0, 164 * *(_DWORD *)(dword_EFB230 + 8));
      *(_DWORD *)(v9 + 4) = 0;
...
void __cdecl Con_Linefeed(enum print_msg_type_t, int) { UNIMPLEMENTED(); }

void __cdecl CL_InitHudMsgIconMaterials(void) { UNIMPLEMENTED(); }
    ...
    if (!byte_F0024C ||
      ...
      *(float *)&dword_F00254 =
      ...
      if (HasLatchedValue) {
        dword_121C7BC("  latched value", 0x7FFFFFFF, dword_14C13C0,
                      dword_F00258, v4 + *(float *)&dword_F0025C, 1065353216,
                      1065353216, &con_inputDvarInactiveValueColor, 0);
        *(float *)&dword_F00250 = *(float *)&dword_F00250 + 200.0;
        v7 = Dvar_DisplayableLatchedValue(Var);
        dword_121C7BC(v7, 40, dword_14C13C0, dword_F00250,
                      *(float *)&dword_F00254 + *(float *)&dword_F0025C,
                      1065353216, 1065353216, &con_inputDvarInactiveValueColor,
                      0);
        v4 = *(float *)&dword_F00254 + *(float *)&dword_F0025C;
        *(float *)&dword_F00254 =
            *(float *)&dword_F00254 + *(float *)&dword_F0025C;
      ...
      *(float *)&dword_F00254 =
      ...
      if (Var->type == 6) {
        result = Cmd_Argc();
        if (result == 2)
          return ConDrawInput_AutoCompleteArg((char **)Var->domain.integer.max,
                                              Var->domain.integer.min);
      }
    }
  }
  return result;
  ...
  if ((*((_BYTE *)cl + 4) & 1) != 0) {
    ...
    if ((_BYTE)result) {
      ...
      *(float *)&dword_F00258 = flt_EFB220 + 6.0;
      ConDraw_Box(
          *(float **)(con_inputBoxColor + 8), (float)(flt_EFB220 + 6.0) - 6.0,
          (float)(flt_EFB224 + 6.0) - 6.0,
          (float)(flt_EFB228 - flt_EFB220) -
              (float)((float)((float)(flt_EFB220 + 6.0) - 6.0) - flt_EFB220),
          *(float *)&dword_F0025C + 12.0);
      ...
      *(float *)&dword_F00254 =
      ...
      if (v5 != 1) {
        ...
        Dvar_ForEach((void (*)(const char *))ConDrawInput_IncrMatchCounter);
        result =
            Cmd_ForEach((void (*)(const char *))ConDrawInput_IncrMatchCounter);
        ...
        if (LODWORD(conDrawInputGlob)) {
          ...
          *(float *)&dword_F00254 =
          ...
          if (SLODWORD(conDrawInputGlob) > 24) {
            v11 = va("%i matches (too many to show)", conDrawInputGlob);
            ConDraw_Box(*(float **)(con_inputHintBoxColor + 8),
          ...
          if (byte_F0024C) {
            for (i = &g_consoleField;; i = (field_t *)((char *)i + 1)) {
              ...
              if (!((v10 & 0xFFFFFF80) != 0
                        ...
                        : (_DefaultRuneLocale.__runetype[v10] >> 14) & 1))
                break;
            }
            v12 = i->buffer[0];
            if (v12) {
              buffer = i->buffer;
              while (!((v12 & 0xFFFFFF80) != 0
                           ? __maskrune(v12, 0x4000) != 0
                           : (_DefaultRuneLocale.__runetype[v12] >> 14) & 1)) {
                v12 = *++buffer;
                if (!v12)
                  goto LABEL_23;
              }
            LABEL_32:
              Dvar_ForEach(
                  (void (*)(const char *))ConDrawInput_DetailedDvarMatch);
              return Cmd_ForEach(
                  (void (*)(const char *))ConDrawInput_DetailedCmdMatch);
            }
          LABEL_23:
          ...
          return Cmd_ForEach((void (*)(const char *))ConDrawInput_CmdMatch);
        }
      }
    }
  }
