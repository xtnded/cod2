void __cdecl MemFile_WriteShort(struct MemoryFile *, short) { UNIMPLEMENTED(); }

void __cdecl MemFile_WriteInt(struct MemoryFile *, int) { UNIMPLEMENTED(); }

void __cdecl MemFile_WriteFloat(struct MemoryFile *, float) { UNIMPLEMENTED(); }

void __cdecl MemFile_WriteVec3(struct MemoryFile *, float const *const) {
  UNIMPLEMENTED();
}

short __cdecl MemFile_ReadShort(struct MemoryFile *) { UNIMPLEMENTED(); }

int __cdecl MemFile_ReadInt(struct MemoryFile *) { UNIMPLEMENTED(); }

float __cdecl MemFile_ReadFloat(struct MemoryFile *) { UNIMPLEMENTED(); }
...
void __cdecl SND_ResetPauseSettingsToDefaults(void) { UNIMPLEMENTED(); }

void __cdecl SND_SetPauseSettings(bool const *const) { UNIMPLEMENTED(); }
...
bool __cdecl SND_AnyActiveListeners(void) { UNIMPLEMENTED(); }
...
int __cdecl SND_GetLocalListenerIndex(void) { UNIMPLEMENTED(); }
  ...
  if (dword_FFEBCC + 32 > 32) {
    ...
    if ((a1 & 4) != 0) {
      if (v15) {
        v23 = 32;
        do {
          if (!(unsigned __int8)SND_IsStreamChannelFree(v23) && v23 != 32 &&
              (unsigned int)(v23 - 33) > 1)
...
void __cdecl SND_RestoreEventually(void const *, int) { UNIMPLEMENTED(); }

void __cdecl SND_ShutdownChannels() { UNIMPLEMENTED(); }
...
void __cdecl SND_SetChannelInfo(int index, int entnum,
  ...
  if (a2 > 0x3FF || (v15 = (signed int)(a3->flags & 0x780) >> 7, v15 <= 0xA) &&
                        ((1 << v15) & 0x786) != 0) {
    ...
    if (v4 > 0) {
      ...
      do {
        ...
        if ((unsigned __int8)SND_IsStreamChannelFree(v24 + 32)) {
          ...
          *(float *)&v6->fPitch = (float)SND_GetStreamChannelPlaybackRate(v7) /
                                  (float)*((int *)v26 + 851);
          ...
          *(float *)&v6->fCurVolume = StreamChannelVolume;
          ...
          if (v8 <= 0xA && ((1 << v8) & 0x786) != 0) {
            ...
            SND_GetCurrent3DPosition(*((_DWORD *)v26 + 845), v17, v28);
            v25 = Vec3Distance(v28, (float *)stru_FFDAF4.pszAliasName);
            v6->dist = (int)v25;
          }
        }
        ++v24;
      ...
      do {
        ...
        if (SND_Is2DChannelFree(v19 + 45)) {
          ...
          *(_DWORD *)v13->pszSampleName =
          ...
          if (!v15)
            v15 = *((_DWORD *)v27 + 1111);
          *(float *)&v13->fPitch = (float)v15 / (float)*((int *)v27 + 1111);
      ...
      for (i = SND_Is3DChannelFree(0);; i = SND_Is3DChannelFree(v21)) {
        if (i) {
          ...
          *(_DWORD *)v9->pszSampleName =
          ...
          if (!v12)
            v12 = *((_DWORD *)v10 + 211);
          *(float *)&v9->fPitch = (float)v12 / (float)*((int *)v10 + 211);
...
void *__cdecl DB_LoadSounds(void *) { UNIMPLEMENTED(); }
...
void __cdecl SND_PlayAmbientAlias(struct snd_alias_t const *pAlias,
  ...
  if (g_snd[0] && a1) {
    ...
    if (SoundFileName == Com_GetSoundFileName(a1) &&
        (v11 = dword_FFDB58[v5], v16 = *(_DWORD *)(v11 + 44), flags = a1->flags,
         (v16 & 1) == (flags & 1)) &&
    ...
    LABEL_6:
      ...
      if (!(unsigned __int8)SND_IsStreamChannelFree(dword_FFDA70[0] + 32)) {
        if (a2) {
          ...
          if (v10 > 0.0) {
            *((float *)&unk_FFDA50 + 2 * v8 + 3) = (float)-v10 / (float)a2;
...
void __cdecl SND_Save(struct MemoryFile *memFile) { UNIMPLEMENTED(); }
            ...
            if ((unsigned __int8)SND_ValidateSoundAliasBlend(
              ...
              if (*(_BYTE *)(snd_enable3D + 8)) {
                SND_StartAlias3DSample(
                    ...
                    v28, v26[0], (float *)&v33.pan, v33.volume, v33.pitch, 0,
                    v33.fraction, v27, v32, &v34, SASYS_CGAME);
                if (v34 >= 0) {
                  v23 = 80 * v34;
      ...
      if ((v16->flags & 0x60) == 0x20 && (v25->flags & 0x60) == 0x20) {
        if (Com_GetSoundFileMem(v16)) {
          ...
          if (v18 == Com_GetSoundFileMem(v16)) {
            if ((unsigned __int8)SND_ValidateSoundAliasBlend((int)v16, (int)v25,
                                                             0)) {
              if (*(_BYTE *)(snd_enable2D + 8)) {
                SND_StartAlias2DSample(v16, v25, v28, v26[0], v33.volume,
                                       v33.pitch, 0, v33.fraction, v27, v32,
                                       &v34, SASYS_CGAME);
                if (v34 >= 0) {
...
void *__cdecl DB_SaveSounds(void *) { UNIMPLEMENTED(); }
      ...
      if (dword_FFEBCC + 32 > 32) {
        ...
        do {
          if (!(unsigned __int8)SND_IsStreamChannelFree(v38)) {
            StreamChannelPlaybackRate = SND_GetStreamChannelPlaybackRate(v38);
            v46 = floorf((float)((float)StreamChannelPlaybackRate * v48) + 0.5);
    ...
    if (v5 < 0) {
      ...
      *((_BYTE *)v13 + 28) = 0;
      if (v13 == (int *)dword_FFDAD8) {
        ...
        *(float *)(dword_FFDAD8 + 12) =
            (float)(*(float *)(dword_FFDAD8 + 8) - *((float *)v13 + 1)) / v14;
        *(_DWORD *)(dword_FFDAD8 + 16) = v13[4];
        *(float *)(dword_FFDAD8 + 24) =
            (float)(*(float *)(dword_FFDAD8 + 20) - *((float *)v13 + 4)) / v14;
      }
    }
  } else {
...
void __cdecl SND_SetEnvironmentEffects_f() {
  ...
  if (Cmd_Argc() != 6) {
    Com_Printf("USAGE: snd_setEnvironmentEffects <const char *priority> <const "
  ...
  if (!snd_roomStrings[0]) {
  LABEL_14:
    Com_Printf("invalid roomtype string '%s', it must be one of the following "
               "strings:\n",
               v4);
...
void __cdecl SND_Init() { UNIMPLEMENTED(); }
...
void __cdecl SND_UpdateRoomEffects(int) { UNIMPLEMENTED(); }

bool __cdecl SND_IsStreamChannelPlaying(int) { UNIMPLEMENTED(); }

bool __cdecl SND_Is3DChannelPlaying(int) { UNIMPLEMENTED(); }

bool __cdecl SND_Is2DChannelPlaying(int) { UNIMPLEMENTED(); }
...
int __cdecl SND_FindFreeStreamChannel(int, int) { UNIMPLEMENTED(); }

bool __cdecl SND_IsChannelReplacable(int, int, int) { UNIMPLEMENTED(); }

int __cdecl SND_CompareReplacableChannels(int, int, int, int) {
  UNIMPLEMENTED();
}

int __cdecl SND_FindReplacableChannel(int, int, int, int) { UNIMPLEMENTED(); }

void __cdecl SND_UpdateSlaveLerp(int) { UNIMPLEMENTED(); }

int __cdecl SND_GetSoundOverlay2D(struct snd_overlay_info_t *const, int) {
  UNIMPLEMENTED();
}

void __cdecl SND_UpdateTimeScale(void) { UNIMPLEMENTED(); }

void __cdecl SND_StopBackground(int, int) { UNIMPLEMENTED(); }
...
void __cdecl SND_PauseSounds(void) {
  ...
  if (g_snd[0] && !byte_FFD802) {
    if (dword_FFEBC4 + 45 > 45) {
      ...
      do {
        if (!SND_Is2DChannelFree(v0) &&
            byte_FFDAE7[(*(_DWORD *)(*((_DWORD *)v1 + 1114) + 44) & 0x780) >>
                        7])
    ...
    if (dword_FFEBC8 > 0) {
      ...
      do {
        if (!SND_Is3DChannelFree(v4) &&
            byte_FFDAE7[(*(_DWORD *)(*((_DWORD *)v5 + 214) + 44) & 0x780) >> 7])
    ...
    if (dword_FFEBCC + 32 > 32) {
      ...
      do {
        if (!(unsigned __int8)SND_IsStreamChannelFree(v2)) {
          if (byte_FFDAE7[(*(_DWORD *)(*((_DWORD *)v3 + 854) + 44) & 0x780) >>
                          7])
...
void __cdecl SND_StopEntityChannel(int, int) { UNIMPLEMENTED(); }

void __cdecl SND_UpdateMasterVolumes(int) { UNIMPLEMENTED(); }
...
void __cdecl SND_UpdatePause(void) { UNIMPLEMENTED(); }
...
void __cdecl SND_SaveSoundAlias(struct snd_alias_t const *,
                                struct MemoryFile *) {
  UNIMPLEMENTED();
}
...
void __cdecl SND_Save2DChannel(int, struct MemoryFile *) { UNIMPLEMENTED(); }

void __cdecl SND_Save3DChannel(int, struct MemoryFile *) { UNIMPLEMENTED(); }
...
bool __cdecl SND_Restore2DChannel(struct MemoryFile *) { UNIMPLEMENTED(); }

bool __cdecl SND_Restore3DChannel(struct MemoryFile *) { UNIMPLEMENTED(); }

void __cdecl SND_UpdateAllChannels(int) { UNIMPLEMENTED(); }

int __cdecl SND_RoomtypeFromString(char const *) { UNIMPLEMENTED(); }
