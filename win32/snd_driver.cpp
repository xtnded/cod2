...
public:
unsigned long __cdecl IXAudioVoice::Release(void) { UNIMPLEMENTED(); }
...
public:
long __cdecl IXAudioVoice::GetVoiceState(unsigned char *) { UNIMPLEMENTED(); }
...
public:
long __cdecl IXAudioSourceVoice::Start(unsigned char) { UNIMPLEMENTED(); }

public:
long __cdecl IXAudioSourceVoice::Stop(unsigned char) { UNIMPLEMENTED(); }

public:
long __cdecl IXAudioSourceVoice::Discontinuity(void) { UNIMPLEMENTED(); }
...
public:
long __cdecl IXAudioSourceVoice::GetVolume(float *) { UNIMPLEMENTED(); }

public:
long __cdecl IXAudioSourceVoice::SetVolume(float) { UNIMPLEMENTED(); }

public:
long __cdecl IXAudioSourceVoice::SetPitch(float) { UNIMPLEMENTED(); }
...
LABEL_21:
  ...
  *(double *)&qword_4A3CA8 = (float)(1000.0 / (float)result);
  ...
  LABEL_3:
    v7 = a4 * a1 * a3;
    while (v7) {
      for (i = dword_4A3C9C; byte_4A3C70[dword_4A3C9C]; i = dword_4A3C9C) {
        SND_Update();
        i = dword_4A3C9C;
...
int __cdecl SND_GetDriverCPUPercentage() { return AIL_digital_CPU_percent(); }

void __cdecl SND_DriverPreUpdate(int frametime) { ; }

int __cdecl SND_GetSoundFileSize(void const *pSoundFile) { return a1[2] + 36; }
...
void __cdecl XA_PacketCacheInit(void) { UNIMPLEMENTED(); }
...
void __cdecl SND_SetStreamChannelVolume(int, float) { UNIMPLEMENTED(); }
...
void __cdecl SND_Set3DChannelVolume(int, float) { UNIMPLEMENTED(); }

float __cdecl SND_Get3DChannelVolume(int index) {
  return AIL_3D_sample_volume(*(&dword_4A3BA8 + a1));
}

void __cdecl SND_Set2DChannelVolume(int, float) { UNIMPLEMENTED(); }
...
void __cdecl XA_ShutdownChannels(void) { UNIMPLEMENTED(); }
...
void __cdecl SND_SetStreamChannelFromSaveInfo(int index,
  ...
  if (*(_DWORD *)&g_snd[80 * a1 + 852] != 2 ||
      SND_IsAliasChannel3D(
          (*(_DWORD *)(*(_DWORD *)&g_snd[80 * a1 + 856] + 44) & 0x780) >> 7)) {
...
void __cdecl SND_UpdateStreamChannel(int i, int frametime) {
  ...
  v3 = &g_snd[80 * a1];
  if (!v3[892]) {
    if (a1 > 34 || (result = (char *)SND_UpdateBackgroundVolume(a1 - 32, a2),
                    (_BYTE)result)) {
      v4 = *((_DWORD *)v3 + 214);
      ...
      if (v4) {
        if (result) {
          v17[0] = *((float *)v3 + 210);
          v16 = 1056964608;
          if (SND_IsAliasChannel3D((*(_DWORD *)(v4 + 44) & 0x780) >> 7)) {
            ...
            if (AIL_is_3D_stream(dword_4A3C28[a1 - 32])) {
              ...
              v10 =
                  *(float *)&g_snd[80 * a1 + 868] - *(float *)&g_snd[v9 + 756];
              v11 =
                  *(float *)&g_snd[80 * a1 + 872] - *(float *)&g_snd[v9 + 760];
              v12 =
                  *(float *)&g_snd[80 * a1 + 876] - *(float *)&g_snd[v9 + 764];
              AIL_set_3D_stream_position(
                  dword_4A3C28[v15],
                  -(float)((float)((float)(v10 * *(float *)&g_snd[v9 + 780]) +
                                   (float)(v11 * *(float *)&g_snd[v9 + 784])) +
                           (float)(v12 * *(float *)&g_snd[v9 + 788])),
                  (float)((float)(v10 * *(float *)&g_snd[v9 + 792]) +
                          (float)(v11 * *(float *)&g_snd[v9 + 796])) +
                      (float)(v12 * *(float *)&g_snd[v9 + 800]),
                  (float)((float)(v10 * *(float *)&g_snd[v9 + 768]) +
                          (float)(v11 * *(float *)&g_snd[v9 + 772])) +
          ...
          if (*(float *)&dword_FFDA74 == 0.0 || g_snd[80 * a1 + 893]) {
            v5 = *(_DWORD *)(v4 + 44);
          } else {
            v5 = *(_DWORD *)(v4 + 44);
            if ((v5 & 4) != 0) {
          ...
          v17[0] = *(float *)(dword_FFDA54 + 12 * ((v5 & 0x780) >> 7)) * v17[0];
          v14 = *(float *)&v16;
          v6 = v17[0] * *(float *)&dword_FFD824;
          if (*(_DWORD *)&g_snd[80 * a1 + 852] != 2 ||
              SND_IsAliasChannel3D(
                  (*(_DWORD *)(*(_DWORD *)&g_snd[80 * a1 + 856] + 44) &
                   0x780) >>
                  7)) {
            AIL_set_stream_volume_levels(dword_4A3C28[v15],
                                         v6 * (float)(1.0 - v14), v14 * v6);
          } else {
...
void __cdecl SND_ShutdownDriver() { UNIMPLEMENTED(); }

void __cdecl XA_SndStreamReadThread(void) { UNIMPLEMENTED(); }

bool __cdecl SND_InitDriver() { UNIMPLEMENTED(); }

struct dvar_s const *const snd_omnidirectionalPercentage;
struct dvar_s const *const snd_speakerConfiguration;
unsigned int __cdecl SND_HashForName(char const *) { UNIMPLEMENTED(); }

void __cdecl XA_ApplyOmnidirectionality(float **) { UNIMPLEMENTED(); }

void __cdecl XA_InitSpatializationCurves(void) { UNIMPLEMENTED(); }
...
void __cdecl XA_FreeStreamPacket(struct XaCacheEntry *) { UNIMPLEMENTED(); }

void __cdecl XA_RemoveFromFreeList(struct XaCacheEntry *) { UNIMPLEMENTED(); }
...
void __cdecl XA_CloseStreamFile(struct XaStreamReadInfo *) { UNIMPLEMENTED(); }

void __cdecl XA_CleanFilename(char *) { UNIMPLEMENTED(); }

float __cdecl XA_GetWetLevel(struct snd_alias_t const *) { UNIMPLEMENTED(); }

float __cdecl XA_GetDryLevel(struct snd_alias_t const *) { UNIMPLEMENTED(); }

int __cdecl XA_CalcTotalSamples(int, int) { UNIMPLEMENTED(); }

unsigned long __cdecl XA_GetSampleIndexFromMsec(int, int) { UNIMPLEMENTED(); }

unsigned char __cdecl XA_GetSpeakerCount(void) { UNIMPLEMENTED(); }

bool __cdecl XA_Init3D(void) { UNIMPLEMENTED(); }

void __cdecl XA_ReleaseStreamPacket(struct XaCacheEntry *) { UNIMPLEMENTED(); }

void __cdecl XA_TouchEntry(struct XaCacheEntry *) { UNIMPLEMENTED(); }
...
void __cdecl XA_SetSpatializationCurves(int) { UNIMPLEMENTED(); }

void __cdecl XA_UpdateXAudioListener(float const *const) { UNIMPLEMENTED(); }
...
struct XaCacheEntry *__cdecl XA_GetStreamPacket(struct XaStreamReadInfo *,
                                                int) {
  UNIMPLEMENTED();
}

float __cdecl XA_CalcXAudioPitch(int, unsigned long) { UNIMPLEMENTED(); }

void __cdecl XA_InitSpatializationParams(void) { UNIMPLEMENTED(); }
...
void __cdecl XA_SpatializeStreamChannel(int) { UNIMPLEMENTED(); }

void __cdecl XA_Spatialize3DChannel(int) { UNIMPLEMENTED(); }

bool __cdecl XA_Init2D(void) { UNIMPLEMENTED(); }
...
void __cdecl XA_InitChannels(void) { UNIMPLEMENTED(); }

SND_LoadSoundFile(SoundFile *soundFile) { UNIMPLEMENTED(); }
