...
int __cdecl Scr_HasSourceFiles(void) { UNIMPLEMENTED(); }
...
void __cdecl RemoveOpcodePos() { UNIMPLEMENTED(); }
...
int __cdecl Scr_GetLineNum(int, unsigned int) { UNIMPLEMENTED(); }
...
int __cdecl Scr_GetSourcePosOfType(char const *, int,
...
void __cdecl Scr_InitOpcodeLookup() { UNIMPLEMENTED(); }
