    ...
    do {
      v3 = *((_WORD *)v6 + 262528);
        if (v3) {
          ...
          v1 = SubTreeSize + MT_GetSubTreeSize(*((unsigned __int16 *)v4 + 1)) +
               1;
          v2 = v1 << v0;
        }
        else {
                    ...
                    while (1) {
                        if (v43) {
                            if (v42) {
                              ...
                              v13 = 0x10000 - v43 -
                                    ((unsigned __int8)
                                         byte_476800[(unsigned __int16)-v43 >>
                                                     8] +
                              ...
                              v45 = (unsigned __int8)((unsigned __int16)-v42 >>
                                                      8);
                              v16 = 0x10000 - v42 -
          ...
          v47 = scrMemTreeGlob[2 * v18];
            while (v47) {
                if (v46) {
                  ...
                  v26 = 0x10000 - v47 -
                        ((unsigned __int8)
                             byte_476800[(unsigned __int16)-v47 >> 8] +
                  ...
                  v29 = 0x10000 - v46 -
                        ((unsigned __int8)
                             byte_476800[(unsigned __int16)-v46 >> 8] +
          ...
          v30 = scrMemTreeGlob[2 * v6];
            while (v30) {
                if (v29) {
                  ...
                  v17 = 0x10000 - v30 -
                        ((unsigned __int8)
                             byte_476800[(unsigned __int16)-v30 >> 8] +
...
int __cdecl MT_GetScore(int)
{
  UNIMPLEMENTED();
}

void __cdecl MT_InitBits(void)
{
  UNIMPLEMENTED();
}

int __cdecl MT_GetSubTreeSize(int)
{
  UNIMPLEMENTED();
}

void __cdecl MT_RemoveHeadMemoryNode(int)
{
  UNIMPLEMENTED();
}

bool __cdecl MT_RemoveMemoryNode(int, int)
{
  UNIMPLEMENTED();
}

void __cdecl MT_AddMemoryNode(int, int)
{
  UNIMPLEMENTED();
}

void __cdecl MT_SafeFreeIndex(unsigned int)
{
  UNIMPLEMENTED();
}

void __cdecl MT_Error(char const *, int)
{
  UNIMPLEMENTED();
}

int __cdecl MT_GetSize(int)
{
  UNIMPLEMENTED();
}
