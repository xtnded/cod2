...
void __cdecl Scr_GetChecksum(int *const) { UNIMPLEMENTED(); }
...
int __cdecl GetVarType(unsigned int) { return dword_104CF08[4 * a1] & 0x1F; }

bool __cdecl IsVarFree(unsigned int id) {
  return (dword_104CF08[4 * a1] & 0x60) == 0;
}

int __cdecl Scr_GetEntNum(unsigned int) { UNIMPLEMENTED(); }

char __cdecl Scr_GetEntClassId(unsigned int) { UNIMPLEMENTED(); }

int __cdecl Scr_IsThreadAlive(unsigned int) { UNIMPLEMENTED(); }
...
void __cdecl SetNewVariableValue(unsigned int id,
...
void __cdecl AddRefToVector(float const *) { UNIMPLEMENTED(); }

int __cdecl Scr_GetRefCountToObject(unsigned int) { UNIMPLEMENTED(); }
...
void __cdecl Scr_RemoveThreadEmptyNotifyName(unsigned int) { UNIMPLEMENTED(); }
...
unsigned int __cdecl Scr_GetNumScriptVars() { return 0; }

void __cdecl Scr_DumpScriptVariables() { ; }

bool __cdecl IsObjectId(unsigned int) { UNIMPLEMENTED(); }

bool __cdecl IsObject(struct VariableValueInternal *) { UNIMPLEMENTED(); }
...
void __cdecl Var_Init() { UNIMPLEMENTED(); }

unsigned int __cdecl FindObjectVariable(unsigned int parentId,
                                        unsigned int id) {
  int v2;  // esi
  int i;   // ecx
  int *v4; // edi
...
void __cdecl AddRefToValue(int type, union VariableUnion u) { UNIMPLEMENTED(); }
      ...
      if (v2 == v3 || (dword_104CF08[4 * v3] & 0x1Fu) > 0xE || !v3) {
        ...
        while (1) {
          ...
          v6 = (float)(COERCE_FLOAT(Scr_GetObjectUsage(v5, a1)) /
                       (float)((float)*((unsigned __int16 *)v8 + 2) + 1.0)) +
               1.0;
        LABEL_13:
          a1 = v6 + v102;
          v102 = a1;
        ...
        if ((dword_104CF08[4 * v16] & 0x1F) == 1) {
          do {
            ...
            a1 = (float)(COERCE_FLOAT(Scr_GetObjectUsage(v18, a1)) /
                         (float)((float)*((unsigned __int16 *)v22 + 2) + 1.0)) +
                 1.0;
            v14 = v14 + a1;
      ...
      if (v91) {
        ...
        while (1) {
          ...
          if (*v101 == 7) {
            ...
            v46 = scrVarGlob[4 * (unsigned __int16)word_104CF0E[8 * v23]];
            v47 = v46;
            if (v23 == v46 || (dword_104CF08[4 * v46] & 0x1Fu) > 0xE || !v46) {
              v48 = 1.0;
            } else {
              v48 = 1.0;
              ...
              while (2) {
                ...
                LABEL_74:
                  a1 = 1.0;
                  v48 = v48 + 1.0;
                  v50 = scrVarGlob[4 * (unsigned __int16)word_104CF0E[8 * v47]];
                  v51 = v50;
                  if (v47 == v50)
                    break;
                  goto LABEL_75;
                }
                a1 = (float)(COERCE_FLOAT(Scr_GetObjectUsage(v49, a1)) /
                             (float)((float)*((unsigned __int16 *)v53 + 2) +
                                     1.0)) +
                     1.0;
                v48 = v48 + a1;
                v50 = scrVarGlob[4 * (unsigned __int16)word_104CF0E[8 * v47]];
                ...
                if (v47 == v50)
                  break;
              LABEL_75:
                if ((dword_104CF08[4 * v51] & 0x1Fu) <= 0xE && v50) {
                  v47 = v51;
                  v52 = 16 * v51 + 17092352;
            ...
            v100 = *v99;
            v54 = v23 + 0x10000;
            v55 = (unsigned __int16)((dword_100CEC0 + v23 + 0x10000) % 0xFFFD +
                                     1);
            ...
            if ((v56[2] & 0x60) == 0x40) {
              if (v54 != (unsigned int)v56[2] >> 8) {
                ...
                if (v103 == &scrVarGlob[4 * v55])
                  goto LABEL_81;
                while (1) {
                  v68 = &scrVarGlob[4 * LOWORD(scrVarGlob[v67])];
            ...
            if (v57) {
              ...
              v60 = scrVarGlob[4 * (unsigned __int16)word_104CF0E[8 * v59]];
              v61 = v60;
              if (v59 == v60 || (dword_104CF08[4 * v60] & 0x1Fu) > 0xE ||
                  !v60) {
                *v99 = v100 + 1.0;
                goto LABEL_39;
              }
              ...
              if ((dword_104CF08[4 * v60] & 0x1F) == 1) {
                while (1) {
                  ...
                  if ((v66[2] & 0x1F) != 0x16)
                    goto LABEL_87;
                  a1 = (float)(COERCE_FLOAT(Scr_GetObjectUsage(v62, a1)) /
                               (float)((float)*((unsigned __int16 *)v66 + 2) +
                                       1.0)) +
                       1.0;
                  v58 = v58 + a1;
                  v63 = scrVarGlob[4 * (unsigned __int16)word_104CF0E[8 * v61]];
                  v64 = v63;
                  if (v61 == v63)
                    break;
                LABEL_88:
                  if ((dword_104CF08[4 * v64] & 0x1Fu) > 0xE || !v63)
                    break;
                  v61 = v64;
                  v65 = 16 * v64 + 17092352;
        ...
        v40 = v39;
        if (v24 == v39 || (dword_104CF08[4 * v39] & 0x1Fu) > 0xE || !v39) {
          v25 = 1.0 / (float)((float)*((unsigned __int16 *)v38 + 2) + 1.0);
          goto LABEL_38;
        }
        v41 = 1.0;
        ...
        if (v40 != v43) {
          ...
          LABEL_67:
            ...
            a1 = (float)(COERCE_FLOAT(Scr_GetObjectUsage(v42, a1)) /
                         (float)((float)LOWORD(dword_104CF04[4 * v42]) + 1.0)) +
                 1.0;
            v41 = v41 + a1;
            v43 = scrVarGlob[4 * (unsigned __int16)word_104CF0E[8 * v40]];
            v44 = v43;
      ...
      if (v76 == v77 || (dword_104CF08[4 * v77] & 0x1Fu) > 0xE || !v77) {
        ...
        while (1) {
          ...
          if ((dword_104CF08[4 * v78] & 0x1F) == 1) {
            ...
            v84 = scrVarGlob[4 * (unsigned __int16)word_104CF0E[8 * v83]];
            v85 = v84;
            if (v83 == v84 || (dword_104CF08[4 * v84] & 0x1Fu) > 0xE || !v84) {
              v86 = 1.0;
            } else {
              v86 = 1.0;
              while (1) {
                if ((dword_104CF08[4 * v85] & 0x1F) == 1 &&
                    (v88 = &scrVarGlob[4 * dword_104CF04[4 * v85]],
                     (v88[2] & 0x1F) == 0x16)) {
                  v79 = (float)(COERCE_FLOAT(Scr_GetObjectUsage(
                                    dword_104CF04[4 * v85], v79)) /
                                (float)((float)*((unsigned __int16 *)v88 + 2) +
                                        1.0)) +
                        1.0;
                } else {
                  v79 = 1.0;
                ...
                v86 = v86 + v79;
                v87 = scrVarGlob[4 * (unsigned __int16)word_104CF0E[8 * v85]];
                if (v85 == v87 || (dword_104CF08[4 * v87] & 0x1Fu) > 0xE ||
                    !v87)
                  break;
                v85 = v87;
              }
          ...
          if (v78 == v80 || (dword_104CF08[4 * v80] & 0x1Fu) > 0xE || !v80)
            break;
          v78 = v80;
        }
        Com_Printf("ent type '%s'... count: %d, var usage: %d\n",
...
unsigned int __cdecl AllocThread(unsigned int self) { UNIMPLEMENTED(); }

unsigned int __cdecl Scr_AllocArray() { UNIMPLEMENTED(); }

unsigned int __cdecl AllocObject() { UNIMPLEMENTED(); }

unsigned int __cdecl AllocValue() { UNIMPLEMENTED(); }

unsigned int __cdecl Scr_InitStringSet(void) { UNIMPLEMENTED(); }

void __cdecl Scr_SetClassMap(int classnum) { UNIMPLEMENTED(); }

unsigned int __cdecl GetArray(unsigned int id) { UNIMPLEMENTED(); }

unsigned int __cdecl GetObject(unsigned int) { UNIMPLEMENTED(); }
...
float const *__cdecl Scr_AllocVector(float const *v) { UNIMPLEMENTED(); }

void __cdecl FreeValue(unsigned int id) { UNIMPLEMENTED(); }

void __cdecl Scr_RemoveThreadNotifyName(unsigned int startLocalId) {
  UNIMPLEMENTED();
}

void __cdecl Var_Shutdown() { UNIMPLEMENTED(); }

void __cdecl Scr_CopyEntityNum(int, int, int) { UNIMPLEMENTED(); }

void __cdecl Scr_ClearVector(struct VariableValue_s *) { UNIMPLEMENTED(); }

bool __cdecl Scr_CastString(struct VariableValue_s *value) { UNIMPLEMENTED(); }

void __cdecl Scr_CastBool(struct VariableValue_s *value) { UNIMPLEMENTED(); }
...
void __cdecl Scr_EvalBoolNot(struct VariableValue_s *value) { UNIMPLEMENTED(); }

void __cdecl ClearVariableValue(unsigned int id) { UNIMPLEMENTED(); }

void __cdecl SetVariableValue(unsigned int id, struct VariableValue_s *value) {
  UNIMPLEMENTED();
}

void __cdecl SetEmptyArray(unsigned int) { UNIMPLEMENTED(); }
...
void __cdecl Scr_CastVector(struct VariableValue_s *value) { UNIMPLEMENTED(); }
...
void __cdecl RemoveNextVariable(unsigned int parentId) { UNIMPLEMENTED(); }

void __cdecl RemoveVariable(unsigned int, unsigned int) { UNIMPLEMENTED(); }
...
void __cdecl ClearObject(unsigned int parentId) { UNIMPLEMENTED(); }

void __cdecl Scr_FreeGameVariable(int bComplete) { UNIMPLEMENTED(); }

void __cdecl Scr_FreeEntityNum(int entnum, int classnum) { UNIMPLEMENTED(); }
...
void __cdecl RemoveRefToObject(unsigned int id) { UNIMPLEMENTED(); }

void __cdecl Scr_KillEndonThread(unsigned int threadId) { UNIMPLEMENTED(); }

void __cdecl Scr_ShutdownStringSet(unsigned int) { UNIMPLEMENTED(); }

void __cdecl Scr_FreeValue(unsigned int id) { UNIMPLEMENTED(); }
...
void __cdecl Scr_RemoveClassMap(int classnum) { UNIMPLEMENTED(); }
...
void __cdecl Scr_KillThread(unsigned int parentId) { UNIMPLEMENTED(); }

void __cdecl Scr_StopThread(unsigned int threadId) { UNIMPLEMENTED(); }
...
void __cdecl Scr_FreeObjects() { UNIMPLEMENTED(); }

void __cdecl Scr_FreeEntityList() { UNIMPLEMENTED(); }
...
bool __cdecl Scr_AddStringSet(unsigned int, char const *) { UNIMPLEMENTED(); }
...
void __cdecl FreeVariable(unsigned int) { UNIMPLEMENTED(); }

unsigned int __cdecl FindVariableIndexInternal2(unsigned int, unsigned int) {
  UNIMPLEMENTED();
}

void __cdecl InitVariables(void) { UNIMPLEMENTED(); }
...
float __cdecl Scr_GetObjectUsage(unsigned int) { UNIMPLEMENTED(); }

unsigned int __cdecl FindArrayVariableIndex(unsigned int, unsigned int) {
  UNIMPLEMENTED();
}

float __cdecl Scr_GetEndonUsage(unsigned int) { UNIMPLEMENTED(); }

float __cdecl Scr_GetThreadUsage(class VariableStackBuffer const *, float *) {
  UNIMPLEMENTED();
}

unsigned short __cdecl AllocVariable(void) { UNIMPLEMENTED(); }
...
unsigned int __cdecl AllocEntity(int, unsigned short) { UNIMPLEMENTED(); }
...
void __cdecl CopyArray(unsigned int, unsigned int) { UNIMPLEMENTED(); }
...
void __cdecl CopyEntity(unsigned int, unsigned int) { UNIMPLEMENTED(); }
...
unsigned int __cdecl Scr_FindArrayIndex(unsigned int,
...
void __cdecl ClearObjectInternal(unsigned int) { UNIMPLEMENTED(); }

int __cdecl Scr_MakeValuePrimitive(unsigned int) { UNIMPLEMENTED(); }
...
void __cdecl Scr_ClearThread(unsigned int) { UNIMPLEMENTED(); }
...
void __cdecl Scr_AddFieldsForFile(char const *) { UNIMPLEMENTED(); }

GetObjectA(unsigned int id) { UNIMPLEMENTED(); }
