...
int __cdecl Scr_IsInScriptMemory(char const *) { UNIMPLEMENTED(); }
...
void __cdecl Scr_BeginLoadAnimTrees(int user) { UNIMPLEMENTED(); }

void __cdecl Scr_BeginLoadScriptsRemote(void) { UNIMPLEMENTED(); }
...
void __cdecl Scr_EndLoadScripts() { UNIMPLEMENTED(); }

void __cdecl Scr_EndLoadAnimTrees() { UNIMPLEMENTED(); }

void __cdecl Scr_FreeScripts(unsigned char sys) { UNIMPLEMENTED(); }
...
unsigned int __cdecl Scr_LoadScript(char const *filename) { UNIMPLEMENTED(); }

int marker_scr_main;
void __cdecl SL_EndLoadScripts(void) { UNIMPLEMENTED(); }

void __cdecl SL_BeginLoadScripts(void) { UNIMPLEMENTED(); }
