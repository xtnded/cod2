void __cdecl SL_Shutdown() { byte_3F6680 = 0; }

void __cdecl SL_TransferSystem(unsigned int, unsigned int) { UNIMPLEMENTED(); }
...
void __cdecl SL_RemoveRefToString(unsigned int stringValue) { UNIMPLEMENTED(); }

void __cdecl SL_ShutdownSystem(unsigned int user) { UNIMPLEMENTED(); }
...
void __cdecl Scr_ShutdownGameStrings() { UNIMPLEMENTED(); }
...
void __cdecl SL_Init() { UNIMPLEMENTED(); }
...
int __cdecl SL_GetRefStringLen(class RefString *) { UNIMPLEMENTED(); }
...
void __cdecl SL_Clear(void) { UNIMPLEMENTED(); }

void __cdecl SL_FreeString(unsigned int, class RefString *, unsigned int) {
  UNIMPLEMENTED();
}

void __cdecl SL_RemoveAllRefToString(unsigned int) { UNIMPLEMENTED(); }
...
void __cdecl SL_Restart(void) { UNIMPLEMENTED(); }
