...
void UI_LoadArenas(void) {
  ...
  if (FileList > 0) {
    ...
    for (i = 0; i != FileList; ++i) {
      ...
      if (v24) {
        if (v16 > 0x1FFF) {
          Com_Printf("^1file too large: %s is %i, max allowed is %i", v23, v16,
                     0x2000);
          FS_FCloseFile(v24);
        } else {
          FS_Read(v21, v16, v24);
          v21[v16] = 0;
          FS_FCloseFile(v24);
          ui_numArenas += UI_ParseInfos(v21, 64 - ui_numArenas,
...
//----- (0017F77E) --------------------------------------------------------
int Key_GetCatcher(void) { return *((_DWORD *)cl + 1); }
...
//----- (0017F934) --------------------------------------------------------
_BOOL4 UI_ClientIsInGame(void) { return *(_DWORD *)clc == 8; }
...
//----- (0017FB24) --------------------------------------------------------
int __cdecl LAN_CompareServers(int a1, int a2, int a3, int a4,
                               unsigned int a5) {
  char *v5;            // esi
  char *v6;            // ebx
  int v7;              // edx
...
int32_t __usercall BG_UpdatePlayerDObj
  ...
  do {
    ...
    *((_DWORD *)v11 - 24) = (*(int(__cdecl **)(char *))((char *)&loc_B3BEC +
                                                        bgs))(attachModelNames);
...
LABEL_22:
  if (v45) {
    if (a2 == a1 + 224) {
      ...
      LABEL_29:
        if (a2 != a1 + 224) {
          XAnimSetCompleteGoalWeight(v43, *(unsigned __int16 *)(bgs + 736184),
                                     0x3F800000u, (float)a2[6] * 0.001,
                                     1065353216, 0,
                                     *(_DWORD *)(*(_DWORD *)v41 + 92), 0);
          XAnimSetCompleteGoalWeight(v43, *(unsigned __int16 *)(bgs + 736186),
                                     0x3C23D70Au, (float)a2[6] * 0.001,
                                     1065353216, 0,
                                     *(_DWORD *)(*(_DWORD *)v41 + 92), 0);
        }
      LABEL_31:
        ...
        if (*(float *)(v14 + 68) == 0.0 || (v15 = a2[11]) == 0) {
          ...
          if (v15 != *(_DWORD *)((char *)&loc_B3BE0 + bgs)) {
            if (v35) {
              v16 = fabs(*((float *)a2 + 9) - *(float *)&a4->name[20]);
              v17 = &a4->name[12];
              v18 = a2 + 7;
            } else {
              v18 = a2 + 7;
              v30 = Vec3Distance((float *)a2 + 7, (float *)&a4->name[12]);
              v16 = v30;
              result = bgs;
              v15 = a2[11];
              v17 = &a4->name[12];
            ...
            *((float *)a2 + 10) =
                (float)(v16 / (float)((float)(*(_DWORD *)((char *)&loc_B3BE0 +
                                                          result) -
                                              v15) *
                                      0.001)) /
                *(float *)(v14 + 68);
            ...
            if (v19 >= 0.1) {
              if (v19 > 2.0) {
                if ((*(_BYTE *)(v14 + 80) & 2) != 0) {
                  ...
                  if (v27 <= 150.0) {
                    if (v27 >= 20.0) {
                      v28 = (float)((float)(v27 - 20.0) / -130.0) + 3.0;
                      if (v19 > v28)
                        *((float *)a2 + 10) = v28;
                    } else if (v19 > 3.0) {
                      a2[10] = 1077936128;
    ...
    if (v38) {
      XAnimSetCompleteGoalWeight(v43, v45, 0x3F800000u, (float)a2[6] * 0.001,
                                 1065353216, 0, 0, 0);
    } else {
  ...
  if (a2 != a1 + 224) {
    ...
    return XAnimSetCompleteGoalWeight(v43, *(unsigned __int16 *)(bgs + 736186),
                                      0x3F800000u, (float)a2[6] * 0.001,
                                      1065353216, 0, 0, 0);
  }
  return result;
...
LABEL_11:
  ...
  LABEL_5:
    ...
    if (result) {
      ...
      v16 = BG_IndexForString(a4, a5, a6, a7, a8, a9, a10, v24,
...
int __usercall BG_ParseConditions
  ...
  while (1) {
    ...
    if (!I_stricmp(v10, "default"))
      return 1;
    v12 = BG_IndexForString(a3, a4, a5, a6, a7, a8, a9, v11, &animConditionsStr,
                            0);
    v13 = animConditionsTable[2 * v12];
    if (!v13) {
      BG_ParseConditionBits(v18, (&off_312F64)[2 * v12], v12, a3, a4, a5, a6,
                            a7, a8, a9, (const char **)&v20);
      goto LABEL_3;
    }
    if (v13 != 1)
      goto LABEL_3;
    if ((&off_312F64)[2 * v12]) {
      ...
      if (v14 && *v14) {
        ...
        if (v19[v15 - 1] != 44) {
        LABEL_13:
          v20 = (char *)BG_IndexForString(a3, a4, a5, a6, a7, a8, a9, v19,
                                          (&off_312F64)[2 * v12], 0);
          goto LABEL_3;
        }
      } else {
        ...
        *(_WORD *)&v40[2 * v41 + 8] = *((_DWORD *)v16 + 18);
        if (!g_pLoadAnims) {
          ...
          if (parseMovetype && *(_WORD *)&v40[2 * v41] != 2) {
            ...
            *((_DWORD *)v16 + 22) = v30;
            if ((unsigned int)(v29 - 18) <= 1) {
              v39 = (char *)a10 + 96 * *(__int16 *)&v40[2 * v41 + 4];
              a2 = 0.0;
              if (*((float *)v39 + 17) != 0.0)
                *((_DWORD *)v39 + 20) |= 2u;
            }
            if ((int)a9->numConditions > 0) {
              ...
              if (*(_DWORD *)a9->conditions == 8) {
                ...
                LABEL_69:
                  ...
                  *(_DWORD *)&a10->animations[v38 + 80] |= 0x10u;
                } else {
                LABEL_56:
                  if (v34 == 2) {
                    v35 = 96 * *(__int16 *)&v40[2 * v41 + 4];
                    *(_DWORD *)&a10->animations[v35 + 80] |= 0x20u;
                  }
                }
              } else {
                v32 = 0;
                while (++v32 != a9->numConditions) {
                  ...
                  if (v33 == 8) {
                    v34 = *(_DWORD *)&a9->conditions[12 * v32 + 4];
                    if (v34 == 1)
                      goto LABEL_69;
                    goto LABEL_56;
                  }
          ...
          if (parseEvent == 2) {
            ...
            *(_DWORD *)&a10
                 ->animations[96 * *(__int16 *)&v40[2 * v41 + 4] + 64] = 30;
          } else if (parseEvent == 1) {
            *(_DWORD *)&a10
                 ->animations[96 * *(__int16 *)&v40[2 * v41 + 4] + 68] = 0;
            v37 = 96 * *(__int16 *)&v40[2 * v41 + 4];
            *(_DWORD *)&a10->animations[v37 + 80] |= 0x40u;
          } else if (parseEvent == 10 || (unsigned int)(v29 - 21) <= 9) {
            *(_DWORD *)&a10
                 ->animations[96 * *(__int16 *)&v40[2 * v41 + 4] + 68] = 0;
          }
        }
            ...
            if (I_stricmp(v17, "duration")) {
              if (I_stricmp(v18, "turretanim")) {
                ...
                if (!g_pLoadAnims) {
                  ...
                  *(_DWORD *)&a10->animations[96 * v27 + 64] = atoi(v26);
                }
              } else {
                if (!g_pLoadAnims) {
...
void __cdecl UI_LoadArenasFromFile(char *) { UNIMPLEMENTED(); }
