...
bool __cdecl Window_HasFocus(struct windowDef_t const *) { UNIMPLEMENTED(); }

int __cdecl Menu_Count(struct displayContextDef_s *dc) { return a1->menuCount; }

int __cdecl Display_KeyBindPending() { return g_waitingForKey; }
...
void __cdecl Item_StopCapture(struct itemDef_s *) { UNIMPLEMENTED(); }

int __cdecl IsVisible(int) { UNIMPLEMENTED(); }
...
void __cdecl LerpColor(float *const a, float *const b, float *const c,
                       float t) {
  int i;         // edx
  float v5;      // xmm1_4
  float *result; // eax
...
int __cdecl BindingIDFromName(char const *) { UNIMPLEMENTED(); }
...
struct itemDef_s *__cdecl Menu_FindItemByName(struct menuDef_t *,
                                              char const *) {
  UNIMPLEMENTED();
}
...
void __cdecl Item_SetMouseOver(struct itemDef_s *, int) { UNIMPLEMENTED(); }
...
void __cdecl Item_UpdatePosition(struct itemDef_s *) { UNIMPLEMENTED(); }
...
void __cdecl Menus_Close(struct displayContextDef_s *dc,
  ...
  LABEL_2:
    ...
    if (result > 0) {
      ...
      while (1) {
        ...
        UI_FeederSelection(*(float *)(*(_DWORD *)(v9 + v5->items) + 728),
...
void __cdecl Menus_CloseAll(struct displayContextDef_s *dc) { UNIMPLEMENTED(); }
...
int __cdecl Color_Parse(char const **, float (*)[4]) { UNIMPLEMENTED(); }
  ...
  if (!String) {
    if ((unsigned __int8)Dvar_GetBool("loc_warnings")) {
      if ((unsigned __int8)Dvar_GetBool("loc_warningsAsErrors"))
        Com_Error(6, "Could not translate menu string reference %s", (char)v3);
      else
...
int __cdecl GetKeyBindingLocalizedString(char const *command,
                                         char *const keys) {
  int KeyBindings; // esi
  char *String;    // eax
  const char *v4;  // eax
  ...
  if (!*a3 ||
    ...
    if (type == 8) {
      if ((unsigned int)(*(_DWORD *)a2->textalignment - 1) <= 1) {
        v13 += UI_OwnerDrawWidth(a1, *(_DWORD *)&a2->window[216], FontHandle,
                                 *(float *)a2->textscale);
      LABEL_14:
        *a3 = UI_TextWidth(a1, v5, 0, FontHandle, *(float *)a2->textscale);
      ...
      if (result) {
        ...
        if (result) {
          ...
          if (result) {
            ...
            if (result)
              return Menu_OrbitItemByName((menuDef_t *)a2->parent, __s, v7, v6,
                                          v9[0], v8, v5);
          }
        }
      }
      ...
      if (result) {
        ...
        if (result) {
          ...
          if (result) {
            v5 = v7;
            v8 = v6;
            return Menu_TransitionItemByName((menuDef_t *)a2->parent, __s, v6,
                                             v7, v9, v10[0]);
          }
        }
      }
  ...
  if (result) {
    ...
    if (result) {
      ...
      if (v10 > 0) {
        for (j = 0; v10 != j; ++j) {
          result =
              Menu_GetMatchingItemByNumber((menuDef_t *)a2->parent, j, __s);
...
int __cdecl Item_TextField_HandleKey(struct displayContextDef_s *dc,
  ...
  LABEL_18:
    ...
    if (v3 != 8) {
      ...
      if (v17) {
        if (v17 <= *(_DWORD *)a2->cursorPos) {
          if (*(_DWORD *)(v4.listBox + 20)) {
            v18 = (itemDef_s *)Menu_SetNextCursorItem(a1,
                                                      (menuDef_t *)a2->parent);
    ...
    LABEL_11:
      if (v3 == 9 || v3 == 155) {
        v25 = (itemDef_s *)Menu_SetNextCursorItem(a1, (menuDef_t *)a2->parent);
        if (v25) {
...
int __cdecl Item_ListBox_HandleKey(struct displayContextDef_s *dc,
  ...
  if ((a2->window[230] & 0x20) != 0) {
    v20 = (int)(float)(*(float *)&a2->window[8] / *(float *)(v5.listBox + 52));
    if (a3 == 156) {
      if (!*(_DWORD *)(v5.listBox + 264)) {
        ...
        if (*(_DWORD *)(v5.listBox + 36) >= *(_DWORD *)v5.listBox + v20) {
          ListBox_SetStartPos((listBoxDef_s *)v5.listBox, v12 - v20 + 1);
    ...
    if (a3 == 157) {
      ...
      LABEL_17:
        Item_SetCursorPos(a2, *(_DWORD *)(v5.listBox + 36));
      LABEL_18:
        UI_FeederSelection(*(float *)a2->special, *(_DWORD *)a2->cursorPos);
        return 1;
      }
      ListBox_SetStartPos((listBoxDef_s *)v5.listBox,
                          *(_DWORD *)v5.listBox + 1);
          ...
          if ((v9 & 0x1000) == 0) {
            if ((v9 & 0x400) == 0) {
              ...
              if (realTime < lastListBoxClickTime &&
                  ...
                  *(_DWORD *)a2->cursorPos == *(_DWORD *)(v5.listBox + 36)) {
                if (ListBox_HasValidCursorPos((const listBoxDef_s *)v5.listBox))
                  Item_RunScript(a1, a2, *(const char **)(v5.listBox + 260));
                realTime = a1->realTime;
              }
...
int __cdecl Item_ListBox_ThumbDrawPosition(struct displayContextDef_s *dc,
  ...
  if ((a2->window[230] & 0x20) != 0) {
    v3 = (int)(float)((float)((float)(*(float *)a2->window +
                      ...
                      1.0);
    cursorx = a1->cursorx;
    if (cursorx < (int)(float)((float)(*(float *)a2->window + 16.0) + 1.0) + 8)
    ...
    if ((a1->staticFlags & 0x200000) != 0) {
      if ((*(_DWORD *)a1->dynamicFlags & 0x1F00) == 0 &&
        ...
        *(_QWORD *)v18 = a2;
        ...
        CalcScreenY(&v18[1], 4);
        result =
            (listBoxDef_s *)CalcScreenPlacement(&v14, &v15, &v16, v17, v12, v5);
        if (v18[0] >= v14 && (float)(v14 + v16) >= v18[0] && v18[1] >= v15 &&
            (float)(v15 + v17[0]) >= v18[1]) {
          ListBox_SetCursorPos(v3,
                               *(_DWORD *)v3->startPos +
      ...
      *(_QWORD *)v18 = __PAIR64__(a2, HIDWORD(a2));
      ...
      result =
          (listBoxDef_s *)CalcScreenPlacement(&v14, &v15, &v16, v17, v12, v5);
      if (v18[1] >= v14 && (float)(v14 + v16) >= v18[1] && v18[0] >= v15 &&
          (float)(v15 + v17[0]) >= v18[0]) {
        ListBox_SetCursorPos(
            v3,
            *(_DWORD *)v3->startPos +
                (int)(float)((float)((float)(*((float *)&a2 + 1) - 2.0) - v11) /
    ...
    if ((a2->window.staticFlags & 0x1000000) == 0 && !a2->fullScreen) {
      ...
      *(_DWORD *)&v19.window[12] = *(_DWORD *)&a2->window.rect[12];
      ...
      if ((v21[0] < *(float *)v19.window ||
           (float)(*(float *)v19.window + *(float *)&v19.window[8]) < v21[0] ||
    ...
    if (a3 <= 201) {
      if (a3 >= 200) {
        ...
        if (!v18->type) {
          ...
          Item_CorrectedTextRect(itemDef_s *)::rect = *(float *)v18->textRect;
          ...
          *(float *)v19.window = Item_CorrectedTextRect(itemDef_s *)::rect;
          ...
          *(float *)&v19.window[12] = flt_F00750;
          ...
          if (v20 >= *(float *)v19.window &&
              (float)(*(float *)v19.window + *(float *)&v19.window[8]) >= v20 &&
        ...
        *(_DWORD *)&v19.window[12] = *(_DWORD *)&v18->window[12];
        ...
        CalcScreenPlacement((float *)v19.window, (float *)&v19.window[4],
                            (float *)&v19.window[8], (float *)&v19.window[12],
                            *(_DWORD *)&v18->window[16],
                            *(_DWORD *)&v18->window[20]);
        if (v20 < *(float *)v19.window ||
            (float)(*(float *)v19.window + *(float *)&v19.window[8]) < v20 ||
            v21[0] < *(float *)&v19.window[4] ||
            (float)(*(float *)&v19.window[4] + *(float *)&v19.window[12]) <
...
void __cdecl Menus_Open(struct displayContextDef_s *dc,
                        struct menuDef_t *menu) {
    ...
    if (a2 == *(menuDef_t **)&a1->menuStack[4 * v5]) {
      ...
      while (1) {
        ...
        if (a2 == v9) {
          ...
          do {
            ++v24;
            *(_DWORD *)&v23[4 * v7 + 560 - (4 * v7 + 564)] = *(_DWORD *)v23;
            v23 += 4;
...
void __cdecl Item_MouseLeave(struct displayContextDef_s *dc,
  ...
  if (a2) {
    ...
    Item_RunScript(a1, (itemDef_s *)a2, *(const char **)&a2[1].rectClient[60]);
...
void __cdecl Script_SetFocus(struct displayContextDef_s *dc,
  ...
  if (result) {
    ...
    v5 = 0;
    while (
        !*(_DWORD *)(*(_DWORD *)(*(_DWORD *)(parent + 636) + 4 * v5) + 192) ||
        I_stricmp(__dst,
    ...
    if (v6) {
      result =
          Item_SetFocus(a1, (itemDef_s *)v6, *(float *)v6, *(float *)(v6 + 4));
      if (result) {
        ...
        return Com_Printf("setFocus: error focusing widget '%s' (widget was "
...
void __cdecl Window_Paint(struct displayContextDef_s *dc, struct windowDef_t *w,
  ...
  if (debugMode) {
    ...
    UI_DrawRect(__SPAIR64__(LODWORD(v25), LODWORD(v26)), v24, v23,
                *(_DWORD *)&a2->rect[16], *(_DWORD *)&a2->rect[20], 1.0, &v27);
  }
  if (a2) {
    style = a2->style;
    if (style) {
      if (!a2->border) {
        ...
        LABEL_14:
          ...
          case 1:
            ...
            break;
          case 2:
            UI_DrawTopBottom(*(float *)a2->rect, *(_QWORD *)&a2->rect[4],
                             *(float *)&a2->rect[12], *(_DWORD *)&a2->rect[16],
                             *(_DWORD *)&a2->rect[20],
      ...
      LABEL_7:
        ...
        case 1u:
          ...
          UI_FillRect(__SPAIR64__(LODWORD(v25), LODWORD(v26)), v24, v23,
                      *(_DWORD *)&a2->rect[16], *(_DWORD *)&a2->rect[20],
                      a2->backColor);
          break;
        case 3u:
        ...
        case 5u:
          if (a2->cinematic == -1) {
            v18 = CIN_PlayCinematic(*(const char **)a2->cinematicName, (int)v26,
                                    (int)v25, (int)v24, (int)v23, 0xAu);
            v19 = -2;
            if (v18 != -1)
              v19 = v18;
            a2->cinematic = v19;
          ...
          if (cinematic >= 0) {
            ...
            CIN_SetExtents(a2->cinematic, (int)v26, (int)v25, (int)v24,
                           (int)v23);
        ...
        case 6u:
          if (a2->background) {
            ...
            backColor = v11;
          LABEL_35:
            UI_DrawHandlePic(v26, v25, v24, v23, *(_DWORD *)&a2->rect[16],
...
void __cdecl Item_Paint(struct displayContextDef_s *dc,
                        struct itemDef_s *item) {
  int v3;                  // eax
  signed int realTime;     // edx
  signed int v5;           // eax
  ...
  if ((v3 & 0x2000) != 0) {
    ...
    if (realTime > (signed int)a3->nextTime) {
      ...
      v51 =
          (float)(v53 + *(float *)&a3->rectClient[4]) - a3->rectEffects0[0][1];
      v48 = (float)(v52 + *(float *)a3->rectClient) - a3->rectEffects0[0][0];
      ...
      *(float *)&v58.y =
      ...
      if (v22) {
        ...
        Item_SetScreenCoords((itemDef_s *)a3, v23, v24, *(_DWORD *)(v22 + 16),
                             *(_DWORD *)(v22 + 20));
        v3 = *(_DWORD *)a3->dynamicFlags;
      } else {
        v3 = *(_DWORD *)a3->dynamicFlags;
      ...
      *(float *)&v58.h = *(float *)&v58.h - a3->rectEffects1[1][0];
      ...
      LABEL_15:
        ...
        if (v11) {
          ...
          Item_SetScreenCoords((itemDef_s *)a3, v12, v13, *(_DWORD *)(v11 + 16),
                               *(_DWORD *)(v11 + 20));
        }
        if (v10 == 4)
...
LABEL_25:
  ...
  if (debugMode) {
    ...
    v59[2] = 0.0;
    v59[0] = 0.0;
    UI_DrawRect(__SPAIR64__(LODWORD(v21),
                            LODWORD(Item_CorrectedTextRect(itemDef_s *)::rect)),
  ...
  case 0xC:
    ...
    if (*(_DWORD *)(v34.listBox + 388)) {
      ...
      v38 =
          (const char *)Dvar_GetVariantString(*(char **)&a3[1].rectClient[80]);
      a1 = atof(v38);
      v39 = a1;
    ...
    if (v7 >= 0) {
      ...
      LABEL_28:
        ...
        if (v9 < v7) {
          ...
          do {
            ++v13;
            *(_DWORD *)&v12[4 * v9 + 560 - (4 * v9 + 564)] = *(_DWORD *)v12;
            v12 += 4;
...
LABEL_8:
  ...
  LABEL_9:
    if (a3->window.background)
      UI_DrawHandlePic(0.0, 0.0, 640.0, 480.0, *(_DWORD *)&a3->window.rect[16],
...
LABEL_11:
  ...
  LABEL_18:
    ...
    UI_DrawRect(*(_QWORD *)a3->window.rect, *(float *)&a3->window.rect[8],
                *(float *)&a3->window.rect[12], *(_DWORD *)&a3->window.rect[16],
...
void __cdecl Menu_PaintAll(struct displayContextDef_s *dc) { UNIMPLEMENTED(); }
...
bool __cdecl Item_IsTextField(struct itemDef_s *) { UNIMPLEMENTED(); }

int __cdecl Item_List_NextEntryForKey(int, int, int) { UNIMPLEMENTED(); }

int __cdecl Item_DvarEnum_CountSettings(struct itemDef_s *) { UNIMPLEMENTED(); }
...
void __cdecl Window_CloseCinematic(struct windowDef_t *) { UNIMPLEMENTED(); }

int __cdecl Item_Multi_CountSettings(struct itemDef_s *) { UNIMPLEMENTED(); }

void __cdecl Menus_AddToStack(struct displayContextDef_s *,
                              struct menuDef_t *) {
  UNIMPLEMENTED();
}

void __cdecl Controls_GetKeyAssignment(char *, int *) { UNIMPLEMENTED(); }

struct rectDef_s *__cdecl Item_CorrectedTextRect(struct itemDef_s *) {
  UNIMPLEMENTED();
}

void __cdecl Menu_CloseCinematics(struct menuDef_t *) { UNIMPLEMENTED(); }

void __cdecl Item_TextField_BeginEdit(struct itemDef_s *) { UNIMPLEMENTED(); }

int __cdecl Item_DvarEnum_EnumIndex(struct itemDef_s *) { UNIMPLEMENTED(); }

char const *__cdecl Item_Multi_Setting(struct itemDef_s *) { UNIMPLEMENTED(); }

int __cdecl Item_Multi_FindDvarByValue(struct itemDef_s *) { UNIMPLEMENTED(); }
...
void __cdecl Item_Multi_Paint(struct displayContextDef_s *,
                              struct itemDef_s *) {
  UNIMPLEMENTED();
}
...
void __cdecl Scroll_ListBox_AutoFunc(struct displayContextDef_s *, void *) {
  ...
  result = a1->realTime;
  if (result > *(_DWORD *)a2) {
    Item_ListBox_HandleKey(a1, *((itemDef_s **)a2 + 6), *((_DWORD *)a2 + 3), 1,
                           0);
...
Menu_HandleMouseMove(displayContextDef_s *dc, menuDef_t *menu, float x,
                     float y) {
  UNIMPLEMENTED();
}
