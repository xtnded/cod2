int __cdecl UI_CursorInRect(int, int, int, int) { UNIMPLEMENTED(); }

float __cdecl UI_ClampDvar(float, float, float) { UNIMPLEMENTED(); }
...
void __cdecl UI_StartDemoLoop(void) { UNIMPLEMENTED(); }
