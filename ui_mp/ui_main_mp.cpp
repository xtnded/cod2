float __cdecl UI_GetBlurRadius() { return *(float *)&uiInfo->blurRadiusOut; }

char const *__cdecl UI_GetTopActiveMenuName(void) { UNIMPLEMENTED(); }
...
void __cdecl UI_SwitchToLocalClient(int) { UNIMPLEMENTED(); }

char const *__cdecl UI_ReplaceConversions(
    char const *sourceString, struct ConversionArguments *arguments) {
...
int __cdecl UI_TextHeight(struct Font_s *font, float scale) { UNIMPLEMENTED(); }
...
void __cdecl UI_FeederSelection(float feederID, int index) {
  ...
  LABEL_11:
    ...
    if ((int)_nel >= 1)
      v6 = a2;
    dword_168BAB0 = v6;
    LAN_GetServerInfo((char *)ui_netSource->current.integer, dword_168BAB4[a2],
                      UI_FeederSelection(float, int)::info, 1024);
...
int __cdecl UI_IsFullscreen() { return Menus_AnyFullScreenVisible(uiInfo); }
...
void __cdecl WM_setVisibility(char *, int) { UNIMPLEMENTED(); }

void __cdecl WM_setItemPic(char *, char const *) { UNIMPLEMENTED(); }
...
void __cdecl UI_CloseXenonHudWaitScreen(void) { UNIMPLEMENTED(); }

void __cdecl UI_CloseMenu(char const *) { UNIMPLEMENTED(); }
...
void __cdecl UI_CloseAll() { UNIMPLEMENTED(); }
...
void __cdecl UI_Shutdown() { UNIMPLEMENTED(); }
...
char const *__cdecl UI_SafeTranslateString(char const *reference) {
  ...
  if (*(_BYTE *)(loc_warnings + 8)) {
    ...
    I_strncat(UI_SafeTranslateString(char const *)::errorString, 1024, "^1)^7");
  ...
  *a4 = 0;
  ...
  if (a1 == 2.0) {
    ...
    case 2u:
      if (v12 > 0) {
        v16 = (char *)Info_ValueForKey(
            UI_FeederItemText(float, int, int, Material **)::info, "hostname");
        I_strncpyz(UI_FeederItemText(float, int, int, Material **)::clientBuff,
                   v16, 20);
    ...
    case 4u:
      ...
      Com_sprintf(UI_FeederItemText(float, int, int, Material **)::clientBuff,
                  0x20u, "%s (%s)", v15, v14);
      return (const gentity_s *)UI_FeederItemText(float, int, int,
                                                  Material **)::clientBuff;
    case 5u:
    ...
    if (a1 != 9.0) {
      ...
      LABEL_30:
        if (v9 == 24.0 && a2 >= 0 && a2 < uiInfo[1].cursorx)
          return (const gentity_s *)*(
              &uiInfo[1].cursory + *(_DWORD *)&uiInfo[1].Menus[4 * a2 + 232]);
        return &inData;
      }
      if (a2 < 0 || a2 >= dword_1684B04)
        return &inData;
      if (a3 == 1)
        return (const gentity_s *)((char *)&unk_1684B08 + 32 * a2);
      if (!(unsigned __int8)CL_IsPlayerMuted(*(_DWORD *)&dword_1685B08[4 * a2]))
        return &inData;
      v21 = "MP_MUTED";
  ...
  LABEL_9:
    ...
    if (*(_DWORD *)(v5.listBox + 16)) {
      if (dword_168BAB0 >= 0) {
        ...
        if (v6 >= *(_DWORD *)v5.listBox && v6 <= *(_DWORD *)(v5.listBox + 16)) {
          v7 = dword_168BAB0 - v6;
          ListBox_SetStartPos((listBoxDef_s *)v5.listBox,
                              *(_DWORD *)v5.listBox + dword_168BAB0 - v6);
...
void __cdecl UI_KeyEvent(int key, int down) {
  ...
  if ((int)Menu_Count(uiInfo) > 0) {
    ...
    if (a1 != 27 || !a2 || Menus_AnyFullScreenVisible(uiInfo) || Focused->onESC)
...
void __cdecl UI_RunMenuScript(char const **args) {
    ...
    *(_DWORD *)&uiInfo[1].Menus[228] = 1;
    ...
    if (v136[0] > 0) {
      ...
      do {
        ...
        *(&v43[1].cursory + cursorx) = (int32_t)String_Alloc((char *)v121[v42]);
        ++uiInfo[1].cursorx;
        ++v42;
      } while (v136[0] > v42);
    }
  ...
  if (!I_stricmp(v130, "selectActivePlayerProfile")) {
    ...
    if (uiInfo[1].cursorx > 0) {
      v47 = 0;
      while (I_stricmp(integer, *((char **)&v46[1].cursory +
        ...
        if ((unsigned __int8)Com_NewPlayerProfile(__dst)) {
          ...
          *(&v62[1].cursory + v63) = (int32_t)String_Alloc(__dst);
          ...
          if (uiInfo[1].cursorx > 0) {
            v68 = 0;
            while (
                I_stricmp(__dst, *((char **)&v67[1].cursory +
...
void __cdecl UI_OpenMenu(char const *) { UNIMPLEMENTED(); }

int __cdecl UI_SetActiveMenu(int menu) { UNIMPLEMENTED(); }
...
void __cdecl UI_ShowPartyLobby(void) { UNIMPLEMENTED(); }
...
char *__cdecl GetMenuBuffer(char const *filename) {
  ...
  if (v3[0]) {
    if (v1 > 0x7FFF) {
      Com_Printf("^1menu file too large: %s is %i, max allowed is %i", a1, v1,
                 0x8000);
      FS_FCloseFile(v3[0]);
      return 0;
    } else {
...
void __cdecl UI_Init() { UNIMPLEMENTED(); }
...
void __cdecl UI_DrawConnectScreen() { UNIMPLEMENTED(); }

void __cdecl UI_Refresh() { UNIMPLEMENTED(); }
...
void __cdecl UI_InsertServerIntoDisplayList(int, int) { UNIMPLEMENTED(); }

void __cdecl UI_StartSkirmish(int) { UNIMPLEMENTED(); }

int __cdecl UI_GetPlayerListNumForClientNum(int) { UNIMPLEMENTED(); }

void __cdecl UI_UpdatePendingPings(void) { UNIMPLEMENTED(); }

void __cdecl UI_ClearDisplayedServers(void) { UNIMPLEMENTED(); }
...
void __cdecl UI_BuildPlayerList(void) { UNIMPLEMENTED(); }

void __cdecl UI_BinaryServerInsertion(int) { UNIMPLEMENTED(); }
...
int __cdecl UI_GetTalkerClientNum(int) { UNIMPLEMENTED(); }
...
void __cdecl UI_ServersSort(int, int) { UNIMPLEMENTED(); }
...
void __cdecl UI_Update(char const *) { UNIMPLEMENTED(); }
      ...
      if (LAN_ServerIsDirty(ui_netSource->current.integer, i)) {
        ...
        if (I_strnicmp(v13, "000.000.000.000", 15) &&
          ...
          if (*(_BYTE *)(ui_browserShowFull + 8) ||
              (v26 = (const char *)Info_ValueForKey(__dst, "sv_maxclients"),
               v12 != atoi(v26))) {
            if (*(_BYTE *)(ui_browserShowPassword + 8) ||
                (v27 = (const char *)Info_ValueForKey(__dst, "pswrd"),
                 !atoi(v27))) {
              if (*(_BYTE *)(ui_browserShowNoPassword + 8) ||
                  (v28 = (const char *)Info_ValueForKey(__dst, "pswrd"),
                   atoi(v28))) {
                if (!*(_BYTE *)(ui_browserShowPure + 8) ||
                    (v29 = (const char *)Info_ValueForKey(__dst, "pure"),
                     atoi(v29))) {
                  if (!*(_BYTE *)(ui_browserShowDedicated + 8) ||
                      (v30 = (const char *)Info_ValueForKey(__dst, "hw"),
                       (unsigned int)(atoi(v30) - 1) <= 2)) {
                    if (*(int *)(ui_browserMod + 8) < 0 ||
                        (v14 = (const char *)Info_ValueForKey(__dst, "mod"),
                         atoi(v14) == *(_DWORD *)(ui_browserMod + 8))) {
                      if (*(int *)(ui_browserFriendlyfire + 8) < 0 ||
                          (v15 = (const char *)Info_ValueForKey(__dst, "ff"),
                           atoi(v15) ==
                               *(_DWORD *)(ui_browserFriendlyfire + 8))) {
                        if (*(int *)(ui_browserKillcam + 8) < 0 ||
                            (v16 = (const char *)Info_ValueForKey(__dst, "kc"),
                             atoi(v16) == *(_DWORD *)(ui_browserKillcam + 8))) {
                          current = ui_joinGameType->current;
                          if (!*(_BYTE *)dword_1685D14[2 * current.integer] ||
                              (v35 = (char *)dword_1685D10[2 * current.integer],
                               v36 =
                                   (char *)Info_ValueForKey(__dst, "gametype"),
                               !I_stricmp(v36, v35))) {
                            if (ui_serverFilterType <= 0 ||
                                (v18 = (char *)*(&off_3325E4 +
                                                 2 * ui_serverFilterType),
                                 v19 = (char *)Info_ValueForKey(__dst, "game"),
                                 !I_stricmp(v19, v18))) {
                              v20 = ui_netSource;
                              if (ui_netSource->current.integer != 2)
                                goto LABEL_46;
                              ...
                              if ((int)_nel > 0) {
                                ...
                                LABEL_89:
                                  ...
                                  if (v37 >= v21 - 1) {
                                    ...
                                    v40 = &dword_1684AD4[v37 + 7161];
                                    v41 = v37;
                                    v42 = (char *)((char *)&dword_168BAB4[v37] -
                                                   (char *)v40);
                                    do {
                                      ++v41;
                                      *(int *)((char *)v40 + (_DWORD)v42) =
                                          *v40;
                                      ++v40;
                                    } while ((int)_nel > v41);
                                  LABEL_46:
                              ...
                              LABEL_71:
                                if (v21 >= v50) {
                                  if (dword_168BAB0 >= v50 && v21)
                                    ++dword_168BAB0;
                                  v32 = v21 + 1;
                                  _nel = v21 + 1;
                                  if (v21 + 1 > v50) {
                                    v33 = &dword_1684AD4[v21 + 7160];
                                    v34 = (char *)((char *)&dword_168BAB4[v32] -
                                                   (char *)v33);
                                    do {
                                      --v32;
                                      *(int *)((char *)v33 + (_DWORD)v34) =
                                          *v33;
                                      --v33;
                                    } while (v32 > v50);
                                  }
                                ...
                                while (1) {
                                  ...
                                  v24 = LAN_CompareServers(
                                      v20->current.integer, dword_168BAA0,
                                      dword_168BAA4, i, dword_168BAB4[v51]);
                                  v25 = v24;
                                  if (!v24) {
                                    if (v51 >= 0) {
                                      v43 = _nel;
                                      if ((int)_nel >= v51) {
                                        if (dword_168BAB0 >= v51 && _nel)
                                          ++dword_168BAB0;
                                        v44 = ++_nel;
                                        if ((int)(v43 + 1) > v51) {
                                          v45 = &dword_1684AD4[v43 + 7160];
                                          v46 = (char *)((char *)&dword_168BAB4
                                                             [v44] -
                                                         (char *)v45);
                                          do {
                                            --v44;
                            ...
                            LABEL_79:
                              if (ServerPing > 0) {
                                LAN_MarkServerDirty(
                                    ui_netSource->current.integer, i, 0);
                                ++UI_BuildServerDisplayList(int)::numclean;
                              }
                              continue;
                            }
                          }
...
void __cdecl UI_UpdateDisplayServers(void) { UNIMPLEMENTED(); }
...
void __cdecl UI_BuildServerStatus(int) { UNIMPLEMENTED(); }
...
void __cdecl UI_StartServerRefresh(int) {
  ...
  if (a1) {
    ...
    if (ui_netSource->current.integer) {
      ...
      if (ui_netSource->current.integer == 1) {
        VariantString = (const char *)Dvar_GetVariantString("debug_protocol");
        if (*VariantString)
...
void __cdecl UI_RegisterDvars(void) { UNIMPLEMENTED(); }

void __cdecl UI_StopServerRefresh(void) { UNIMPLEMENTED(); }

void __cdecl UI_DoServerRefresh(void) { UNIMPLEMENTED(); }
    ...
    *((_DWORD *)&unk_1685C00 + 2 * v4 + 3) = String_Alloc(v1);
    ...
    if (MenuBuffer) {
      ...
      *((_DWORD *)&unk_1685C00 + 2 * v7 + 4) = String_Alloc(v6);
      dword_1685D10[2 * dword_1685D0C + 1] = dword_1685C10[2 * dword_1685C08];
    } else {
...
UI_DrawRecordLevel(rectDef_s *rect) { UNIMPLEMENTED(); }
