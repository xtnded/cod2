int __cdecl Respond_trigger_damage(struct gentity_s *, int) { UNIMPLEMENTED(); }
...
void __cdecl InitSentientTrigger(struct gentity_s *) { UNIMPLEMENTED(); }
...
void __cdecl SP_trigger_disk(struct gentity_s *ent) { UNIMPLEMENTED(); }

void __cdecl SP_trigger_radius(struct gentity_s *ent) { UNIMPLEMENTED(); }

void __cdecl InitTrigger(struct gentity_s *) { UNIMPLEMENTED(); }
...
void __cdecl InitTriggerWait(struct gentity_s *, int) { UNIMPLEMENTED(); }
