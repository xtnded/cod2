...
void __cdecl G_SetClientSound(struct gentity_s *)
{
  UNIMPLEMENTED();
}
        ...
        if (result > 0) {
          v3 = *(_DWORD *)(client + 10024);
            ...
            LABEL_17:
              ...
              *(float *)(client + 10308) =
                  (float)((float)((float)(v9 * v14[3]) +
                                  (float)(v10 * v14[4])) +
                          (float)(v11 * v14[5])) *
                  v13;
              *(float *)(client + 10312) =
                  (float)((float)((float)(v9 * v14[0]) +
                                  (float)(v10 * v14[1])) +
                          (float)(v11 * v14[2])) *
                  v12;
              *(_DWORD *)(client + 292) =
        ...
        if (v8 > 0) {
            for (i = 0; v8 != i; ++i) {
              ...
              v7 = (int(__cdecl *)(gentity_s *, gentity_s *, int))
                ...
                if (v6->s.eType == 3) {
                  result = (char **)BG_PlayerTouchesItem(
                      (playerState_s *)a1->client, &v6->s, dword_193466C);
                    if (result) {
                  ...
                  result = (char **)SV_EntityContact(&v14, &v11,
                                                     &g_entities + v10[i]);
                    if (result) {
                      result = (char **)Scr_IsSystemActive();
                      if (result)
...
void __cdecl ClientImpacts(struct gentity_s *, struct pmove_t *)
{
  ...
  result = a2;
    ...
    LABEL_3:
      ...
      if (v10)
        result = (pmove_t *)((
            int(__cdecl *)(gentity_s *, gentity_s *, int))v10)(a1, v5, 1);
        while (1) {
          ++v3;
                ...
                case 197:
                  v16 = a8->client;
                    if (v16 && (a8->flags & 3) == 0) {
                      a8->health = 0;
                      *(_DWORD *)(v16 + 300) = 0;
                      player_die(a1, a2, a3, a4, a5, a6, a7, a8, a8, a8, 100000,
...
void __cdecl ClientEndFrame(struct gentity_s *)
{
  UNIMPLEMENTED();
}
        ...
        while (1) {
          ...
          v12 = v11;
            if ((unsigned __int8)(v11 + 98) <= 0x11u &&
              ...
              BG_WeaponFireRecoil((const playerState_s *)v13,
                                  (float *)(v13 + 10380), v29);
            }
...
int __cdecl G_UpdateClientInfo(struct gentity_s *)
{
  UNIMPLEMENTED();
}
