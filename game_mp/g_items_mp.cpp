...
int __cdecl IsItemRegistered(int iItemIndex) { return itemRegistered[a1]; }

void __cdecl ClearRegisteredItems() { UNIMPLEMENTED(); }
...
void __cdecl Fill_Clip(struct playerState_s *, int) { UNIMPLEMENTED(); }

int __cdecl Add_Ammo(struct gentity_s *ent, int weapon, int count,
                     int fillClip) {
  int v4;                // esi
  int v5;                // edi
  int32_t client;        // eax
...
void __cdecl SaveRegisteredItems() { UNIMPLEMENTED(); }

void __cdecl SaveRegisteredWeapons() { UNIMPLEMENTED(); }
...
void __cdecl RegisterItem(int iItemIndex, int bUpdateCS) {
  ...
  if (!result) {
    if (!dword_193449C) {
      ...
      if (v3 && *v3) {
        v4 = va("game tried to register the item '%s' after initialization "
                "finished\n",
                (const char *)bg_itemlist[11 * a1 + 5]);
        Scr_Error(v4);
      } else {
        v6 = va("game tried to register the item '%s' after initialization "
                "finished\n",
                "<<unknown>>");
        Scr_Error(v6);
      }
...
void __cdecl G_RegisterWeapon(int weapIndex) { UNIMPLEMENTED(); }
...
void __cdecl G_RunItem(struct gentity_s *ent) { UNIMPLEMENTED(); }

void __cdecl G_RunCorpseMove(struct gentity_s *ent) { UNIMPLEMENTED(); }
...
void __cdecl FinishSpawningItem(struct gentity_s *ent) {
  ...
  *(float *)&v17.contents = v2 - 4096.0;
  ...
  LABEL_8:
    ...
    v10[1] =
        v12 + (float)((float)(*(float *)&v17.surfaceFlags - v12) * v6.fraction);
    v10[2] =
...
void __cdecl G_RunCorpse(struct gentity_s *ent) { UNIMPLEMENTED(); }
...
int *itemRegistered;
int __cdecl G_ItemClipMask(struct gentity_s *) { UNIMPLEMENTED(); }
...
void __cdecl RegisterWeaponRumbles(struct WeaponDef *) { UNIMPLEMENTED(); }

int __cdecl GetFreeCueSpot(void) { UNIMPLEMENTED(); }

void __cdecl G_RunCorpseAnimate(struct gentity_s *) { UNIMPLEMENTED(); }
