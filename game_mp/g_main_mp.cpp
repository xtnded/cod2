void __cdecl G_UpdateObjectiveToClients(void) { UNIMPLEMENTED(); }
...
void __cdecl G_LogPrintf(char const *fmt, ...) {
  ...
  if (dword_1934498) {
    ...
    Com_sprintf(v3, 0x400u, "%3i:%i%i %s", dword_193466C / 1000 / 60,
                dword_193466C / 1000 % 60 / 10, dword_193466C / 1000 % 60 % 10,
                __str);
...
float __cdecl G_GetFogOpaqueDistSqrd() { return flt_193625C; }
...
int __cdecl G_GetSavePersist() { return dword_19361D4; }

void __cdecl G_UpdateHudElemsToClients(void) { UNIMPLEMENTED(); }
...
void __cdecl G_RunThink(struct gentity_s *ent) { UNIMPLEMENTED(); }

void __cdecl CheckVote() { UNIMPLEMENTED(); }

void *__cdecl Hunk_AllocXAnimServer(int) {
  return Hunk_AllocLowInternal(__len);
}

void __cdecl G_FreeEntities(void) { UNIMPLEMENTED(); }

void __cdecl G_ShutdownGame(int freeScripts) { UNIMPLEMENTED(); }

void __cdecl DebugDumpAnims(void) { UNIMPLEMENTED(); }
...
void __cdecl G_XAnimUpdateEnt(struct gentity_s *) { UNIMPLEMENTED(); }

void __cdecl G_RunFrame(int levelTime) { UNIMPLEMENTED(); }
...
void __cdecl G_FreeAnimTreeInstances(void) { UNIMPLEMENTED(); }

void __cdecl G_LoadAnimTreeInstances(void) { UNIMPLEMENTED(); }

void __cdecl G_RegisterDvars(void) { UNIMPLEMENTED(); }
...
void __cdecl G_RunFrameForEntity(struct gentity_s *) { UNIMPLEMENTED(); }
