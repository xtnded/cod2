int __cdecl DebugLine(float *const, float *const, int) { UNIMPLEMENTED(); }
...
void __cdecl G_FreeEntityRefs(struct gentity_s *) { UNIMPLEMENTED(); }
...
void __cdecl PlayerCorpse_Free(struct gentity_s *) { UNIMPLEMENTED(); }
...
int __cdecl infront(struct gentity_s *, struct gentity_s *) { UNIMPLEMENTED(); }

void __cdecl G_SetConstString(unsigned short *to, char const *from) {
  UNIMPLEMENTED();
}

void __cdecl G_InitGentity(struct gentity_s *e) { UNIMPLEMENTED(); }

void __cdecl G_SafeDObjFree(struct gentity_s *ent) { UNIMPLEMENTED(); }
...
void __cdecl G_UpdateTagInfo(struct gentity_s *, int) { UNIMPLEMENTED(); }
...
int __cdecl G_RumbleIndex(char const *) { UNIMPLEMENTED(); }

unsigned char __cdecl G_SoundAliasIndex(char const *name) { UNIMPLEMENTED(); }

int __cdecl G_ShellShockIndex(char const *name) { UNIMPLEMENTED(); }

int __cdecl G_EffectIndex(char const *name) { UNIMPLEMENTED(); }

int __cdecl G_TagIndex(char const *name) { UNIMPLEMENTED(); }
...
int __cdecl G_LocalizedStringIndex(char const *string) { UNIMPLEMENTED(); }
...
void __cdecl G_FreeEntity(struct gentity_s *ed) { UNIMPLEMENTED(); }
...
void __cdecl G_FreeEntityDelay(struct gentity_s *ed) { UNIMPLEMENTED(); }

void __cdecl G_KillBox(struct gentity_s *) { UNIMPLEMENTED(); }
...
bool __cdecl G_MaySpawnEntity(struct gentity_s *) { UNIMPLEMENTED(); }
