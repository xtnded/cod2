...
void __cdecl SanitizeString(char *, char *) { UNIMPLEMENTED(); }
...
void __cdecl Cmd_Where_f(struct gentity_s *) { UNIMPLEMENTED(); }
...
void __cdecl Cmd_UFO_f(struct gentity_s *) { UNIMPLEMENTED(); }

void __cdecl Cmd_Noclip_f(struct gentity_s *) { UNIMPLEMENTED(); }

void __cdecl Cmd_Notarget_f(struct gentity_s *) { UNIMPLEMENTED(); }

void __cdecl Cmd_DemiGod_f(struct gentity_s *) { UNIMPLEMENTED(); }

void __cdecl Cmd_God_f(struct gentity_s *) { UNIMPLEMENTED(); }
...
void __cdecl G_setfog(char const *fogstring) { UNIMPLEMENTED(); }
...
void __cdecl Cmd_Fogswitch_f(void) { UNIMPLEMENTED(); }

void __cdecl Cmd_EntityCount_f(struct gentity_s *) { UNIMPLEMENTED(); }
...
void __cdecl G_Say(struct gentity_s *ent, struct gentity_s *target, int mode,
  ...
  if (v6 == 1) {
    ...
    LABEL_15:
      ...
      Com_sprintf(v18, 0x80u, "%s(\x14%s\x15)%s%s: ", __str, v10, __dst, "^7");
      v16 = 53;
...
void __cdecl Cmd_MenuResponse_f(struct gentity_s *pEnt) { UNIMPLEMENTED(); }
  ...
  if (I_stricmp(__s, "typemap")) {
    if (!I_stricmp(__s, "g_gametype")) {
      if (Scr_IsValidGameType(v38)) {
        ...
        Com_sprintf(&byte_193479C[1024], 0x400u, "GAME_VOTE_GAMETYPE\x14%s",
                    GameTypeNameForScript);
        goto LABEL_44;
      }
    LABEL_32:
    ...
    if (!I_stricmp(__s, "map")) {
      if (SV_MapExists(v38)) {
        ...
        Com_sprintf(&byte_193479C[1024], 0x400u, "GAME_VOTE_MAP\x15%s", v38);
        goto LABEL_44;
      }
    LABEL_50:
  ...
  LABEL_56:
    if (v38[0]) {
      ...
      Com_sprintf(&byte_193479C[1024], 0x400u,
                  "GAME_VOTE_GAMETYPE\x14%s\x15 - \x14GAME_VOTE_MAP\x15%s", v24,
                  __src);
    } else {
      Com_sprintf(&byte_193479C[1024], 0x400u, "GAME_VOTE_MAP\x15%s", __src);
    }
    goto LABEL_44;
  }
...
void __cdecl Cmd_Kill_f(struct gentity_s *) { UNIMPLEMENTED(); }
...
void __cdecl Cmd_Give_f(struct gentity_s *ent) { UNIMPLEMENTED(); }
      ...
      if (v9 >= 0 && v9 < dword_1934664) {
        ...
        if (v10) {
          ...
          LABEL_18:
            ...
            I_CleanStr(__dst);
            I_strncpyz((char *)__src, (char *)(v56->client + 10116), 64);
            ...
            G_LogPrintf("tell;%d;%d;%s;%d;%d;%s;%s\n", v14, v13, __dst, Guid,
                        number, (const char *)__src, ConcatArgs(int)::line);
  ...
  if (*(_DWORD *)(v49->client + 4) != 5) {
    ...
    if (!I_stricmp(v60, "kill")) {
      ...
      if (!*(_DWORD *)(v37 + 9896)) {
        ...
        v49->health = 0;
        *(_DWORD *)(v37 + 300) = 0;
        player_die(a1, a2, a3, a4, a5, a6, a7, v49, v49, v49, 100000, 0xCu, 0,
                   0, HITLOC_NONE, 0);
      }
      return;
    }
    if (I_stricmp(v60, "follownext")) {
                ...
                if (I_stricmp(v60, "setviewpos")) {
                  if (I_stricmp(v60, "entitycount")) {
                    if (I_stricmp(v60, "printentities")) {
                      v44 = va("%c \"GAME_UNKNOWNCLIENTCOMMAND\x15%s\"", 101,
                               v60);
                      SV_GameSendServerCommand(a8, SV_CMD_CAN_IGNORE, v44);
                    } else {
                      G_PrintEntities();
                    }
      ...
      if (v41[2474] == 2 && (int)v41[2475] < 0) {
        ...
        while (1) {
          ...
          if (SV_GetArchivedClientInfo(v42, (int *)(v49->client + 9908), &v59,
                                       __src) &&
      ...
      if (v38[2474] == 2 && (int)v38[2475] < 0) {
        ...
        while (1) {
          ...
          if (SV_GetArchivedClientInfo(v39, (int *)(v49->client + 9908), &v59,
                                       __src) &&
              G_ClientCanSpectateTeam((gclient_s *)v49->client,
                                      (team_t)__src[0].team)) {
            break;
    ...
    if (a2->r.inuse) {
      ...
      if (client) {
        if (*(_DWORD *)(client + 9924) == 2 &&
            ...
            (*(_BYTE *)(g_deadChat + 8) || !*(_DWORD *)(a1->client + 9896) ||
             *(_DWORD *)(a2->client + 9896))) {
          if (a3 == 1)
            v10 = 105;
          else
            v10 = 104;
          v11 = va("%c \"\x15%s%c%c%s\"", v10, (const char *)a5, 94, a4, a6);
          SV_GameSendServerCommand(
...
void __cdecl Cmd_PrintEntities_f(void) { UNIMPLEMENTED(); }

void __cdecl Cmd_Tell_f(struct gentity_s *) { UNIMPLEMENTED(); }

void __cdecl Cmd_Say_f(struct gentity_s *, int, int) { UNIMPLEMENTED(); }
