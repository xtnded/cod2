int __cdecl LogAccuracyHit(struct gentity_s *target,
  ...
  if (a1->takedamage) {
    if (a1 != a2) {
      client = a1->client;
      if (client) {
        if (a2->client && *(int *)(client + 4) <= 5 && !OnSameTeam(a1, a2))
          return 1;
      }
    }
  }
  ...
  if ((unsigned __int8)Melee_Trace(a8, a9, v16, a10, a11, a12, &v17, v18)) {
    ...
    if (v17.entityNum != 1022) {
      if (v12->takedamage) {
        ...
        v15 = rand() % 5;
        G_Damage(a1, a2, a3, a4, a5, a6, a7, v12, a8, a8, a9->forward, v18,
                 v16 + v15, 0, 7u, partGroup, 0);
      }
    }
  }
}
...
void __cdecl FireWeaponMelee(struct gentity_s *ent) {
  ...
  if ((*(_DWORD *)(a8->client + 160) & 0x300) == 0 || !a8->active) {
    ...
    Weapon_Melee(
        a1, a2, a3, a4, a5, a6, a7, a8, &v8, *(float *)(player_meleeRange + 8),
        *(float *)(player_meleeWidth + 8), *(float *)(player_meleeHeight + 8));
  }
}
...
void __cdecl FireWeapon(struct gentity_s *) { UNIMPLEMENTED(); }

void __cdecl gunrandom(float *, float *) { UNIMPLEMENTED(); }
