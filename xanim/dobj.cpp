        ...
        if (result) {
          v5 = 32 * a4 + result;
            if (a3) {
              ...
              v9 = (float)-v14 * v16;
              *(float *)v5 =
                  (float)(v12 * (float)(v15 * v13)) + (float)(v11 * v9);
        ...
        if (!v101) {
          ...
          v82 = v13[9];
            if (v82 != 0.0 && v98 >= v97) {
              ...
              v28 = v13[8];
              v129 =
                  (float)((float)((float)(v111 + v23) * v28) +
              ...
              v128 =
                  (float)((float)((float)(v113 - v22) * v28) +
                          (float)((float)((float)(1.0 - (float)(v24 + v109)) *
                                          v27) +
                                  (float)((float)(v25 + v110) * v26))) +
                  v9[1];
              v29 =
                  (float)((float)((float)((float)(v111 - v23) * v26) +
              ...
              v31 = *v106 - v128;
              v32 = *v108 - v29;
              v33 = (float)-(float)((float)((float)(v127 * v30) +
                                            (float)(v126 * v31)) +
                                    (float)(v125 * v32)) *
                    v83;
              if (v33 < 1.0)
                ...
                v34 =
                    (float)((float)((float)(*a3 - v129) * (float)(*a3 - v129)) +
                            (float)((float)(*v105 - v128) *
                                    (float)(*v105 - v128))) +
                    (float)((float)(*v107 - v29) * (float)(*v107 - v29));
                if ((float)(v82 - v34) > 0.0) {
                  if (v98 == v97 && (float)(v33 - fsqrt((float)(v82 - v34) *
                                                        v83)) >= a5->fraction)
                    goto LABEL_63;
                  v35 = *a2 - *v9;
                  v131 = v114 - v9[1];
                  ...
                  v42 = v38 * *v18;
                  v43 = v38 * *v20;
                  v142[0] = (float)((float)((float)(1.0 - (float)(v117 + v42)) *
                                            v35) +
                                    (float)((float)(v39 + v43) * v131)) +
                            (float)((float)(v116 - v41) * v130);
                  v142[1] = (float)((float)((float)(v39 - v43) * v35) +
                                    (float)((float)(1.0 - (float)(v42 + v115)) *
                                            v131)) +
                ...
                if (*v22) {
                  String = SL_FindString(v22);
                    if (String && v32 > 0) {
                      ...
                      v28 = 0;
                        for (j = a4;; j = v34) {
                          BoneIndex = XModelGetBoneIndex(
                              *((const XModel **)j + 7), String);
                          if (BoneIndex >= 0)
                            break;
                          ++v28;
                          v34 += 4;
                    ...
                    LABEL_23:
                      Com_Printf("WARNING: Part '%s' not found in model '%s' "
                                 "or any of "
                                 "its descendants\n",
                                 v30,
                                 *(const char **)(*((_DWORD *)a4 + 7) + 136));
                    }
                }
            }
        }
    ...
    if (!v3) {
      ...
      v113 = skel + 48;
        ...
        LABEL_14:
                  ...
                  v43 = 1 << (v19 & 0x1F);
                    if ((v43 & v128[(v19 >> 5) + 9]) != 0) {
                        if ((v43 & v128[(v19 >> 5) + 1]) != 0) {
                          ...
                          *(float *)(v14 + 4) = v103;
                          v27 = (float)(v26 * v22) +
                                (float)((float)((float)(v23 * v25) +
                                                (float)(v21 * v99)) -
                                        (float)(v24 * v20));
                        }
                      *(float *)(v14 + 8) = v27;
                      v28 = (float)((float)((float)(v97 * v97) +
                                            (float)(v103 * v103)) +
                                    (float)(v27 * v27)) +
                            (float)(v95 * v95);
                        if (v28 == 0.0) {
                      ...
                      v41 =
                          ...
                          v16[4];
                      v42 =
                          (float)((float)((float)((float)(v33 + v40) *
                                                  *(float *)(v14 + 16)) +
                                          (float)((float)(1.0 -
                                                          (float)(v39 + v118)) *
                                                  *(float *)(v14 + 20))) +
                                  (float)((float)(v120 - v37) *
                                          *(float *)(v14 + 24))) +
                          v16[5];
                      *(float *)(v14 + 24) =
                ...
                if (v110) {
                  ...
                  v54 = 32 * *(unsigned __int8 *)(v112 + v125);
                    if ((v79 & v128[v78 + 1]) != 0) {
                      ...
                      *(v53 - 3) = v104;
                      v62 = (float)(v61 * v57) +
                            (float)((float)((float)(v58 * v60) +
                                            (float)(v56 * v101)) -
                                    (float)(v59 * v55));
                    }
                  *(v53 - 2) = v62;
                  v63 = (float)((float)((float)(v98 * v98) +
                                        (float)(v104 * v104)) +
                                (float)(v62 * v62)) +
                        (float)(v96 * v96);
                    if (v63 == 0.0) {
                  ...
                  *v53 = v109;
                  ...
                  v74 = v67 * v70;
                  v75 = v67 * v72;
                  v76 = (float)((float)((float)((float)(1.0 -
                                                        (float)(v122 + v74)) *
                                                v109) +
                                        (float)((float)(v69 - v75) * v108)) +
                                (float)((float)((float)(v124 * v72) + v71) *
                                        v64)) +
                        *(float *)(v14 - v65 + 16);
                  v77 = (float)((float)((float)((float)(v69 + v75) * v109) +
                        ...
                        *(float *)(v14 - v65 + 20);
                  v53[2] =
                      (float)((float)((float)((float)(v71 -
                                                      (float)(v124 * v72)) *
                                              v109) +
                                      (float)((float)(v73 + v123) * v108)) +
                              (float)(v64 *
                                      (float)(1.0 - (float)(v121 + v122)))) +
                      *(float *)(v14 - v65 + 24);
                  *v53 = v76;
                  v53[1] = v77;
                  goto LABEL_34;
          ...
          v107 = v128[0] + v82;
            while (1) {
              ...
              if ((v85 & v128[(v83 >> 5) + 9]) != 0)
                break;
                if (v83 != *v115 - 1 || (v86 = v115 + 2, v115 += 2,
                                         (v85 & v128[(v83 >> 5) + 5]) != 0)) {
                LABEL_45:
                  v14 += 32;
                  if (v107 == ++v83)
          ...
          v84 = (float)((float)((float)(*(float *)v14 * *(float *)v14) +
                                (float)(*(float *)(v14 + 4) *
                                        *(float *)(v14 + 4))) +
                                  ...
                                  int *const partBits)
{
  ...
  v7 = *v6;
    if (v7 > a2) {
      v20 = 0;
    LABEL_7:
        for (j = *((_DWORD *)v17 + 1) + 4;;
             v3 -= *(unsigned __int8 *)(v10 + j)) {
          v8 = v3 - v21[v20];
            while (1) {
              v9 = v3 >> 5;
              a3[v9] |= 1 << (v3 & 0x1F);
