float __cdecl ShortLerpAsVec(short, short, float) { UNIMPLEMENTED(); }
...
float __cdecl FloatLerp(float, float, float) { UNIMPLEMENTED(); }
...
bool __cdecl XAnimIsLooped(struct XAnim_s const *anims,
...
int __cdecl XAnimTreeSize(int) { UNIMPLEMENTED(); }

void __cdecl XAnimDisableLeakCheck(void) { UNIMPLEMENTED(); }

void __cdecl XAnimAbort() { g_end = 0; }
...
void __cdecl XAnimClearTreeAnimCache(struct XAnimTree_s *) { UNIMPLEMENTED(); }

void __cdecl XAnimFree(struct XAnimParts_s *parts) { UNIMPLEMENTED(); }

void __cdecl XAnimShutdown() { UNIMPLEMENTED(); }
...
void __cdecl XAnimClearTree(struct XAnimTree_s *tree) { UNIMPLEMENTED(); }
...
void __cdecl XAnimSetCompleteGoalWeight(struct XAnimTree_s *tree,
  ...
  if (a8) {
    if (a2) {
      ...
      v14 = a2;
      while (1) {
        v15 = &g_xAnimInfo[10 * *(unsigned __int16 *)&a1->infoArray[2 * v14]];
        v16 = anims + 8 * v14;
        ...
        if (*v17) {
          ...
          do {
            ...
            if ((_WORD)result) {
              ...
              if (*((float *)v20 + 3) != 0.0 || *((_WORD *)v20 + 10)) {
                v20[3] = 0;
                *((_WORD *)v20 + 10) = 0;
                v20[4] = 0;
                *((_WORD *)v20 + 11) = 0;
    ...
    LABEL_10:
      ...
      if (!*(_WORD *)(anims + 8 * a2 + 12)) {
        result =
            (int)&g_xAnimInfo[10 * *(unsigned __int16 *)&a1->infoArray[2 * a2]];
...
void __cdecl XAnimSetupSyncNodes(struct XAnim_s *anims) { UNIMPLEMENTED(); }
...
int __cdecl XAnimSetCompleteGoalWeightKnobAll(
  ...
  if (a2) {
    ...
    if (!*(_WORD *)&a1->infoArray[2 * v19]) {
      v61 = a1;
      do {
        XAnimSetGoalWeightInternal(v61, v19, 1, 0.0, a5, 1065353216, 0, 0);
        if (!v19)
          break;
        v61 = a1;
        ...
        if (*v25) {
          ...
          do {
            ...
            if (v67) {
              ...
              if (*((float *)v68 + 3) != 0.0 || *((_WORD *)v68 + 10)) {
                v68[3] = 0;
                *((_WORD *)v68 + 10) = 0;
                v68[4] = 0;
                *((_WORD *)v68 + 11) = 0;
  ...
  if (a3 != v29) {
    while (1) {
      ...
      v31 = (unsigned __int16 *)(v28 +
                                 8 * *(unsigned __int16 *)(v28 + 8 * v30 + 14) +
                                 12);
      v89 = v31;
      v88 = *v31;
      if (*v31)
    ...
    LABEL_36:
      ...
      if (v30) {
        ...
        while (1) {
          v43 =
              &g_xAnimInfo[10 * *(unsigned __int16 *)&v40->infoArray[2 * v42]];
          v44 = v41 + 8 * v42;
          ...
          if (*v45) {
            ...
            do {
              ...
              if (v63) {
                ...
                if (*((float *)v64 + 3) != 0.0 || *((_WORD *)v64 + 10)) {
                  v64[3] = 0;
                  *((_WORD *)v64 + 10) = 0;
                  v64[4] = 0;
                  *((_WORD *)v64 + 11) = 0;
                ...
                v93 = (unsigned __int16 *)(a1->anims + 8 * v62 + 12);
                v92 = *v93;
                if (*v93) {
                  v65 = 0;
                  do {
      ...
      LABEL_43:
        if (*(_WORD *)(v41 + 8 * v30 + 12))
          goto LABEL_46;
        v47 = &g_xAnimInfo[10 * *(unsigned __int16 *)&a1->infoArray[2 * v30]];
...
int __cdecl XAnimSetGoalWeight(struct XAnimTree_s *tree, unsigned int animIndex,
  ...
  if (a8) {
    if (a2) {
      ...
      v13 = a2;
      while (1) {
        v14 = &g_xAnimInfo[10 * *(unsigned __int16 *)&a1->infoArray[2 * v13]];
        v15 = anims + 8 * v13;
    ...
    LABEL_6:
      if (!*(_WORD *)(anims + 8 * a2 + 12)) {
        v11 = &g_xAnimInfo[10 * *(unsigned __int16 *)&a1->infoArray[2 * a2]];
...
void __cdecl DObjCalcAnim(struct DObj_s const *obj, int *const partBits) {
  ...
  if (!v3) {
    ...
    do {
      *v7 |= *(int *)((char *)a2 + v4 - 4);
      *(float *)((char *)&v25[3] + v4) = *(float *)((char *)&v24[4095] + v4);
      ++v8;
      v4 += 4;
      ++v7;
    } while (v8 != 5);
    ...
    if (a1->tree) {
      v26 |= 0x80000000;
      XAnimCalc((int **)a1, 0, (float *)(skel + 48), 1.0, (const DObj_s *)1, 0,
                COERCE_FLOAT(v24), 0);
    }
    if (a1->numModels) {
      v22 = a1;
...
void __cdecl DObjUpdateClientInfo(struct DObj_s *obj, float dtime) {
  ...
  if (a1->tree) {
    v2 = 0;
    v3 = 0;
    XAnimUpdateOldTime(a1->tree, 0, &v2, a2, (XAnimTree_s *)1, (_BYTE *)v4 + 1,
                       (XAnimState *)v4);
    XAnimUpdateInfoInternal((char **)a1->tree, 0, 1u, a2);
  }
}
...
void __cdecl XAnimSetAnimRateInternal(struct XAnimTree_s *, unsigned int,
                                      float) {
  UNIMPLEMENTED();
}
...
bool __cdecl XAnimInitTime(struct XAnimInfo *) { UNIMPLEMENTED(); }

void __cdecl XAnimInitInfo(struct XAnimInfo *) { UNIMPLEMENTED(); }
...
unsigned short __cdecl XAnimGetNextNotifyTime(struct XAnimEntry const *,
                                              float) {
  UNIMPLEMENTED();
}
...
void __cdecl XAnim_SetTime(float, int, struct XAnimTime *) { UNIMPLEMENTED(); }
...
void __cdecl XAnim_CalcRotEnd(struct XAnimPartQuat const *, float,
                              float *const) {
  UNIMPLEMENTED();
}
...
void __cdecl XAnim_CalcSimpleRotDuring<unsigned short>(
    struct XAnimTime const *, struct XAnimPartQuat const *, float,
    float *const) {
  UNIMPLEMENTED();
}
...
bool __cdecl XAnimIsDefault(struct XAnimParts_s *) { UNIMPLEMENTED(); }
...
void __cdecl XAnimClearServerNotify(struct XAnimInfo *) { UNIMPLEMENTED(); }
...
LABEL_16:
  ...
  if (v18) {
    ...
    if (!*(_WORD *)(v19 + 12) || (*(_BYTE *)(v19 + 16) & 3) != 0)
      Com_Printf("%s%s: (weight) %.2f -> %.2f, (time) %.2f -> %.2f\n", v12, v35,
                 v10, v11, *((float *)v34 + 4), *((float *)v34 + 3));
    else
...
void __cdecl XAnimCalc(struct DObj_s const *, unsigned int, float,
  ...
  if (*v126) {
    ...
    if (a6) {
          ...
          do {
            if (((*(int *)(LODWORD(a7) + 4 * (v101 >> 5) + 16400) >>
              ...
              if (v102 != 0.0) {
                ...
                v165 = (float)(1.5 - (float)((float)((float)(v102 * 0.5) *
                                                     *(float *)v166) *
                                             *(float *)v166)) *
                       *(float *)v166;
                v103 = a4 * v165;
        ...
        do {
          if (((*(int *)(LODWORD(a7) + 4 * (v105 >> 5) + 16400) >>
            ...
            if (v106 != 0.0) {
              ...
              *(float *)v166 =
                  (float)(1.5 -
                          (float)((float)((float)(v106 * 0.5) * v165) * v165)) *
                  v165;
              v107 = a4 * *(float *)v166;
              *v121 = (float)((float)(a4 * *(float *)v166) * *v96) + *v121;
            ...
            v108 = v96[7];
            if (v108 != 0.0) {
              v121[4] = (float)((float)(a4 / v108) * v96[4]) + v121[4];
              v121[5] = (float)((float)(a4 / v108) * v96[5]) + v121[5];
              v121[6] = (float)((float)(a4 / v108) * v96[6]) + v121[6];
              v121[7] = a4 + v121[7];
            }
          }
          ++v105;
      ...
      v99 = 0;
      do {
        if (((*(int *)(LODWORD(a7) + 4 * (v99 >> 5) + 16400) >> (v99 & 0x1F)) &
             1) == 0) {
          v100 = v121[7];
          if (v100 != 0.0) {
    ...
    if ((_BYTE)a5 && *((_BYTE *)a1 + 25)) {
      ...
      v39 = 0;
      do {
        if (((*(int *)(LODWORD(a7) + 4 * (v39 >> 5) + 16400) >> (v39 & 0x1F)) &
             1) == 0) {
          *v38 = 0.0;
          v38[1] = 0.0;
          v38[2] = 0.0;
          ...
          do {
            ...
            if (v140 > 0) {
              ...
              do {
                ...
                if (v60 >= 0) {
                  if (*(unsigned __int16 *)(2 * v60 + v141) == v65) {
                    v67 = v60;
                    if (*((_BYTE *)&v164[1] + v60) == 127) {
                    LABEL_104:
                      *((_BYTE *)&v164[1] + v67) = v138;
                      *(&__src + (v138 >> 5)) |= 1 << (v138 & 0x1F);
                    }
                  } else {
                    v66 = v141 + 2 * v60;
                    v67 = v60;
        ...
        do {
          ...
          if (v132 > 0) {
            ...
            do {
              ...
              if (v15 >= 0) {
                if (*(unsigned __int16 *)(2 * v15 + v133) == v20) {
                  v22 = v15;
                  if (*((_BYTE *)&v164[1] + v15) == 127) {
                  LABEL_102:
                    *((_BYTE *)&v164[1] + v22) = v130;
                    *(&__src + (v130 >> 5)) |= 1 << (v130 & 0x1F);
                  }
                } else {
                  v21 = v133 + 2 * v15;
                  v22 = v15;
    ...
    if (v30 == 1.0) {
      ...
      if (*v29) {
        if (v31 > 0xFFu) {
          v153 = v25 + 16;
          __src = dword_3BE00C[10 * *((unsigned __int16 *)v127 + a2 + 4)];
          v162 = v31;
          v163 = (float)v31 * v30;
          v164[0] = (int)v163;
          ...
          if (v156 > 0) {
            for (m = 0; m != v156; ++m) {
              if (((*(int *)(LODWORD(a7) + 16400 +
                             4 * ((int)*(unsigned __int8 *)(v153 + m) >> 5)) >>
                    (*(_BYTE *)(v153 + m) & 0x1F)) &
                   1) == 0) {
                v75 = &v121[8 * *(unsigned __int8 *)(v153 + m)];
                v155 = (unsigned __int16 **)(*((_DWORD *)v128 + 6) + 8 * m);
                if (((*(char *)(v157 + (m >> 3)) >> (m & 7)) & 1) != 0) {
                  v71 = v155[1];
                  if (v71) {
                    v72 = *v71;
                    if (*v71) {
                      if (v72 < v162) {
                        XAnim_GetTimeIndexCompressed<unsigned short>(
                            (int)&__src, (int)(v71 + 4), v72, v166, &v165);
                        v89 = v165;
                        v90 = v166[0];
                      } else {
                      ...
                      v91 = (__int16 *)(*((_DWORD *)v71 + 1) + 4 * v90);
                      v75[2] = (float)((float)((float)*v91 +
                                               (float)((float)(v91[2] - *v91) *
                                                       v89)) *
                                       v70) +
                               v75[2];
                      v75[3] = (float)((float)((float)v91[1] +
                                               (float)(v89 * (float)(v91[3] -
                                                                     v91[1]))) *
                                       v70) +
                               v75[3];
                    } else {
                      v75[2] = (float)((float)(__int16)v71[2] * v70) + v75[2];
                      v75[3] = (float)((float)(__int16)v71[3] * v70) + v75[3];
                    }
                  } else {
                    v75[3] = a4 + v75[3];
                  }
                  ...
                  if (*v76) {
                    if (v77 < v162) {
                      XAnim_GetTimeIndexCompressed<unsigned short>(
                          (int)&__src, (int)(v76 + 4), v77, (int *)&v165,
                          (float *)v166);
                      v86 = *(float *)v166;
                      v87 = v165;
                    } else {
                      *(float *)v166 = v163 - (float)v164[0];
                      v165 = *(float *)v164;
                      v86 = *(float *)v166;
                      v87 = *(float *)v164;
                    }
                    v88 = (__int16 *)(*((_DWORD *)v76 + 1) + 8 * LODWORD(v87));
                    *v75 =
                        (float)((float)((float)*v88 +
                                        (float)((float)(v88[4] - *v88) * v86)) *
                                v70) +
                        *v75;
                    v75[1] = (float)((float)((float)v88[1] +
                                             (float)((float)(v88[5] - v88[1]) *
                                                     v86)) *
                                     v70) +
                             v75[1];
                    v75[2] = (float)((float)((float)v88[2] +
                                             (float)((float)(v88[6] - v88[2]) *
                                                     v86)) *
                                     v70) +
                             v75[2];
                    v75[3] = (float)((float)((float)v88[3] +
                                             (float)(v86 * (float)(v88[7] -
                                                                   v88[3]))) *
                                     v70) +
                             v75[3];
                  } else {
                    *v75 = (float)((float)(__int16)v76[2] * v70) + *v75;
                    v75[1] = (float)((float)(__int16)v76[3] * v70) + v75[1];
                    v75[2] = (float)((float)(__int16)v76[4] * v70) + v75[2];
                    v75[3] = (float)((float)(__int16)v76[5] * v70) + v75[3];
                  }
                }
                v73 = *v155;
                if (*v155) {
                  ...
                  if (*v73) {
                    if (v74 < v162) {
                      XAnim_GetTimeIndexCompressed<unsigned short>(
                          (int)&__src, (int)(v73 + 4), v74, (int *)&v165,
                          (float *)v166);
                      v79 = *(float *)v166;
                      v78 = v165;
                    } else {
                    ...
                    v80 = (float *)(*((_DWORD *)v73 + 1) + 12 * LODWORD(v78));
                    v75[4] =
                        (float)((float)(*v80 +
                                        (float)((float)(v80[3] - *v80) * v79)) *
                                a4) +
                        v75[4];
                    v75[5] = (float)((float)(v80[1] +
                                             (float)((float)(v80[4] - v80[1]) *
                                                     v79)) *
                                     a4) +
                             v75[5];
                    v75[6] = (float)((float)(v80[2] +
                                             (float)(v79 * (float)(v80[5] -
                                                                   v80[2]))) *
                                     a4) +
                             v75[6];
                  } else {
                    v75[4] = (float)(a4 * *((float *)v73 + 1)) + v75[4];
                    v75[5] = (float)(a4 * *((float *)v73 + 2)) + v75[5];
                    v75[6] = (float)(a4 * *((float *)v73 + 3)) + v75[6];
                  }
                }
                v75[7] = a4 + v75[7];
              }
          ...
          if (v151 > 0) {
            for (n = 0; n != v151; ++n) {
              if (((*(int *)(LODWORD(a7) + 16400 +
                             4 * ((int)*(unsigned __int8 *)(n + v148) >> 5)) >>
                    (*(_BYTE *)(n + v148) & 0x1F)) &
                   1) == 0) {
                v35 = &v121[8 * *(unsigned __int8 *)(n + v148)];
                v150 = *((_DWORD *)v128 + 6) + 8 * n;
                if (((*(char *)(v152 + (n >> 3)) >> (n & 7)) & 1) != 0) {
                  v33 = *(unsigned __int16 **)(v150 + 4);
                  if (v33) {
                    if (*v33) {
                      XAnim_GetTimeIndex<unsigned char>(
                          (int)&__src, (int)(v33 + 4), *v33, (int *)&v165,
                          (float *)v166);
                      v94 = *(float *)v166;
                      v95 =
                          (__int16 *)(*((_DWORD *)v33 + 1) + 4 * LODWORD(v165));
                      v35[2] = (float)((float)((float)*v95 +
                                               (float)((float)(v95[2] - *v95) *
                                                       *(float *)v166)) *
                                       v32) +
                               v35[2];
                      v35[3] = (float)((float)((float)v95[1] +
                                               (float)(v94 * (float)(v95[3] -
                                                                     v95[1]))) *
                                       v32) +
                               v35[3];
                    } else {
                      v35[2] = (float)((float)(__int16)v33[2] * v32) + v35[2];
                      v35[3] = (float)((float)(__int16)v33[3] * v32) + v35[3];
                    }
                  } else {
                    v35[3] = a4 + v35[3];
                  }
                  ...
                  if (*v36) {
                    XAnim_GetTimeIndex<unsigned char>(
                        (int)&__src, (int)(v36 + 4), *v36, v166, &v165);
                    v92 = v165;
                    v93 = (__int16 *)(*((_DWORD *)v36 + 1) + 8 * v166[0]);
                    *v35 = (float)((float)((float)*v93 +
                                           (float)((float)(v93[4] - *v93) *
                                                   v165)) *
                                   v32) +
                           *v35;
                    v35[1] = (float)((float)((float)v93[1] +
                                             (float)((float)(v93[5] - v93[1]) *
                                                     v92)) *
                                     v32) +
                             v35[1];
                    v35[2] = (float)((float)((float)v93[2] +
                                             (float)((float)(v93[6] - v93[2]) *
                                                     v92)) *
                                     v32) +
                             v35[2];
                    v35[3] = (float)((float)((float)v93[3] +
                                             (float)(v92 * (float)(v93[7] -
                                                                   v93[3]))) *
                                     v32) +
                             v35[3];
                  } else {
                    *v35 = (float)((float)(__int16)v36[2] * v32) + *v35;
                    v35[1] = (float)((float)(__int16)v36[3] * v32) + v35[1];
                    v35[2] = (float)((float)(__int16)v36[4] * v32) + v35[2];
                    v35[3] = (float)((float)(__int16)v36[5] * v32) + v35[3];
                  }
                }
                ...
                if (*(_DWORD *)v150) {
                  if (*v34) {
                    XAnim_GetTimeIndex<unsigned char>(
                        (int)&__src, (int)(v34 + 4), *v34, (int *)&v165,
                        (float *)v166);
                    v81 = *(float *)v166;
                    v82 = (float *)(*((_DWORD *)v34 + 1) + 12 * LODWORD(v165));
                    v35[4] =
                        (float)((float)(*v82 + (float)((float)(v82[3] - *v82) *
                                                       *(float *)v166)) *
                                a4) +
                        v35[4];
                    v35[5] = (float)((float)(v82[1] +
                                             (float)((float)(v82[4] - v82[1]) *
                                                     v81)) *
                                     a4) +
                             v35[5];
                    v35[6] = (float)((float)(v82[2] +
                                             (float)(v81 * (float)(v82[5] -
                                                                   v82[2]))) *
                                     a4) +
                             v35[6];
                  } else {
                    v35[4] = (float)(a4 * *((float *)v34 + 1)) + v35[4];
                    v35[5] = (float)(a4 * *((float *)v34 + 2)) + v35[5];
                    v35[6] = (float)(a4 * *((float *)v34 + 3)) + v35[6];
                  }
                }
                v35[7] = a4 + v35[7];
              }
    ...
    if (v146 > 0) {
      for (ii = 0; ii != v146; ++ii) {
        if (((*(int *)(LODWORD(a7) + 16400 +
                       4 * ((int)*(unsigned __int8 *)(v145 + ii) >> 5)) >>
              (*(_BYTE *)(v145 + ii) & 0x1F)) &
             1) == 0) {
          ...
          for (i = 0; i != v42; ++i) {
            ...
            if (v27) {
              ...
              if (*((float *)v28 + 8) != 0.0) {
                ...
                if (v47)
                  XAnimProcessServerNotify(a1, (float *)v28, (int)v48, *v7);
                *v29 = *v7;
                *((_WORD *)v28 + 10) = *((_WORD *)v43 + 10);
                *((_WORD *)v28 + 1) = -1;
                if (v47)
                  XAnimProcessClientNotify((unsigned int)v28, (int)v48, v50);
                v33 = *(unsigned __int16 *)v48;
                if (*(_WORD *)v48) {
                  v34 = 0;
                  do {
                    XAnimUpdateInfoSyncInternal(
                        a1, v34 + *((unsigned __int16 *)v48 + 3), v47, v50,
                        (XAnimInfo *)v7);
                    ++v34;
                  } while (v33 != v34);
                }
