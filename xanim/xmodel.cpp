...
int __cdecl XModelGetCollisionLod(struct XModel const *) { UNIMPLEMENTED(); }
...
void __cdecl XModelSetOptimize(int) { UNIMPLEMENTED(); }
...
int __cdecl XModelTraceLine(struct XModel const *model, struct trace_t *results,
  ...
  do {
    ...
    if (!CM_TraceBox(&v86, (const float *)(v8 + 8), (const float *)(v8 + 20),
                     LODWORD(a2->fraction))) {
      v59 = v86.end[0];
      ...
      if (*(int *)(v8 + 4) > 0) {
        ...
        do {
          ...
          v32 = v31[1];
          v33 = v31[3];
          v34 = (float)((float)((float)(v59 * *v31) + (float)(v60 * v32)) +
                        (float)(v31[2] * v29)) -
                v33;
          if (v34 < 0.0) {
            v35 = (float)((float)((float)(v58 * *v31) + (float)(v32 * v57)) +
                          (float)(v31[2] * v56)) -
                  v33;
            if (v35 > 0.0) {
              v36 = v35 - v34;
              ...
              if (v37 < a2->fraction) {
                ...
                v40 =
                    (float)((float)((float)(v39 * v31[4]) +
                                    (float)((float)((float)(v82 * v38) + v57) *
                                            v31[5])) +
                            (float)((float)((float)(v81 * v38) + v56) *
                                    v31[6])) -
                    v31[7];
                if (v40 >= -0.001 && v40 <= 1.001) {
                  v41 = (float)((float)((float)(v39 * v31[8]) +
                                        (float)((float)((float)(v82 * v38) +
                                                        v57) *
                                                v31[9])) +
                                (float)((float)((float)(v81 * v38) + v56) *
                                        v31[10])) -
                        v31[11];
                  if (v41 >= -0.001 && (float)(v40 + v41) <= 1.001) {
                    a2->startsolid = 0;
                    a2->allsolid = 0;
                    a2->fraction = v37;
...
void __cdecl XModelFree(struct XModel *model) { UNIMPLEMENTED(); }

void __cdecl XModelPartsFree(struct XModelParts_s *model) { UNIMPLEMENTED(); }
...
XModelPartsFindData(char const *name) { UNIMPLEMENTED(); }
...
XModelSurfsFindData(char const *name) { UNIMPLEMENTED(); }
