...
public:
long __cdecl D3DDevice::BeginScene(void) { UNIMPLEMENTED(); }
...
public:
long __cdecl D3DDevice::BlockUntilIdle(void) { UNIMPLEMENTED(); }

public:
unsigned long __cdecl D3DDevice::InsertFence(void) { UNIMPLEMENTED(); }

public:
int __cdecl D3DResource::IsBusy(void) { UNIMPLEMENTED(); }
...
void __cdecl RB_EndSurfaceIfNeeded(void) { UNIMPLEMENTED(); }

void __cdecl RB_SetCodeConstantFromVec4(int, float const *const) {
  UNIMPLEMENTED();
}

float const *__cdecl RB_GetCodeConstant(int) { UNIMPLEMENTED(); }
...
void __cdecl RB_Overflow(void) { UNIMPLEMENTED(); }

void __cdecl RB_CheckOverflow(int, int) { UNIMPLEMENTED(); }

void __cdecl RB_SetFeedbackImage(struct GfxImage *) { UNIMPLEMENTED(); }

void __cdecl RB_SetIndices(struct D3DIndexBuffer *) { UNIMPLEMENTED(); }
...
void __cdecl RB_FlushGpu(void) { UNIMPLEMENTED(); }
...
void __cdecl RB_CheckSkinnedCacheNotBusy(void) { UNIMPLEMENTED(); }
...
void __cdecl RB_Resolve(struct GfxImage *) { UNIMPLEMENTED(); }

void __cdecl RB_Set3D() { UNIMPLEMENTED(); }
...
void __cdecl RB_FullScreenFilter(struct Material const *) { UNIMPLEMENTED(); }
...
void __cdecl RB_ExecuteRenderCommands(void const *data) {
  ...
  if (!byte_11805DC) {
    v15 =
        (*(int(__cdecl **)(int))(*(_DWORD *)dword_117D8A8 + 12))(dword_117D8A8);
...
LABEL_9:
  ...
  if (*(int *)(r_testFill + 8) > 0) {
    if (*(_BYTE *)(r_testFillEnable + 8)) {
      ...
      v38 = ri;
      a3.f32[0] = (float)SHIDWORD(qword_1186C9C);
      v39 = (float)(RB_BenchmarkRepeatedCalls((const Material *)rgp[1054],
                                              *(_DWORD *)(r_testFill + 8), v37,
                                              (float)(int)qword_1186C9C, a3, a4,
                                              a5, a6, a7) /
                    60.0);
      ...
      if (byte_1180618) {
        ...
        v58 = RB_BenchmarkRepeatedCalls(
            ...
            (float)(int)qword_1186C9C, a3, a4, a5, a6, a7);
        v37 = v57(0, "2-sided stencil keep fill   %4.1f overdraw @ 60Hz\n",
                  (float)(v58 / 60.0));
        v59 = ri;
        a3.f32[0] = (float)SHIDWORD(qword_1186C9C);
        v39 = (float)(RB_BenchmarkRepeatedCalls((const Material *)rgp[1056],
                                                *(_DWORD *)(r_testFill + 8),
                                                v37, (float)(int)qword_1186C9C,
                                                a3, a4, a5, a6, a7) /
                      60.0);
        v59(0, "2-sided stencil reject fill %4.1f overdraw @ 60Hz\n", v39);
      }
      v40 = ri;
      v41 = RB_TestFillPass3D((const Material *)rgp[1057], TECHNIQUE_POINTLIGHT,
                              v37, *(float *)&v39, a3, a4, a5, a6, a7);
      v42 = v40(0, "phong point bump fill       %4.1f overdraw @ 60Hz\n", v41);
      v43 = ri;
      v44 = RB_TestFillPass3D((const Material *)rgp[1058], TECHNIQUE_POINTLIGHT,
                              v42, *(float *)&v41, a3, a4, a5, a6, a7);
      ...
      v49 = ri;
      *(float *)&v47 = RB_TestFillPass3D(
          (const Material *)rgp[1058], TECHNIQUE_LIGHTPROBE_NOT_CACHED_FIRST,
          v48, *(float *)&v47, a3, a4, a5, a6, a7);
      v49(0, "phong dir bump+spec fill    %4.1f overdraw @ 60Hz\n",
          *(float *)&v47);
      a1 = ri(0, "-----------------------------------------------\n");
    } else {
      ri(0, "Fill testing uses extra textures and materials, so it is usually "
            "unavailable.\n");
      a1 = ri(0, "You must set 'r_testFillEnable' to 1 and vid_restart to test "
                 "fill rates.\n");
    }
    dword_1180758(r_testFill, 0);
  }
  if (*(int *)(r_testTransform + 8) > 0) {
    v66 = RB_BenchmarkRepeatedCalls((const Material *)rgp[1038], 1362, a1, 0.0,
                                    (__m128)0LL, a4, a5, a6, a7) /
          60.0;
    ri(0, "-----------------------------------------------\n");
...
void __cdecl RB_RenderThread(void) { UNIMPLEMENTED(); }
...
void __cdecl R_SetSkinnedCacheEvent(void) { UNIMPLEMENTED(); }
...
bool __cdecl RB_UsingGlow(void) { UNIMPLEMENTED(); }

bool __cdecl RB_UsingBlur(float) { UNIMPLEMENTED(); }

int __cdecl RB_GetGlowRadiusOrder(float *const) { UNIMPLEMENTED(); }
...
void __cdecl RB_SetViewProjectionMatrix(void) { UNIMPLEMENTED(); }

void const *__cdecl RB_NextRenderCmd(void const *) { UNIMPLEMENTED(); }

void __cdecl RB_SetOutdoorFeatherConst(void) { UNIMPLEMENTED(); }

void __cdecl RB_DeriveNearPlaneConstantsForView(void) { UNIMPLEMENTED(); }

bool __cdecl RB_UsingPostEffects(float) { UNIMPLEMENTED(); }
...
void __cdecl RB_SetTessVertex2d(int, float, float, float, float,
                                unsigned long) {
  UNIMPLEMENTED();
}
...
float __cdecl RB_GetBlurRadius(float) { UNIMPLEMENTED(); }
...
void __cdecl RB_SetGameTime(float) { UNIMPLEMENTED(); }
...
void __cdecl RB_SetClipPlanesCmd(struct GfxRenderCommandExecState *) {
  ...
  if (*(int *)(v2 + 4) > 0) {
    ...
    do {
      do
        (*(void(__cdecl **)(int, int, int))(*(_DWORD *)dword_117D8A8 + 220))(
            dword_117D8A8, v4, v5);
      while (alwaysfails);
      ++v4;
      v5 += 16;
...
void __cdecl RB_FinishGpu(void) { UNIMPLEMENTED(); }

void __cdecl RB_EndBenchmarkGpu(union _LARGE_INTEGER *) { UNIMPLEMENTED(); }

void __cdecl RB_BeginBenchmarkGpu(union _LARGE_INTEGER *) { UNIMPLEMENTED(); }

void __cdecl RB_BeginFrame(void) { UNIMPLEMENTED(); }

void __cdecl RB_ResolveTile(void) { UNIMPLEMENTED(); }
...
void __cdecl RB_UpdateBackEndDvarOptions(void) { UNIMPLEMENTED(); }

void __cdecl RB_RestoreViewAfterTiling(void) { UNIMPLEMENTED(); }
...
void __cdecl RB_Set2D(void) { UNIMPLEMENTED(); }
...
void __cdecl RB_BlurShadowPass(float, float) { UNIMPLEMENTED(); }

void __cdecl RB_ShowShadowsDebug(void) { UNIMPLEMENTED(); }

void __cdecl RB_ShowFloatZDebug(void) { UNIMPLEMENTED(); }

void __cdecl RB_ShowFbColorDebug_Screen(void) { UNIMPLEMENTED(); }

void __cdecl RB_ShowFbColorDebug_Feedback(void) { UNIMPLEMENTED(); }
...
float __cdecl RB_TestFillPass(struct Material const *) { UNIMPLEMENTED(); }
...
void __cdecl RB_DrawDebugPostEffects(void) { UNIMPLEMENTED(); }

void __cdecl RB_DrawFullScreenColoredQuadCmd(
    struct GfxRenderCommandExecState *) {
  UNIMPLEMENTED();
}

void __cdecl RB_FullScreenColoredFilter(struct Material const *,
                                        unsigned long) {
  UNIMPLEMENTED();
}
...
void __cdecl RB_TestTransform(void) { UNIMPLEMENTED(); }

void __cdecl RB_TestFill(void) { UNIMPLEMENTED(); }
...
void __cdecl RB_AdjustViewForTile(void) { UNIMPLEMENTED(); }
...
void __cdecl RB_BlurScreen(float) { UNIMPLEMENTED(); }

void __cdecl RB_CalcGlowEffect(void) { UNIMPLEMENTED(); }
...
void __cdecl RB_ApplyGlowEffectPass(int, struct GfxImage *) { UNIMPLEMENTED(); }

void __cdecl RB_DrawSpriteCmd(struct GfxRenderCommandExecState *) {
  UNIMPLEMENTED();
}

void __cdecl RB_ApplyGlowEffect(void) { UNIMPLEMENTED(); }

void __cdecl RB_ProcessPostEffects(float) { UNIMPLEMENTED(); }

void __cdecl RB_RenderCommandFrame(void const *) { UNIMPLEMENTED(); }

void __cdecl RB_ApplyLatePostEffectsCmd(struct GfxRenderCommandExecState *) {
  UNIMPLEMENTED();
}

RB_IsGpuFenceFinished() { UNIMPLEMENTED(); }

RB_GpuWaited(int ticks) { UNIMPLEMENTED(); }

RB_AdaptiveGpuSyncWait() { UNIMPLEMENTED(); }

RB_AdaptiveGpuSyncTarget() { UNIMPLEMENTED(); }
