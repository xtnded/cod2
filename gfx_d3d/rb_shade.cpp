...
void __cdecl RB_BeginSurface(struct Material const *material,
                             enum MaterialTechniqueType techType, int lmapIndex)
{
  int *result; // eax
...
int __cdecl RB_SetIndexData(unsigned short const *, int)
{
  ...
  v6 = (IDirect3DIndexBuffer9 *)v3[2];
    if (v4 || !dword_11804C0 && !v5) {
      if ((*(int(__cdecl **)(IDirect3DIndexBuffer9 *, int, size_t, void **,
                             int))(*(_DWORD *)v6 + 44))(v6, v5, v2, __dst,
                                                        0x2000) >= 0)
        goto LABEL_11;
      goto LABEL_8;
    }
    ...
    if (*(_DWORD *)(r_rendererInUse + 8) == 2) {
        ...
        if ((unsigned int)(dword_11E15C0 - 15) > 2) {
          v2 = dword_11E1A44;
            if (dword_11E1A44) {
              ...
              return RB_SetEntityHwLightsDx7((float *)(v2 + 8),
                                             *(_DWORD *)(v2 + 4));
            }
      ...
      v0 = dword_11E1A44;
        if (dword_11E1A44) {
          ...
          RB_SetCodeConstant(133, flt_11E44B0[0], flt_11E44B0[1],
                             flt_11E44B0[2], *(float *)(v0 + 4));
