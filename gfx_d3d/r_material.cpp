...
public:
unsigned long __cdecl D3DVertexDeclaration::Release(void)
{
  UNIMPLEMENTED();
}
...
struct Material **__cdecl std::_Val_type<struct Material **>(struct Material **)
{
  UNIMPLEMENTED();
}
            ...
            while (1) {
              ...
              v4 = v24[0] - 1;
                if ((unsigned __int8)*v3 >=
                    (unsigned int)LOWORD(v24[2 * v24[0] + 2])) {
                  v4 = v24[0];
                }
                else {
                  v5 = v24[0];
    ...
    do {
        while (1) {
          ...
          result = (*(int(__cdecl **)(int, _DWORD, int))(
              *(_DWORD *)dword_117D8A8 + 364))(dword_117D8A8,
                                               *(_DWORD *)(v11 + 4), v11 + 12);
          v10 = result;
          if (result < 0)
            goto LABEL_29;
      ...
      result = (*(int(__cdecl **)(int, _DWORD, int))(
          *(_DWORD *)dword_117D8A8 + 424))(dword_117D8A8, *(_DWORD *)(v11 + 4),
                                           v11 + 12);
      v10 = result;
      if (result >= 0)
        goto LABEL_25;
...
void __cdecl Material_DirtySort(void)
{
  UNIMPLEMENTED();
}
...
struct Material *__cdecl R_RegisterRawImage(char const *name,
                                            int baseImageFlags, int imageTrack)
{
  _DWORD *v1; // edx
  _DWORD *v3; // ecx
...
void __cdecl Unload_Material(struct Material *)
{
  UNIMPLEMENTED();
}
    ...
    struct MaterialVertexDeclaration **mtlVertDecl)
{
  ...
  v10 = (char *)&s_streamSourceInfo;
    do {
            ...
            while (1) {
              ...
              v5 = v18;
                while (1) {
                  ...
                  v19[0] = v3 - 1;
                  v7 =
                      *(unsigned __int16 *)((char *)v4 + (char *)&v19[2 * v18] -
                                            (char *)v16);
                  v4 -= 2;
      ...
      do
        (*(void(__cdecl **)(int, _DWORD *, int *))(
            *(_DWORD *)dword_117D8A8 + 344))(dword_117D8A8, v20, v21);
      while (alwaysfails);
      result = v21[0];
    LABEL_17:
...
bool __cdecl Material_Compare(struct Material const *, struct Material const *)
{
  unsigned int v2; // eax
...
void __cdecl Material_LoadBuiltIn(struct BuiltInMaterialTable const *const, int)
{
  UNIMPLEMENTED();
}
