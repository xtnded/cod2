float __cdecl exp(float) { UNIMPLEMENTED(); }
    ...
    *a4 = v4.f32[0];
    ...
    if (v10.f32[0] == 0.0) {
      ...
      *v6 = fsqrt(v10.f32[0]);
      g_LastGlowFilter = 1;
      unk_11E1AD8 =
          dx[5 * RB_ApplyGlowFilter(v9, R_RENDERTARGET_GLOW_0, a1, *v6, v10, v4,
                                    (__m128)0LL, a2, a3) +
             2828];
      dword_11E1AD0 = 2;
    }
...
void __cdecl RB_FilterImage(struct GfxImageFilter *) { UNIMPLEMENTED(); }
