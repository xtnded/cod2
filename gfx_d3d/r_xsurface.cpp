  ...
  if (boneOffset == -1) {
    ...
    if ((_WORD)result) {
      ...
      do {
        ...
        *(v13 - 3) = (float)((float)((float)(*(float *)(verts + 48) * *v15) +
                                     (float)(*(float *)(verts + 52) * v15[4])) +
                             (float)(*(float *)(verts + 56) * v15[8])) +
                     v15[12];
        *(v13 - 2) = (float)((float)((float)(*(float *)(verts + 48) * v15[1]) +
                                     (float)(*(float *)(verts + 52) * v15[5])) +
                             (float)(*(float *)(verts + 56) * v15[9])) +
                     v15[13];
        *(v13 - 1) = (float)((float)((float)(*(float *)(verts + 48) * v15[2]) +
        ...
        if ((_BYTE)result) {
          ...
          *(v13 - 1) = v16 * *(v13 - 1);
          ...
          do {
            ...
            v20 = (float)*(unsigned __int16 *)(v17 + 14) * 0.000015258789;
            *(v13 - 3) =
                (float)((float)((float)((float)((float)(*(float *)v17 * *v19) +
                                                (float)(*(float *)(v17 + 4) *
                                                        v19[4])) +
                                        (float)(*(float *)(v17 + 8) * v19[8])) +
                                v19[12]) *
                        v20) +
                *(v13 - 3);
            *(v13 - 2) =
      ...
      do {
        if (a5) {
          *a5 = (float)((float)(*v8 * *v10) + (float)(v8[1] * v10[4])) +
                (float)(v8[2] * v10[8]);
          a5[1] = (float)((float)(*v8 * v10[1]) + (float)(v8[1] * v10[5])) +
                  (float)(v8[2] * v10[9]);
          a5[2] = (float)((float)(*v8 * v10[2]) + (float)(v8[1] * v10[6])) +
                  (float)(v8[2] * v10[10]);
          a5 += 3;
        }
        result = a4;
        ...
        *v5 =
            (float)((float)((float)(v8[12] * *v10) + (float)(v8[13] * v10[4])) +
                    (float)(v8[14] * v10[8])) +
            v10[12];
