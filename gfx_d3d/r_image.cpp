...
int __cdecl Image_MipmapRes(int, int)
{
  UNIMPLEMENTED();
}
...
struct GfxImage **__cdecl std::_Val_type<struct GfxImage **>(struct GfxImage **)
{
  UNIMPLEMENTED();
}
...
void *__cdecl Image_PhysicalAlloc(int)
{
  UNIMPLEMENTED();
}
...
void __cdecl R_SumOfUsedImages(struct Image_MemUsage *)
{
  UNIMPLEMENTED();
}
          ...
          v15 = *(_DWORD *)v14;
            if (*(_DWORD *)v14 == 4) {
              (*(void(__cdecl **)(_DWORD, _DWORD, int *, int))(
                  **(_DWORD **)(v14 + 4) + 68))(*(_DWORD *)(v14 + 4), 0, v51,
                                                v37);
              v16 = v51[0];
            }
            else {
              ...
              (*(void(__cdecl **)(int, _DWORD, int *))(*(_DWORD *)v29 + 68))(
                  v29, 0, v50);
              v16 = v50[0];
            }
            if (v16 == 50) {
...
void __cdecl Image_RebuildCosinePowerMap(float shift)
{
  ...
  result = (int *)r_rendererInUse;
    if (*(_DWORD *)(r_rendererInUse + 8) != 2) {
      ...
      *(_WORD *)(v2 + 28) = 1;
      *(_DWORD *)v2 = 3;
      v3 = (*(int(__cdecl **)(int, int, int, int, _DWORD, int, int, int,
                              _DWORD))(*(_DWORD *)dword_117D8A8 + 92))(
          dword_117D8A8, 32, 256, 1, 0, 50, 1, v2 + 4, 0);
        if (v3 < 0) {
...
struct GfxImage *__cdecl Image_Register(char const *imageName,
                                        unsigned char semantic, int imageTrack)
{
  int v3;       // ebx
  GfxImage *v4; // esi
  int v5;       // eax
...
int __cdecl Image_GetPlatformScreenHeight(int)
{
  UNIMPLEMENTED();
}

int __cdecl Image_GetPlatformScreenWidth(int)
{
  UNIMPLEMENTED();
}
