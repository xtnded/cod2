...
struct Font_s *__cdecl R_RegisterFont(char const *fontName, int imageTrack)
{
  ...
  v2 = registeredFontCount;
    ...
    LABEL_2:
        if (v2 > 15) {
          R_Error(ERR_DROP,
                  "R_RegisterFont: Too many fonts registered already.\n");
          return 0;
        }
        else {
          Font = R_LoadFont(a1, a2);
          if (!Font)
            R_Error(ERR_DROP, "R_RegisterFont: Error while reading font '%s'",
                    a1);
      ...
      v26 = 0.0;
        for (result = (int)R_GetConsoleString(a1, &a2, __src, v33,
          ...
          ConsoleIcon = (_WORD *)result;
            if (__src[0]) {
              result = R_AddCmdDrawTextWithCursor(
                  __src, 0x7FFFFFFF, a3, v26 + a4, *(float *)&a5, *(float *)&a6,
                  *(float *)&a7, v33, a9, -1, 0);
              if (!BYTE1(v38[0]))
                goto LABEL_4;
              v36 = __src;
                ...
                if (*v10) {
                    while (v28 > v29) {
                      ...
                      v11 = result;
                        ...
                        if (v11 - 32 <= 0x5F) {
                          v12 =
                              (unsigned __int16 *)(a3->glyphs + 24 * v11 - 768);
                          goto LABEL_18;
                        }
                      glyphCount = a3->glyphCount;
                      v19 = glyphCount - 1;
          ...
          ConsoleIcon = (_WORD *)R_GetConsoleIcon((int)ConsoleIcon, &a2, &v34,
                                                  v35, (int *)&v37, v33, v38);
          ...
          *(float *)v35 = v16;
          v17 = (float)((float)((float)(v15 * 0.80000001) + v16) * -0.5) +
                *(float *)&a5;
          if (LOBYTE(v38[0]))
            result = R_AddCmdDrawStretchPic(a4 + v26, v17, v14, v16, 1.0, 0.0,
                                            0.0, 1.0, v33, v37);
          else
            result = R_AddCmdDrawStretchPic(a4 + v26, v17, v14, v16, 0.0, 0.0,
                                            1.0, 1.0, v33, v37);
          v26 = v26 + v34;
          if (!ConsoleIcon)
            return result;
    ...
    if (a1) {
      ...
      v19 = 0.0;
        ...
        LABEL_6:
          ...
          v19 = (float)v24 + v19;
            if (LOBYTE(v30[0])) {
              ConsoleString = (__int16 *)R_GetConsoleIcon(
                  (int)ConsoleString, &a2, &v29, &v28, &v27, 0, 0);
              v19 = v19 + v29;
            }
        }
      while (ConsoleString);
...
short const *__cdecl R_GetConsoleIcon(short const *, int *, float *, float *,
                                      struct Material **, float *const, bool *)
{
  UNIMPLEMENTED();
}
