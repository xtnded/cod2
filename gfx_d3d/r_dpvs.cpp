...
int __cdecl R_CellForPoint(float const *const origin)
{
  ...
  if (!dword_1184B9C)
    ...
    for (i = *(_DWORD *)(dword_1184B9C + 12); *(_DWORD *)i == -1;
         i = *(_DWORD *)(i + 20)) {
        while ((float)((float)((float)((float)(*a1 * **(float **)(i + 12)) +
                                       (float)(a1[1] *
                                               *(float *)(*(_DWORD *)(i + 12) +
                                                          4))) +
                               (float)(a1[2] *
                                    ...
                                    int cameraCellIndex)
{
  ...
  R_FrustumClipPlanes(a1->viewProjectionMatrix,
    ...
    if (a1->projectionMatrix[15] == 0.0) {
      ...
      *(float *)&dpvsGlob.coeffs[12] =
          262144.0 -
          (float)((float)((float)(*(float *)dpvsGlob.coeffs *
                                  *(float *)stru_C96E68.coeffs) +
                          (float)(*(float *)&dpvsGlob.coeffs[4] *
                                  *(float *)&stru_C96E68.coeffs[4])) +
                  (float)(*(float *)&dpvsGlob.coeffs[8] *
        ...
        do {
          v22 = stru_1155004.entities + v66;
            if (*(int *)(stru_1155004.entities + v66) <= 1) {
              ...
              v42 = *(float *)(v22 + 56);
              *(float *)&v73.node.plane =
                  (float)(v42 * v75) + *(float *)(v22 + 60);
              *((float *)&v73.leaf + 1) =
                  (float)(v42 * v76) + *(float *)(v22 + 64);
              *((float *)&v73.leaf + 2) =
                  (float)(v42 * v77) + *(float *)(v22 + 68);
              v43 = *(float *)(v22 + 56);
              *(float *)&v74.contents =
                  (float)(v43 * *(float *)&v74.u.node.plane) +
                  *(float *)(v22 + 60);
              *(float *)&v74.parent =
                  (float)(v43 * *((float *)&v74.u.leaf + 1)) +
                  *(float *)(v22 + 64);
              *(float *)&v74.cellIndex =
                  (float)(v43 * *((float *)&v74.u.leaf + 2)) +
                  *(float *)(v22 + 68);
              if (v61 <= 0)
                goto LABEL_83;
              HIBYTE(v67.maxs[0]) = -1;
                      ...
                      v64 = 0;
                        for (i = 0;; i = v64) {
                          ...
                          if (*(int *)(v49 + 28) <= 0)
                            break;
                          *(_BYTE *)(v50 + 19) = -1;
                            if ((float)((float)((float)((float)(*(float
                                                                      *)((char
                                                                              *)&v73
                                                                             .node
                                                                             .plane +
                ...
                LABEL_99:
                    if ((float)(*(float *)&v74.contents -
                                *(float *)&v73.node.plane) <= 1536.0) {
                      if ((float)(*(float *)&v74.parent -
                                  *((float *)&v73.leaf + 1)) > 1536.0)
                        goto LABEL_107;
                    }
                    else {
                        if ((float)(*(float *)&v74.parent -
                        ...
                        LABEL_101:
                          ...
                          CG_CullIn(
                              (const centity_s *)*(&scene + 13 * v65 + 371));
                    ...
                    LABEL_107:
                      if ((float)(*(float *)&v74.cellIndex -
                                  *((float *)&v73.leaf + 2)) > 1536.0)
                        goto LABEL_101;
                    }
                  if (R_FilterEntityIntoCells_r(*(_DWORD *)(dword_1184B9C + 12),
                                                v65, &v73, &v74) != -1)
                    goto LABEL_40;
                  goto LABEL_101;
                }
              ...
              HIBYTE(v67.maxs[0]) = -1;
                if ((float)((float)((float)(*(float *)((char *)&v73.node.plane +
                                                       BYTE2(v67.maxs[0])) *
                                            v67.mins[1]) +
                                    (float)((float)(*(float *)&v67.writable
                                                         .markCount *
                                                    *(float *)((char *)&v73.node
                                                                   .plane +
                                                               LOBYTE(
                ...
                LABEL_46:
                    if (dword_C96E58 <= 0) {
                    LABEL_54:
                      if (R_FilterEntityIntoCells_r(
                              *(_DWORD *)(dword_1184B9C + 12), v65, &v73,
                              &v74) == -1)
                        R_AddBModelSurfaces(
                            (GfxSceneEntity *)(&scene + 13 * v65 + 369), v65);
                    }
                    else {
                      v28 = 0;
                        while (1) {
        ...
        if (a2 < 0) {
          v58 = dword_1184B9C;
            if (*(int *)(dword_1184B9C + 252) > 0) {
              ...
              v60 = 0;
                do {
                  R_AddVisibleSurfacesInCell(
                      (char *)(v60 + *(_DWORD *)(v58 + 256)), (int)&v67, v61);
                  ++v59;
                  v58 = dword_1184B9C;
                  v60 += 60;
                }
          ...
          v35 = (char *)(*(_DWORD *)(dword_1184B9C + 256) + 60 * a2);
            if (*(_BYTE *)(r_singleCell + 8)) {
              ...
              R_VisitPortals((const GfxCell *)v35, &dpvsGlob, &v67,
                             (GfxPortal *)v61);
            }
        }
    }
          ...
          v57 = 0;
            do {
              R_AddWorldSurfaceWithCull(
                  *(_DWORD *)(*(_DWORD *)(v36 + 28) + 4 * v57++), (int)&v67,
                  v61 - 1, 0);
              v36 = dword_1184B9C;
            }
...
float (*__cdecl R_ChopPortalWinding(float (*)[3], int *,
                                    struct DpvsPlane const *, float (*)[3]))[3]
{
  UNIMPLEMENTED();
}
      ...
      *(_DWORD *)(v112 + 40) = 0;
      ...
      if (*(_DWORD *)(r_showPortals + 8) && !*(_BYTE *)(r_portalBevelsOnly + 8))
        R_AddDebugPolygon(
            ...
            (float *)&R_VisitPortals(GfxCell const *, DpvsPlane const *,
      ...
      v81 = __src[2];
      v82 =
          (float)((float)(__src[2] * *(float *)(dword_C96E50 + 44)) +
                ...
                if (v14 > 0) {
                  ...
                  v92 = 2;
                    do {
                      ...
                      v92 += 2;
                      v91 =
                          v91 + (float)(v93 * (float)(*(float *)((char *)&v128 +
                                                                 v92 * 4) -
                                                      v126[v92 + 381]));
                    }
                  while (v14 >= v90);
        ...
        LABEL_64:
          ...
          v59 = v121;
            while (1) {
              ...
              v61 = (float)((float)(v59 * v57[1]) + (float)(v60 * v57[5])) +
                    v57[13];
              v62 = (float)((float)(v59 * v57[2]) + (float)(v60 * v57[6])) +
                    v57[14];
              v63 = 1.0 / (float)((float)((float)(v59 * v57[3]) +
                                          (float)(v60 * v57[7])) +
                                  v57[15]);
              *v58 =
                  (float)((float)((float)(v59 * *v57) + (float)(v60 * v57[4])) +
                          v57[12]) *
                  v63;
              v58[1] = v61 * v63;
              v58[2] = v62 * v63;
          ...
          v64 = &v136;
            for (j = 0;; j = v71) {
              ...
              if ((float)((float)(v69 * v126[2]) +
                          (float)((float)(v67 * v126[0]) +
                                  (float)(v68 * v126[1]))) <= v70)
                break;
            LABEL_74:
              ...
              v32 = *v30;
                if ((float)((float)((float)(v32 * v32) +
                  ...
                  *v31 = v32;
                  ...
                  v34 = v30[2];
                  v31[2] = v34;
                  v31[3] = 0.001 - (float)((float)((float)(v32 * *v29) +
                                                   (float)(v33 * v29[1])) +
                                           (float)(v34 * v29[2]));
                  v35 = 12;
                  if (*(int *)v31 <= 0)
      ...
      v38 = (float *)dword_C96E48;
        if (dword_C96E48) {
          ...
          *v39 = *(float *)dword_C96E48;
          ...
          v42 = v39[2];
          v43 = v39[3];
          v44 = (float)((float)((float)(*v39 * __src[0]) +
                                (float)(v41 * __src[1])) +
                        (float)(v42 * __src[2])) +
                v43;
          v45 = (float)((float)((float)(*v39 * __src[3 * v14 - 3]) +
            ...
            if (v45 <= v44) {
                ...
                if (v14 - 2 <= 0 ||
                  ...
                  v85 = 0;
                    while (v14 - 3 != v85) {
                     ...
                     (float)((float)((float)((float)(v41 * v133) +
                                             (float)(v40 * v132)) +
                                     (float)(v42 * v134)) +
                             v43) <= v44) {
              ...
              v47 = __src;
                while (++v46 != v14 - 1) {
                  v48 = (float)((float)(v42 * v47[8]) +
                                (float)((float)(v41 * v47[7]) +
                                        (float)(v40 * v47[6]))) +
                        v43;
                  v47 += 3;
                  if (v48 > v44)
