public:
__cdecl _XMMATRIX::_XMMATRIX(void) { UNIMPLEMENTED(); }
...
struct __vector4 __cdecl XMVector3Transform(struct __vector4,
                                            struct _XMMATRIX) {
  UNIMPLEMENTED();
}
...
int __cdecl FloatAsInt(float const *) { UNIMPLEMENTED(); }
...
int __cdecl Com_InitPrefetch(int, void const *) { UNIMPLEMENTED(); }
...
int __cdecl R_GetIgnorePrecacheErrors() { return unk_1180902 != 0; }
...
float __cdecl R_GetLodDist(float const *const, float) { UNIMPLEMENTED(); }
    ...
    for (i = a1;; i = v17) {
      ...
      if (*surfs == 5) {
        ...
        if (*surfs == 4) {
          ...
          surfs += 14;
          v24 = *(float *)(e + 56);
          BoneOffset = XSurfaceGetBoneOffset((const XSurface_s *)v19[1]);
          R_GetRigidTransform((const DObjSkelMat_s *)((char *)v25 + BoneOffset),
                              (const float *)(e + 60),
                              (const float(*)[3])(e + 20), v24,
                              (float(*)[3])(v19 + 2));
        } else {
          v16 = surfs;
          surfs += 4;
...
void __cdecl R_SkinXModelCmd(struct SkinXModelCmd *skinCmd, int context) {
  ...
  if (a1->boneCount) {
    ...
    v4 = a1->mat + 16;
    do {
      if (((*(int *)&a1->surfacePartBits[4 * (v3 >> 5)] >> (v3 & 0x1F)) & 1) !=
          0) {
  ...
  if (*(_BYTE *)(result + 28)) {
    ...
    while (1) {
      ...
      LABEL_10:
        ...
        R_GetRigidTransform(
            (const DObjSkelMat_s *)&v29[BoneOffset], (const float *)(e + 60),
            (const float(*)[3])(e + 20), v21, (float(*)[3])(v20 + 2));
        ++v24;
        v30 = (SkinXModelCmd *)((char *)v30 + 1);
        v19 = a1;
        result = a1->surfCount;
    ...
    do {
      if (((v72[v9 >> 5] >> (v49 & 0x1F)) & 1) != 0) {
        ...
        *(float *)&v48 = v15 + v21;
        ...
        v25.f32[0] =
            v25.f32[0] + (float)(*(float *)((char *)&v22->bounds[0][2] + v27) *
                                 (float)(v16 + v19));
        v23.f32[0] =
            v23.f32[0] + (float)((float)(v16 + v19) *
        ...
        v33 = (__m128)v48;
        v33.f32[0] =
            (float)(*(float *)&v48 * *(float *)((char *)v22->bounds[0] + v32)) +
            v31.f32[0];
        v31.f32[0] =
            v31.f32[0] +
            (float)(*(float *)&v48 * *(float *)((char *)v22->bounds[1] - v32));
        ...
        v33.f32[0] =
            v33.f32[0] + (float)(*(float *)((char *)&v22->bounds[0][2] + v35) *
                                 (float)(v53 - v18));
        v31.f32[0] =
            v31.f32[0] + (float)((float)(v53 - v18) *
        ...
        v41.f32[0] =
            v41.f32[0] + (float)((float)(v53 + v18) *
                                 *(float *)((char *)&v22->bounds[0][1] + v43));
        v39.f32[0] = (float)(v39.f32[0] + (float)((float)(v16 - v19) * *v42)) +
                     (float)((float)(v53 + v18) *
  ...
  if (result <= 3) {
    if (InterlockedCompareExchange((int)&a1->cullState, 3, 2) == 2) {
      ...
      if (DObjBad(obj)) {
        ...
        if (*(_DWORD *)(developer + 8)) {
          R_XModelDebugBoxes((int)a1, (float *)&a2->reType, obj);
          result = R_XModelDebugAxes((int)a1, (float *)&a2->reType, obj);
        }
      } else {
        ...
        if (result) {
          ...
          if (result) {
            ...
            if ((unsigned int)(v4 + v14) <= 0x1000) {
              ...
              LABEL_19:
                v6 = v5 - __src;
                v7 = InterlockedExchangeAdd((int)frontEndDataOut + 524296, v6);
                if (v6 + v7 <= (unsigned int)&loc_20000) {
                  ...
                  if (v15 == 1) {
                    ...
                    v21.materialSubimageIndex = *(_DWORD *)v16;
                    v21.radius = *(_QWORD *)(v16 + 4);
                    v21.rotation = *(_DWORD *)(v16 + 12);
                    v21.minScreenRadius = *(_DWORD *)(v16 + 16);
                    v22 = *(_DWORD *)(v16 + 20);
                    v23 = *(_DWORD *)(v16 + 24);
                    v24 = *(_DWORD *)(v16 + 28);
                    result = R_AddFrontendCmd(2, &v21.customMaterial, v12);
                  } else {
                    if (v14 > 0) {
                      for (i = 0; i != v14; ++i)
                        *((_BYTE *)&v21.lighting.origin[2] + i + 2) =
                            DObjGetMatOffset(obj,
                                             *(__int16 *)v19[i].modelIndex);
                    }
                    v20[0] = a1->surfs;
                    ...
                    result = R_AddFrontendCmd((v14 > 10) + 6, v20, v12);
                  }
                } else {
                  *((_DWORD *)frontEndDataOut + 131074) = &loc_20000;
                  result = *(_DWORD *)frontEndDataOut;
                  if (*(_DWORD *)frontEndDataOut !=
                      R_SkinSceneDObj(GfxSceneEntity *,
                                      GfxEntity *)::warnCount) {
                    R_SkinSceneDObj(GfxSceneEntity *, GfxEntity *)::warnCount =
                        *(_DWORD *)frontEndDataOut;
                    result = ri(2, "MAX_SCENE_SURFS_SIZE exceeded - not "
                                   "drawing surface\n");
                  }
                }
              } else {
                ...
                v5 = __src;
                v13 = v19;
                for (result = R_PreSkinXSurface(a1, obj, v19, 0, v25, __src);
                     result;
                     result = R_PreSkinXSurface(a1, obj, v13, v17, v25, v5)) {
                  v5 += result;
                  ++v17;
                  ++v13;
                  if (v14 == v17)
              ...
              if (*(_DWORD *)frontEndDataOut !=
                ...
                R_SkinSceneDObj(GfxSceneEntity *, GfxEntity *)::warnCount =
                    *(_DWORD *)frontEndDataOut;
                result = ri(
                    2, "MAX_SCENE_MATERIALS exceeded - not drawing surface\n");
              }
            }
          }
        }
...
int marker_r_model;
void __cdecl R_PostXModelBounds(struct GfxSceneEntity *) { UNIMPLEMENTED(); }

void __cdecl R_PostSkinXModel(struct GfxSceneEntity *) { UNIMPLEMENTED(); }
...
int __cdecl R_AllocSkinnedCachedVerts(int) { UNIMPLEMENTED(); }
  ...
  *((_DWORD *)a6 + 3) = 0;
  ...
  if (*v16 > v17) {
    ...
    if (*v15 != R_AllocSkinnedCachedVerts(int)::warnCount) {
      ...
      ri(2, "R_MAX_SKINNED_CACHE_VERTICES exceeded - not drawing surface\n");
    }
  LABEL_15:
    v14 = -1;
  }
  ...
  if (a2->reType == 2) {
    if (*(_BYTE *)(r_smc_enable + 8)) {
      if (XSurfaceGetBoneOffset(a5) != -1 &&
        ...
        v12 = (GfxStaticSurface *)(*(_DWORD *)(*(_DWORD *)&algn_1183A7C[24] +
                                               8 * a3 + 4) +
                                   16 * a6);
        v24 = v12;
        v13 = *(GfxStaticModelSurfaceCached **)&v12->cachedLods[4 * a7];
        if (v13 ||
            (v13 = (GfxStaticModelSurfaceCached *)R_CacheStaticModelSurface(
                 v12, a5, a3, v10),
      ...
      if (XModelBad(obj)) {
        ...
        if (result >= 0) {
          ...
          if ((unsigned int)(v6 + Surfaces) <= 0x1000) {
            ...
            LABEL_21:
              v10 = v9 - __src;
              v11 = InterlockedExchangeAdd((int)frontEndDataOut + 524296, v10);
              if (v10 + v11 <= (unsigned int)&loc_20000) {
                ...
                if (*(_DWORD *)(r_xdebug + 8)) {
                  ...
                  if ((*(_BYTE *)(v17 + 8) & 2) != 0)
                    R_XModelDebugAxes((int)a1, (float *)&a2->reType, v16);
                }
                result = v33[0];
                if (v33[0]) {
                  ...
                  if (v21 == 1) {
                    ...
                    v26[2] = v14;
                    v28 = v21;
                    result = R_AddFrontendCmd((Surfaces > 10) + 6, v26, v18);
                  }
                }
              } else {
                *((_DWORD *)frontEndDataOut + 131074) = &loc_20000;
                ...
                if (*(_DWORD *)frontEndDataOut !=
                    R_SkinXModel(GfxSceneEntity *, GfxEntity *,
                                 int)::warnCount) {
                  R_SkinXModel(GfxSceneEntity *, GfxEntity *, int)::warnCount =
                      *(_DWORD *)frontEndDataOut;
                  result = ri(
                      2,
                      "MAX_SCENE_SURFS_SIZE exceeded - not drawing surface\n");
                }
              }
            } else {
              v7 = 0;
              v23 = __src;
              for (j = __src;; j = v23) {
                result = R_PreSkinStaticSurface(a1, a2, a3, obj, v31[v7], v7,
                                                v22, v33, j);
                if (!result)
                  break;
                v23 += result;
            ...
            if (*(_DWORD *)frontEndDataOut !=
              ...
              R_SkinXModel(GfxSceneEntity *, GfxEntity *, int)::warnCount =
                  *(_DWORD *)frontEndDataOut;
              result =
                  ri(2, "MAX_SCENE_MATERIALS exceeded - not drawing surface\n");
            }
          }
        }
      }
...
R_UnlockSkinnedCache() { UNIMPLEMENTED(); }

R_OptimizeAllModels() { UNIMPLEMENTED(); }

R_ReleaseAllModels() { UNIMPLEMENTED(); }

Model_Alloc(int size) { UNIMPLEMENTED(); }

R_LockSkinnedCache(GfxLockType lockType) { UNIMPLEMENTED(); }

R_ShutdownModels() { UNIMPLEMENTED(); }

R_FinishLoadingModels() { UNIMPLEMENTED(); }
