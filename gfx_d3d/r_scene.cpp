              ...
              v8 = *((_DWORD *)frontEndDataOut + 1);
                if (v8 <= 0xFFFF) {
                  ...
                  if (v10 == 2 && *(_BYTE *)(fx_sort + 8))
                    v11 = 16 * a2 + (v7 << 19) + (v4->info.sortedIndex << 9) -
                          2147483646;
                  else
                    v11 = (v4->info.sortedIndex << 21) + 16 * v7 + v10 +
                          (a2 << 16);
                  *v9 = v11;
                  v9[1] = (int)v13;
                  ++dword_11555B8;
              ...
              v9 = *((_DWORD *)frontEndDataOut + 1);
                if (v9 <= 0xFFFF) {
                  ...
                  if (*v8 == 2 && *(_BYTE *)(fx_sort + 8))
                    ...
                    v4 = (*(unsigned __int16 *)(v7 + 10) << 21) + 16 * a2 +
                         *v8 + (v6 << 16);
                  *v12 = v4;
                  v12[1] = (int)v8;
                  ++dword_11555B8;
              ...
              v6 = *((_DWORD *)frontEndDataOut + 1);
                if (v6 <= 0xFFFF) {
                  ...
                  if (*(_DWORD *)surfs == 2 && *(_BYTE *)(fx_sort + 8))
                    v7 = (v5 << 19) + (*(unsigned __int16 *)(v4 + 10) << 9) -
                         2147483150;
                  else
                  ...
                  *((_DWORD *)frontEndDataOut + 163843) = v14 + 1;
                  ++stru_1155004.entityCount;
                    if (entityCount >= 0) {
                      ...
                      v12 =
                          (_DWORD *)(stru_1155004.entities + 116 * entityCount);
      ...
      v8 = *((_DWORD *)frontEndDataOut + 1);
        if (v8 <= 0xFFFF) {
          ...
          if (s_entitySurface == 2 && *(_BYTE *)(fx_sort + 8))
            v10 = (v5 << 19) +
                  (*(unsigned __int16 *)(customMaterial + 10) << 9) -
                  2147483150;
          else
  ...
  v34 = (GfxViewParms *)v1;
    if ((int)stru_1155004.time < dword_1181DC8[11]) {
        if (dword_1181DC8[1] == dword_1181DC8[9]) {
          ...
          v25 =
              fminf(1.0, (float)(stru_1155004.time - dword_1181DC8[10]) / v24);
