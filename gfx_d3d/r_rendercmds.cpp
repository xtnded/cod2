public:
long __cdecl D3DDevice::AcquireThreadOwnership(void) { UNIMPLEMENTED(); }

public:
long __cdecl D3DDevice::ReleaseThreadOwnership(void) { UNIMPLEMENTED(); }

public:
int __cdecl D3DDevice::IsFencePending(unsigned long) { UNIMPLEMENTED(); }

void __cdecl Vec4Clear(float *const) { UNIMPLEMENTED(); }

bool __cdecl R_HaveFloatZ(void) { UNIMPLEMENTED(); }

bool __cdecl R_NeedFloatZ(void) { UNIMPLEMENTED(); }

void __cdecl R_BeginDebugFrame() { UNIMPLEMENTED(); }
...
void __cdecl R_ToggleSmpFrame(void) { UNIMPLEMENTED(); }

void __cdecl R_AddFrontendCmd(int type, void *data) {
  return R_ProcessFrontendCmdInternal(a1, a2, a3);
}

void __cdecl R_EndRemoteScreenUpdate(void) { UNIMPLEMENTED(); }
...
void __cdecl R_AddCmdBlurShadowCookie(void) { UNIMPLEMENTED(); }
...
void __cdecl R_AddCmdSetStencilRefValue(int) { UNIMPLEMENTED(); }
...
void __cdecl R_AddCmdResumeUntiledRendering(void) { UNIMPLEMENTED(); }

void __cdecl R_AddCmdEndTiling(void) { UNIMPLEMENTED(); }
...
void __cdecl R_AddCmdPreTessGroupCompleted(int) { UNIMPLEMENTED(); }
...
void __cdecl R_ShutdownBackendData() { return R_ShutdownDebugEntry(&_b); }

void __cdecl R_InitBackendData() { UNIMPLEMENTED(); }

int __cdecl R_ForceEndRemoteScreenUpdate(void) { UNIMPLEMENTED(); }

void __cdecl R_AddCmdDrawLines(short, short,
...
void __cdecl R_AbortRenderCommands() { UNIMPLEMENTED(); }

void __cdecl R_BeginFrame() { UNIMPLEMENTED(); }

void __cdecl R_ReleaseThreadOwnership(void) { UNIMPLEMENTED(); }

void __cdecl R_BeginRemoteScreenUpdate(void) { UNIMPLEMENTED(); }

void __cdecl R_ForceBeginRemoteScreenUpdate(int) { UNIMPLEMENTED(); }

int __cdecl R_ProcessFrontendCmd(int, int) { UNIMPLEMENTED(); }

void __cdecl R_ProcessFrontendCmdsForBackend(void) { UNIMPLEMENTED(); }

int __cdecl R_ProcessNonSkinFrontendCmds(int) { UNIMPLEMENTED(); }

void __cdecl R_EndDebugFrame() { UNIMPLEMENTED(); }

void __cdecl R_WaitNonSkinFrontendCmds(void) { UNIMPLEMENTED(); }

void __cdecl R_ProcessFrontendCmds(int) { UNIMPLEMENTED(); }

void __cdecl R_WaitFrontendCmds(void) { UNIMPLEMENTED(); }

void __cdecl R_InitFrontendThread(void) { UNIMPLEMENTED(); }

void __cdecl R_EndFrame() { UNIMPLEMENTED(); }

void __cdecl R_InitRenderThread(void) { UNIMPLEMENTED(); }
...
void __cdecl R_SetTestLods(void) { UNIMPLEMENTED(); }

bool __cdecl R_CheckDvarModified(struct dvar_s const *) { UNIMPLEMENTED(); }

void *__cdecl R_GetCommandBuffer(enum GfxRenderCommand, int) {
  UNIMPLEMENTED();
}

int __cdecl R_IsPendingNonSkinFrontendCmds(void) { UNIMPLEMENTED(); }

int __cdecl R_IsPendingFrontendCmds(void) { UNIMPLEMENTED(); }

void __cdecl R_ClearCmdList(void) { UNIMPLEMENTED(); }

void __cdecl R_InitFrontendCmdsPos(void) { UNIMPLEMENTED(); }

void __cdecl R_PerformanceCounters(void) { UNIMPLEMENTED(); }

bool __cdecl R_LightTweaksModified(void) { UNIMPLEMENTED(); }
...
void __cdecl R_AddCmdEndOfList(void) { UNIMPLEMENTED(); }

void *__cdecl R_GrowCommandBuffer(int) { UNIMPLEMENTED(); }

void __cdecl R_InitFrontendCmds(void) { UNIMPLEMENTED(); }

void __cdecl R_UpdateFrontEndDvarOptions(void) { UNIMPLEMENTED(); }
...
void __cdecl R_ToggleSmpFrameCmd(void) { UNIMPLEMENTED(); }

void __cdecl R_FrontendThread2(void) { UNIMPLEMENTED(); }

void __cdecl R_FrontendThread(void) { UNIMPLEMENTED(); }

void __cdecl R_IssueRenderCommands(void) { UNIMPLEMENTED(); }

R_AddCmdTouchAllImages() { UNIMPLEMENTED(); }
