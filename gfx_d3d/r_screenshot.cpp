...
void __cdecl R_ScreenshotCommand(enum GfxScreenshotType type)
{
  ...
  char __str[280];     // [esp+160h] [ebp-118h] BYREF
    ...
    if (!strcmp((const char *)unk_11807C4(1), "savegame") &&
        unk_11807C0() == 3 && *(_BYTE *)unk_11807C4(2)) {
            ...
            if (R_ScreenshotCommand(GfxScreenshotType)::lastNumber <= 9999) {
                while (1) {
                  if ((unsigned int)v2 > 0x270F)
                    ...
                    Com_sprintf(__str, 0x100u, "screenshots/shot%04i.%s", v2,
                                v14);
...
void __cdecl R_SaveGameShot(char const *)
{
  UNIMPLEMENTED();
}
            ...
            do {
              ...
              v2 = 4 * v51;
                for (i = 0; i != v48; ++i) {
                  ...
                  *(double *)&v32 =
                      (float)((float)*(unsigned __int8 *)(v2 + *v66 + 2) *
                              0.0039215689);
                  v5 = pow(v32, v38);
                  *(float *)(v64 + v4) = v5;
                  v6 = *(v3 - 1);
                  ...
                  *(double *)&v33 =
                      (float)((float)*(unsigned __int8 *)(v2 + *v66 + 1) *
                              0.0039215689);
                  v7 = pow(v33, v39);
                  *(float *)(v64 + v6 + 4) = v7;
                  v8 = *(v3 - 1);
                  ...
                  *(double *)&v34 =
                      (float)((float)*(unsigned __int8 *)(v2 + *v66) *
                              0.0039215689);
                  v9 = pow(v34, v40);
                  *(float *)(v64 + v8 + 8) = v9;
                  v64 += 12;
            ...
            do {
              ...
              v63 = 4 * v56 * v53;
                for (j = 0; j != v56; ++j) {
                  ...
                  v81 =
                      (float)(v11 * *v12) + *(float *)&cubemapShotAxis[9 * v54];
                  v82 = (float)(v11 * v12[1]) +
                        *(float *)&cubemapShotAxis[9 * v54 + 1];
                  v83 = (float)(v11 * v12[2]) +
                        *(float *)&cubemapShotAxis[9 * v54 + 2];
                          ...
                          v18 = 12 * v56 * v16;
                            for (k = 0; k != v56; ++k) {
                              v20 = (float)((float)((float)((float)k + 0.5) +
                                    ...
                                    1.0;
                              v78 =
                                  (float)(v20 * *(float *)&dword_2F272C[v15]) +
                                  *(float *)&cubemapShotAxis[v15];
                              v21 =
                                  (float)(v20 * *(float *)&dword_2F2730[v15]) +
                                  *(float *)&dword_2F2724[v15];
                              v80 =
                                  (float)(v20 * *(float *)&dword_2F2734[v15]) +
                                  *(float *)&dword_2F2728[v15];
                              v78 =
                                  (float)(v17 * *(float *)&dword_2F2738[v15]) +
                                  v78;
                              v79 =
                                  (float)(v17 * *(float *)&dword_2F273C[v15]) +
                                  v21;
                              v80 =
                                  (float)(v17 * *(float *)&dword_2F2740[v15]) +
                                  v80;
                              v41 = LODWORD(v14);
                              Vec3Normalize(&v78);
                              v22 = (float)((float)(v81 * v78) +
                                            (float)(v82 * v79)) +
                                    (float)(v83 * v80);
                                if (v22 > 0.0) {
      ...
      v22 = 0;
        while (1) {
          v6 = 0;
            do {
              v23 =
                  (float)((float)v5 * 0.5) * *(float *)&cubemapShotAxis[9 * a2];
              v24 = (float)((float)v5 * 0.5) *
                    *(float *)&cubemapShotAxis[9 * a2 + 1];
              v25 = (float)((float)v5 * 0.5) *
                    *(float *)&cubemapShotAxis[9 * a2 + 2];
              v7 = (float *)&cubemapShotAxis[9 * a2 + 3];
              v8 = (float)v5 * -0.5;
              v23 = (float)((float)((float)((float)v6 + v8) + 0.5) * *v7) + v23;
              v24 =
                  (float)((float)((float)((float)v6 + v8) + 0.5) * v7[1]) + v24;
              v25 =
                  (float)((float)((float)((float)v6 + v8) + 0.5) * v7[2]) + v25;
...
void __cdecl R_CopyCubemapShot(enum CubemapShot)
{
  UNIMPLEMENTED();
}
...
void __cdecl R_CubemapShotRestoreState(void)
{
  UNIMPLEMENTED();
}

void __cdecl R_CubemapShotSetInitialState(void)
{
  UNIMPLEMENTED();
}
