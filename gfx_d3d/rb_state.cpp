...
public:
long __cdecl D3DDevice::SetIndices(struct D3DIndexBuffer *) { UNIMPLEMENTED(); }
...
void __cdecl RB_SetFvf(unsigned long) { UNIMPLEMENTED(); }
...
void __cdecl RB_PushMatrixStack() { UNIMPLEMENTED(); }
...
void __cdecl RB_DecideDefaultSamplerState() { UNIMPLEMENTED(); }
...
void __cdecl RB_SetDepthHackNearClip(float nearClip) {
  ...
  *((_BYTE *)v1 + 2451) = 0;
  ...
  if (*(_DWORD *)(r_rendererInUse + 8) == 2) {
    v3 = v1 + 208;
    do
      result = (*(int(__cdecl **)(int, int, int *))(*(_DWORD *)dword_117D8A8 +
                                                    176))(dword_117D8A8, 3, v3);
    while (alwaysfails);
  }
  return result;
}
...
void __cdecl RB_UpdateViewportConstants() {
  ...
  if (v0 > 1) {
    ...
    if (v11 < 0) {
      v8 = (float)((unsigned int)v11 >> 1) + (float)((unsigned int)v11 >> 1);
      goto LABEL_5;
    }
  LABEL_12:
    v8 = (float)v11;
  ...
  do {
    ...
    if (v3 <= v13) {
      if (v13 >= 0)
        goto LABEL_17;
      v9 = (float)((unsigned int)v13 >> 1) + (float)((unsigned int)v13 >> 1);
      goto LABEL_7;
    }
    --v14;
  } while (v14);
  ...
  if (*(_DWORD *)(r_rendererInUse + 8) == 2) {
    ...
    do {
      (*(void(__cdecl **)(int, int, float *))(*(_DWORD *)dword_117D8A8 + 176))(
          dword_117D8A8, 3, a1->projectionMatrix);
      result = alwaysfails;
    } while (alwaysfails);
  }
  return result;
...
void __cdecl RB_SetAnisotropy() { UNIMPLEMENTED(); }
...
LABEL_5:
    ...
    if (byte_118061A) {
      ...
      do
        (*(void(__cdecl **)(int, int, float))(*(_DWORD *)dword_117D8A8 + 228))(
            dword_117D8A8, 175, COERCE_FLOAT(LODWORD(v15)));
      while (alwaysfails);
    } else {
      v14 = v6 + v6;
    }
  ...
  if ((a1 & 0x40) != 0) {
    ...
    if ((v13 & 0x40) != 0) {
      do
        (*(void(__cdecl **)(int, int, _DWORD))(*(_DWORD *)dword_117D8A8 + 228))(
            dword_117D8A8, 52, 0);
      while (alwaysfails);
    }
...
LABEL_21:
  ...
  if (((v1 & 0x7000000) == 0) != (_BYTE)v2) {
    do
      LOBYTE(v2) =
          (*(int(__cdecl **)(int, int, bool))(*(_DWORD *)dword_117D8A8 + 228))(
              dword_117D8A8, 206, (v1 & 0x7000000) != 0);
    while (alwaysfails);
  }
  if ((v1 & 0x7000000) != 0) {
    if ((v16 & 0x7000000) != 0) {
...
bool __cdecl RB_IsIndexBufferBusy(struct D3DIndexBuffer *) { UNIMPLEMENTED(); }
...
void __cdecl RB_ReleasePixelShader(void) { UNIMPLEMENTED(); }
    ...
    if (a3) {
      do
        (*(void(__cdecl **)(int, int, GfxTexture))(
            *(_DWORD *)dword_117D8A8 + 260))(dword_117D8A8, a1, a3->texture);
      while (alwaysfails);
    } else {
      do
        (*(void(__cdecl **)(int, int, _DWORD))(*(_DWORD *)dword_117D8A8 + 260))(
            dword_117D8A8, a1, 0);
      while (alwaysfails);
    }
    ...
    if ((unsigned __int8)v4 != v11) {
        ...
        if (v9 != v6) {
          do
            (*(void(__cdecl **)(int, int, int, int))(
                *(_DWORD *)dword_117D8A8 + 276))(dword_117D8A8, a1, 6, v6);
          while (alwaysfails);
        }
        if (v14 != v7) {
          do
            (*(void(__cdecl **)(int, int, int, int))(
                *(_DWORD *)dword_117D8A8 + 276))(dword_117D8A8, a1, 5, v7);
          while (alwaysfails);
        }
      }
      if ((v12 & 0xC) != 0) {
      ...
      if ((v12 & 0x70) != 0) {
        if ((v13 & 0x10) != 0) {
          do
            (*(void(__cdecl **)(int, int, int, int))(
                *(_DWORD *)dword_117D8A8 + 276))(dword_117D8A8, a1, 1,
                                                 (v11 & 0x10) == 0 ? 1 : 3);
          while (alwaysfails);
        }
        if ((v13 & 0x20) != 0) {
          do
            (*(void(__cdecl **)(int, int, int, int))(
                *(_DWORD *)dword_117D8A8 + 276))(dword_117D8A8, a1, 2,
                                                 (v11 & 0x20) == 0 ? 1 : 3);
          while (alwaysfails);
        }
        if ((v13 & 0x40) != 0) {
          do
            (*(void(__cdecl **)(int, int, int, int))(
                *(_DWORD *)dword_117D8A8 + 276))(dword_117D8A8, a1, 3,
                                                 (v11 & 0x40) == 0 ? 1 : 3);
          while (alwaysfails);
        }
      }
...
void __cdecl RB_BindDefaultImages() { UNIMPLEMENTED(); }

void __cdecl RB_ReleaseVertexShader(void) { UNIMPLEMENTED(); }
  ...
  if (dword_1186CA4 == 1) {
    ...
    LABEL_3:
      ...
      *(_QWORD *)((char *)&xmmword_1186CB0 + 4) = v2;
      ...
      do {
        (*(void(__cdecl **)(int, __int128 *))(*(_DWORD *)dword_117D8A8 + 188))(
            dword_117D8A8, &xmmword_1186CB0);
...
void __cdecl RB_UnbindAllImages() { UNIMPLEMENTED(); }
...
void __cdecl RB_InitImages() { UNIMPLEMENTED(); }
...
void __cdecl RB_SetInitialState() { UNIMPLEMENTED(); }
...
void __cdecl RB_ChangedProjectionMatrix(void) { UNIMPLEMENTED(); }
...
void __cdecl RB_SetDefaultStateBits_Common(int *const) { UNIMPLEMENTED(); }

void __cdecl RB_InitMatricesFromViewForTile(struct GfxViewParms const *) {
  UNIMPLEMENTED();
}

void __cdecl RB_SetDefaultStateBits_Ref(int *const) { UNIMPLEMENTED(); }

void __cdecl RB_SetDefaultStateBits_Active(int *const) { UNIMPLEMENTED(); }

RB_SetAlphaAntiAliasingState(int stateBits0) { UNIMPLEMENTED(); }

RB_ChangeAlphaStageState(int stageIndex, int texStageBits) { UNIMPLEMENTED(); }

RB_ChangeColorStageState(int stageIndex, int texStageBits) { UNIMPLEMENTED(); }

RB_SetSamplerConstantDx7(unsigned int color) { UNIMPLEMENTED(); }

RB_ChangeGenTexCoords(int samplerIndex, unsigned char genTexCoords) {
  UNIMPLEMENTED();
}

RB_SetViewMatrixForWDx7(float w) { UNIMPLEMENTED(); }
