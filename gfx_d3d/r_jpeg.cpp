  ...
  if (v20[0]) {
    ...
    if (v14 <= dword_1180698 && dword_1180698 >= v15) {
      if (v16 == 3) {
        ...
        *a5 = v15;
        *a6 = 21;
        v9 = (*(int(__cdecl **)(unsigned int)) & algn_11806C8[8])(4 * v15 * v8);
        *a3 = v9;
        v12 = 4 * v14;
...
void __cdecl R_SaveJpg(char const *filename, int quality, int image_width,
  ...
  if (v10) {
    ...
    v6 =
        (_DWORD *)(*(int(__cdecl **)(_DWORD *, _DWORD, int))__b[1])(__b, 0, 28);
    v10 = v6;
  }
...
int marker_r_jpeg;
void __cdecl PrintfJpeg(char *) { return ri(0, "%s\n", a1); }

void __cdecl ExitJpeg(void) { return dword_11806C4(0, "jpeg internal error"); }
