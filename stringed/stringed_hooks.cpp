...
int __cdecl Language_IsAsian(void)
{
  UNIMPLEMENTED();
}
...
{
  return loc_language->current;
}

int __cdecl Language_UsesSpaces(void)
{
  UNIMPLEMENTED();
}

int __cdecl Taiwanese_CollapseBig5Code(unsigned int)
{
  UNIMPLEMENTED();
}
        ...
        if (current.integer > 9) {
            if (current.integer != 10) {
                if (current.integer == 11) {
                  v5 = (*v2 << 8) + v2[1];
                    if ((unsigned __int8)(BYTE1(v5) + 95) <= 0x56u &&
                        v2[1] > 0xA0u && v2[1] != 0xFF) {
                      *a1 = (const char *)(v2 + 2);
                      if (a2)
...
int __cdecl Chinese_CollapseGBCode(unsigned int)
{
  UNIMPLEMENTED();
}

int __cdecl Japanese_CollapseShiftJISCode(unsigned int)
{
  UNIMPLEMENTED();
}

int __cdecl Korean_CollapseKSC5601HangulCode(unsigned int)
{
  UNIMPLEMENTED();
}
                    ...
                    if (!String) {
                        if (loc_warnings && *(_BYTE *)(loc_warnings + 8)) {
                          if (loc_warningsAsErrors &&
                            ...
                            Com_Printf("^3WARNING: Could not translate part of "
                                       "%s: \"%s\"\n",
                                       a2, __src);
                  ...
                  v17 = __src;
                    do {
                        if (!memcmp(v17, "&&", 2)) {
                          v16 = v17[2];
                            if (v16 <= 0xFF &&
                                (_DefaultRuneLocale.__runetype[v16] & 0x400) !=
                                    0) {
                              *v17 = 22;
                              v26 = 1;
                            }
                    ...
                    if (!memcmp(v13, "&&", 2)) {
                      v14 = v13[2];
                        if (v14 <= 0xFF &&
                          ...
                          if (v14 == 48)
                            Com_Printf("%s cannot have &&0 as conversion "
                                       "format: \"%s\"\n",
                                       a2, a1);
                          if (v27 == v14 - 48)
                            break;
  ...
  char *result; // eax
    ...
    if (!result) {
        if (*(_BYTE *)(loc_warnings + 8)) {
          ...
          I_strncpyz(SEH_SafeTranslateString(char const *)::szErrorString,
                     __src, 1024);
          return SEH_SafeTranslateString(char const *)::szErrorString;
        }
    }
...
bool __cdecl Chinese_IsTrailingPunctuation(unsigned int)
{
  UNIMPLEMENTED();
}
...
bool __cdecl Japanese_IsTrailingPunctuation(unsigned int)
{
  UNIMPLEMENTED();
}
...
bool __cdecl Taiwanese_IsTrailingPunctuation(unsigned int)
{
  UNIMPLEMENTED();
}

bool __cdecl Taiwanese_ValidBig5Code(unsigned int)
{
  UNIMPLEMENTED();
}
...
void __cdecl SEH_UpdateCurrentLanguage(void)
{
  UNIMPLEMENTED();
}

bool __cdecl Chinese_ValidGBCode_UICode(unsigned int)
{
  UNIMPLEMENTED();
}
...
bool __cdecl Korean_ValidKSC5601Hangul_Code(unsigned int)
{
  UNIMPLEMENTED();
}
