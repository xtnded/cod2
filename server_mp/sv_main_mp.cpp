  ...
  Info_SetValueForKey(__s1, "hw", v18);
    if (*(_BYTE *)(sv_pure + 8) && !*v12) {
      v30 = (char *)Dvar_GetString("sv_referencedIwdNames");
        if (!*v30 ||
            (SV_Cmd_TokenizeString(v30), v34 = SV_Cmd_Argc(), v34 <= 0)) {
          v19 = 0;
          goto LABEL_29;
        }
      v35 = 0;
        ...
        if ( v23 <= *(_DWORD *)((char *)`global constructor keyed to'CMemoryBuffer::sDelayedFreeRequests + (_DWORD)a1) )
        {
            for (j = a1;; j = a1) {
              Com_Printf("cmd %5d: %8d: %s\n", v23,
                         *(_DWORD *)&j
                              ->reliableCommandInfo[1032 * (v23 & 0x7F) + 1024],
          ...
          v4 = (char *)dword_170048C + v13;
            if (*(int *)((char *)&dword_170048C->state + v13) > 1) {
              ...
              ClientScore = G_GetClientScore(
                  931767531 * ((v4 - (char *)dword_170048C) >> 2));
        ...
        do {
          v6 = (char *)dword_170048C + v20;
            if (*(int *)((char *)&dword_170048C->state + v20) > 1) {
              ...
              if (gameInitialized)
                ClientScore = G_GetClientScore(
                    931767531 * ((v6 - (char *)dword_170048C) >> 2));
              else
                ClientScore = 0;
              Com_sprintf(__src, 0x400u, "%i %i \"%s\"\n", ClientScore, v7,
                          v6 + 134216);
  ...
  v9 = Dvar_GetString("fs_game");
    if (*(_BYTE *)(sv_pure + 8) && (!v9 || !LOBYTE(v9->s.number))) {
      v12 = (char *)Dvar_GetString("sv_referencedIwdNames");
        if (!*v12 ||
            (SV_Cmd_TokenizeString(v12), v14 = SV_Cmd_Argc(), v14 <= 0)) {
          v10 = 0;
          goto LABEL_19;
        }
      v15 = 0;
        ...
        for (i = 0; i < *(_DWORD *)(sv_maxclients + 8); ++i) {
          ...
          v6 = *(int32_t *)((char *)&v2->netchan.remoteAddress.ip + 2);
            if (NET_CompareBaseAdr(a1, *(netadr_t *)(&qport - 2)) &&
                ...
                if (v2->state != 1) {
                  *(uint32_t *)((char *)&v2->lastPacketTime + 2) =
                      dword_1700484;
                  if (v2->state > 3)
                    SV_UserVoice(v2, a2);
                  else
                ...
                if (dword_170049C < 2147483646 - dword_1700494) {
                  ...
                  v8 = sv_maxclients;
                    if (*(int *)(sv_maxclients + 8) > 0) {
                      v9 = 0;
                        do {
                            if (v7->state &&
                                !*(_DWORD *)((char *)&loc_6E5C4 + (_DWORD)v7)) {
                              SV_BotUserMove(v7);
                              v8 = sv_maxclients;
                            }
                          ++v9;
                    ...
                    if (*(int *)(v8 + 8) > 0) {
                      ...
                      v28 = 0;
                        do {
                          ...
                          if (*(int32_t *)((char *)&dword_170048C->state +
                                           v28) != 4 ||
                              !*((_DWORD *)v11 + 33553))
                            goto LABEL_43;
                  ...
                  v18 = dword_170048C;
                    if (*(int *)(sv_maxclients + 8) > 0) {
                      v19 = 0;
                        while (1) {
                          if (*(signed int *)((char *)&v18->lastPacketTime +
                                              2) > v16)
                            *(uint32_t *)((char *)&v18->lastPacketTime + 2) =
                                v16;
                            if (!v18->serverId) {
                                if (v18->state == 1) {
                                  if (v27 <=
                                      *(signed int *)((char *)&v18
                                                      ...
                                                      2))
                                    goto LABEL_70;
                                  Com_DPrintf("Going from CS_ZOMBIE to CS_FREE "
                                              "for %s\n",
                                              &v18->name[2]);
                                  v18->state = 0;
                                }
                                    ...
                                    if (v18->state <= 1 ||
                                        v17 <= *(signed int
                                                     *)((char *)&v18
                                                        ...
                                                        2)) {
                                    LABEL_70:
                                      *(uint32_t *)((char *)&v18->timeoutCount +
                                                    2) = 0;
                                      goto LABEL_63;
                                    }
                                  v20 =
      ...
      v10 = sv_maxclients;
        ...
        LABEL_10:
          ...
          v11 = 0;
            ...
            if (Netchan_Process(
                    (netchan_t *)((char *)&v9->netchan.outgoingSequence + 2),
                    a9)) {
          ...
          {
                    SV_Netchan_Decode(
                        v9, (unsigned __int8 *)(a9->data + a9->readcount),
                        (unsigned __int8 *)(a9->cursize - a9->readcount));
                      if (v9->state != 1) {
                        *(uint32_t *)((char *)&v9->lastPacketTime + 2) =
                            dword_1700484;
                        SV_ExecuteClientMessage(a1, a2, a3, a4, a5, a6, a7, v9,
                                                a9);
                        bgs = 0;
                      }
          }
