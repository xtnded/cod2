            ...
            if (v1 >= 0 && v1 < *(_DWORD *)(sv_maxclients + 8)) {
              v2 = (client_s *)((char *)dword_170048C + 495372 * v1);
                if (v2->state == 4) {
                  ...
                  SV_SendServerCommand(v2, SV_CMD_CAN_IGNORE, "%c \"\x15%s\"",
                                       104, v5);
                }
            }
        }
...
int __cdecl SV_KickClient(struct client_s *, char *, int)
{
  UNIMPLEMENTED();
}

int __cdecl SV_KickClient_f(char *, int)
{
  UNIMPLEMENTED();
}

int __cdecl SV_KickUser_f(char *, int)
{
  UNIMPLEMENTED();
}

void __cdecl SV_TempBanNum_f(void)
{
  UNIMPLEMENTED();
}

void __cdecl SV_DropNum_f(void)
{
  UNIMPLEMENTED();
}

void __cdecl SV_Drop_f(void)
{
  UNIMPLEMENTED();
}

void __cdecl SV_TempBan_f(void)
{
  UNIMPLEMENTED();
}

void __cdecl SV_KillServer_f(void)
{
  UNIMPLEMENTED();
}
      ...
      SavePersist = G_GetSavePersist();
        if (!*(_BYTE *)(sv_maxclients + 7) &&
            ...
            if (sv[2] != com_frameTime) {
              ...
              unk_1700488 ^= 4u;
              sv_serverId_value = (((_BYTE)sv_serverId_value + 1) & 0xF) +
                                  (sv_serverId_value & 0xF0);
              Dvar_SetInt(sv_serverid, sv_serverId_value);
              sv[2] = com_frameTime;
              sv[0] = 1;
              sv[1] = 1;
              SV_RestartGameProgs(a2, a3.f32[0], a4, a5, a6, a7, a8,
                                  SavePersist);
              v10 = 3;
                do {
                  dword_1700484 += 100;
                    ...
                    do {
                      v13 = (char *)dword_170048C + v12;
                        if (*(int *)((char *)&dword_170048C->state + v12) > 1) {
                          ...
                          SV_AddServerCommand((client_s *)v13, SV_CMD_RELIABLE,
                                              v14);
                          v15 = (char *)ClientConnect(a2, a3.f32[0], a4, a5, a6,
                                                      a7, a8, v11,
                                                      *((_WORD *)v13 + 242424));
                            if (v15) {
                              SV_DropClient(a3.f32[0], (client_s *)v13, v15);
                              Com_Printf("SV_MapRestart_f: dropped client %i - "
                                         "denied!\n",
                                         v11);
                            }
