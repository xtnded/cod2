        ...
        do {
          while (1) {
            if (v7 != v3) {
              ...
              if (*(int *)((char *)&dword_170048C->state + v4) > 1 &&
                  !v5[v7 + 495304]) {
                if (v5[495368]) {
                  v6 = *((_DWORD *)v5 + 123825);
                  if (v6 <= 39)
          ...
          *(_DWORD *)&v5[261 * v6 + 485117] = __n;
          memcpy(&v5[261 * *((_DWORD *)v5 + 123825) + 484861], __src, __n);
  ...
  if (*(_BYTE *)(sv_voice + 8)) {
    ...
    if (Byte > 0) {
      ...
      while (1) {
        ...
        G_BroadcastVoice(*(gentity_s **)((char *)&a1->gentity + 2), &__dst);
        if (Byte == ++v3)
          return;
      }
      Com_Printf("Received invalid voice packet of size %i from %s\n", v4,
...
SV_ClientWantsVoiceData(int clientNum) { UNIMPLEMENTED(); }
