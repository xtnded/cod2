                  ...
                  v20 = v19;
                    if (v19->r.linked) {
                        if (v19->r.broadcastTime ||
                          ...
                          HIDWORD(v21->r.clientMask) =
                              HIDWORD(v20->r.clientMask);
          ...
          v33 = v32;
            if (v32->r.linked) {
                if (v32->r.broadcastTime ||
                  ...
                  MSG_WriteDeltaArchivedEntity(
                      &v43, (archivedEntity_s *)&sv[93 * v33->s.number + 2311],
                      &__dst, (msg_t *)1);
                }
            }
          ++v31;
      ...
      *(uint32_t *)((char *)&a3->nextSnapshotTime + 2) = dword_1700484 - 1;
      ...
      if (*(_BYTE *)(sv_debugRate + 8))
        Com_Printf(
            ...
            v4, &a3->name[2], *(int32_t *)((char *)&a3->rate + 2));
        ...
        if (v17->state != 1) {
          ...
          *((_DWORD *)v18 + 2477) = dword_170049C;
            if (sv == 2) {
                ...
                if (unk_17004A8 && ClientArchiveTime > 0) {
                  ...
                  v21 = dword_17004AC - v20;
                    ...
                    if (v21 < dword_17004AC) {
                        while (1) {
                          CachedSnapshotInternal =
                              SV_GetCachedSnapshotInternal(v21);
                          if (CachedSnapshotInternal)
                            break;
                          if (++v21 >= dword_17004AC)
                            goto LABEL_62;
              ...
              v114 = a1;
              AddLeanToPosition(v113, *((float *)v18 + 59),
                                *((float *)v18 + 19), 16.0, 20.0);
                if (CachedSnapshotInternal) {
                  ...
                  v24 = CM_LeafCluster(v23);
                    if (v24 >= 0) {
                      ...
                      *(float *)&v88 = G_GetFogOpaqueDistSqrd();
                      ...
                      LODWORD(a1) =
                          _mm_cmpneq_ss((__m128)v88, v25).u32[0] & v88;
                      v89 = a1;
                        if (v84 > 0) {
                          v90 = 0;
                          v105 = 0;
                            ...
                            if (v105 > 0) {
                                for (i = 0; i != v105; ++i) {
                                  ...
                                  if (++dword_1700498 > 2147483645)
                                    Com_Error(
                                        0,
                                        "\x15svs.nextSnapshotEntities wrapped",
                                        v64);
                                  ++*((_DWORD *)v18 + 2474);
                                }
                            }
                    ...
                    if ((int)CachedSnapshotInternal[4] > 0) {
                      v36 = 0;
                        for (j = CachedSnapshotInternal;;
                             j = CachedSnapshotInternal) {
                          memcpy((void *)(unk_17004A4 +
                                          92 * (dword_170049C % dword_1700494)),
                                 (const void *)(unk_17004CC +
                                                9992 * ((j[5] + v36) % 4096) +
                                                4),
                                 0x5Cu);
                      ...
                      v56 = *((_DWORD *)v52 + 87);
                        if (v56) {
                            ...
                            LABEL_163:
                              a1 = v80;
                              if ((v80 == 0.0 ||
                                   !BoxDistSqrdExceeds(v77->r.absmin,
                                                       v77->r.absmax, v113,
                                                       v80)) &&
                                  v104 != 1024)
                                v108[v104++] = v81;
                    ...
                    if (unk_1700324 <= ++v81) {
                        if (v104 > 0) {
                            for (n = 0; n != v104; ++n) {
                              ...
                              memcpy(
                                  (void *)(unk_17004A0 + 240 * (dword_1700498 %
                                                                dword_1700490)),
                                  __src, 0xF0u);
                              if (++dword_1700498 > 2147483645)
                                Com_Error(
                                    0, "\x15svs.nextSnapshotEntities wrapped",
                                    v65);
                              ++*((_DWORD *)v18 + 2474);
                            }
                        }
                                ...
                                if (v70->state > 1) {
                                  v41 = (_DWORD *)(unk_17004A4 +
                                                   92 * (dword_170049C %
                                                         dword_1700494));
                                  ClientState =
                                      (const void *)G_GetClientState(v106);
                                  memcpy(v41, ClientState, 0x5Cu);
                                    if (v106 == *v41) {
                                      if (++dword_170049C > 2147483645)
                                        Com_Error(0,
                                                  "\x15svs.nextSnapshotClients "
                                                  "wrapped",
                                                  v63);
                                      ++*((_DWORD *)v18 + 2475);
                                    }
...
LABEL_16:
  ...
  v96 = 0;
    for (ii = v93;; ii = v93) {
        while (v97 < ii) {
          v8 = (entityState_s *)(unk_17004A0 +
                                 240 * ((v92 + v97) % dword_1700490));
          number = v8->number;
          if (v95 > v96)
            goto LABEL_34;
          v12 = number >= 9999;
    ...
    LABEL_29:
        if (v12) {
          ...
          MSG_WriteDeltaEntity(
              &v110, (entityState_s *)((char *)&sv + 372 * number + 9244), v8,
              (msg_t *)1);
          ++v97;
        }
    }
    ...
    if ( v29 <= *(_DWORD *)((char *)`global constructor keyed to'CMemoryBuffer::sDelayedFreeRequests + (_DWORD)a2) )
    {
          while (1) {
            Com_Printf("cmd %5d: %8d: %s\n", v29,
                       *(_DWORD *)&v28
                            ->reliableCommandInfo[1032 * (v29 & 0x7F) + 1024],
        ...
        while (1) {
          ...
          ++v19;
            if (*(_DWORD *)((char *)&loc_725DC + (_DWORD)v0)) {
              v1 = *(_DWORD *)v0->netchan.unsentBuffer -
                   v0->netchan.unsentLength;
                if (v1 <= 1500) {
                  v20 = 1000 * v1;
                }
                else {
              ...
              if (*(_BYTE *)(sv_debugRate + 8))
                Com_Printf("It would take %ims to send %i bytes to client %s "
                           "(rate %i)\n",
                           v5, v1, &v0->name[2],
                           *(int32_t *)((char *)&v0->rate + 2));
            ...
            LABEL_31:
              ...
              *(float *)((char *)&loc_5F4EC + (_DWORD)&sv) = v16;
              return Com_DPrintf(
                  ...
                  "cr(%2.2f) acr(%2.2f)\n",
                  (float)(v13 / (float)v19), v13, dword_1700390[0], v14,
                  dword_1700390[22], v15,
