...
void __cdecl SV_ClearServer(void)
{
  UNIMPLEMENTED();
}
...
void __cdecl SV_CreateBaseline(void)
{
  UNIMPLEMENTED();
}
...
void __cdecl SV_SetXUIDConfigStrings(void)
{
  UNIMPLEMENTED();
}
...
void __cdecl SV_BoundMaxClients(int)
{
  UNIMPLEMENTED();
}
...
void __cdecl SV_DropAllClients(void)
{
  UNIMPLEMENTED();
}

void __cdecl SV_FinalMessage(char *)
{
  UNIMPLEMENTED();
}
          ...
          v28 = 0;
            do {
                if (*p_state > 2) {
                  ...
                  LODWORD(v42) =
                      *(_DWORD *)((char *)&loc_6E5C4 + (_DWORD)p_state);
      ...
      v19 = 0;
        while (1) {
          ...
          v20 = (char *)ClientConnect(a1, a2.f32[0], a3, a4, a5, a6, a7, v18,
            ...
            if (v20) {
              SV_DropClient(a2.f32[0],
                            (client_s *)((char *)dword_170048C + v19), v20);
            LABEL_23:
              ++v18;
              v19 += 495372;
...
void __cdecl SV_FreeArchivedSnapshot(void)
{
  UNIMPLEMENTED();
}
