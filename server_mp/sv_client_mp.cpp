...
void __cdecl SV_FreeClientScriptPers() { UNIMPLEMENTED(); }
  ...
  if (!MEMORY[0x170A4EC][0] && stru_170A4E8 != 1) {
    ...
    *(_WORD *)&MEMORY[0x170A4EC][4] = -9136;
    Com_Printf("%s resolved to %i.%i.%i.%i:%i\n", "cod2master.activision.com",
               MEMORY[0x170A4EC][0], MEMORY[0x170A4EC][1], MEMORY[0x170A4EC][2],
               MEMORY[0x170A4EC][3], 20700);
  }
...
void __cdecl SV_ClientEnterWorld(struct client_s *client,
                                 struct usercmd_s *cmd) {
  UNIMPLEMENTED();
}

void __cdecl SV_FreeClient(struct client_s *cl) { UNIMPLEMENTED(); }
...
void __cdecl SV_DirectConnect(struct netadr_t from) {
  ...
  if (*(int *)(sv_maxclients + 8) > 0) {
    ...
    while (1) {
      ...
      HIDWORD(v46) = *(int32_t *)((char *)&v8->netchan.remoteAddress.ip + 2);
...
void __cdecl SV_FreeClients() { UNIMPLEMENTED(); }
...
void __cdecl SV_ClientThink(struct client_s *cl, struct usercmd_s *cmd) {
  ...
  *(_DWORD *)&a1->lastUsercmd.forwardmove = result;
  if (a1->state == 4) {
    G_SetLastServerTime(931767531 * (((char *)a1 - (char *)dword_170048C) >> 2),
                        a2->serverTime);
    return ClientThink(931767531 * (((char *)a1 - (char *)dword_170048C) >> 2));
  }
  return result;
}
...
void __cdecl SV_UserMove(struct client_s *cl, struct msg_t *msg, int delta) {
  ...
  *(_DWORD *)&a8
  ...
  if (v14->state == 4) {
    ...
    v18 = v26;
    while (1) {
      if (*v16 <= v26[v17] && *v16 > (signed int)a8->lastUsercmd.serverTime) {
        v19 = *v18;
        ...
        *(_DWORD *)&a8->lastUsercmd.forwardmove = v18[6];
        if (a8->state == 4) {
          G_SetLastServerTime(
              931767531 * (((char *)a8 - (char *)dword_170048C) >> 2), v19);
...
void __cdecl SV_ExecuteClientMessage(struct client_s *cl, struct msg_t *msg) {
  ...
  if (*(_DWORD *)a8->voicePackets == sv_serverId_value ||
    ...
    if (*(_DWORD *)(legacyHacks + 4) || a8->state <= 3 ||
        ...
        dword_1700484 >= *(signed int *)((char *)&a8->nextReliableTime + 2)) {
      if (v13) {
        v14 = 1;
        goto LABEL_29;
      }
      ...
      v14 = 0;
    LABEL_29:
      *(uint32_t *)((char *)&a8->nextReliableTime + 2) = dword_1700484 + 800;
      goto LABEL_15;
    }
    v14 = 1;
  LABEL_15:
  ...
  if ((*(_DWORD *)a8->voicePackets & 0xF0) == (sv_serverId_value & 0xF0)) {
    ...
    if (*(_BYTE *)(net_lanauthorize + 8) ||
        (LODWORD(v23) = *(_DWORD *)((char *)&loc_6E5C4 + (_DWORD)a8),
         HIDWORD(v23) = *(int32_t *)((char *)&a8->netchan.remoteAddress.ip + 2),
         v24 = a8->netchan.qport, *(_QWORD *)&v19.type = v23, v19.port = v24,
         !Sys_IsLANAddress(v19))) {
      v15 = *(_DWORD *)((char *)COpenGL::SetColorMaterialEnable + (_DWORD)a8);
      LODWORD(v25) = *(_DWORD *)((char *)&loc_6E5C4 + (_DWORD)a8);
      HIDWORD(v25) = *(int32_t *)((char *)&a8->netchan.remoteAddress.ip + 2);
...
int __cdecl SV_FindFreeTempBanSlot(void) { UNIMPLEMENTED(); }

int __cdecl SV_IsBannedGuid(int) { UNIMPLEMENTED(); }
...
void __cdecl SV_UpdateUserinfo_f(struct client_s *) { UNIMPLEMENTED(); }

void __cdecl SV_Disconnect_f(struct client_s *) { UNIMPLEMENTED(); }

int __cdecl SV_ClientCommand(struct client_s *, struct msg_t *) {
  UNIMPLEMENTED();
}

SV_AuthorizeRequest(netadr_t from, int challenge) { UNIMPLEMENTED(); }

SV_AuthorizeIpPacket(netadr_t from) { UNIMPLEMENTED(); }

SV_DoneDownload_f(client_s *cl) { UNIMPLEMENTED(); }

SV_RetransmitDownload_f(client_s *cl) { UNIMPLEMENTED(); }

SV_WriteDownloadToClient(client_s *cl, msg_t *msg) { UNIMPLEMENTED(); }

SV_StopDownload_f(client_s *cl) { UNIMPLEMENTED(); }

SV_NextDownload_f(client_s *cl) { UNIMPLEMENTED(); }

SV_BeginDownload_f(client_s *cl) { UNIMPLEMENTED(); }
