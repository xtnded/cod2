...
METHODDEF void write_any_marker(j_compress_ptr cinfo, int marker,
...
GLOBAL void jinit_marker_writer(j_compress_ptr cinfo) {
  ...
  cinfo->marker = (struct jpeg_marker_writer *)(*cinfo->mem->alloc_small)(
      (j_common_ptr)cinfo, JPOOL_IMAGE, SIZEOF(struct jpeg_marker_writer));
