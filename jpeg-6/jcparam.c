...
LOCAL void add_huff_table(j_compress_ptr cinfo, JHUFF_TBL **htblptr,
...
LOCAL jpeg_scan_info *fill_a_scan(jpeg_scan_info *scanptr, int ci, int Ss,
...
LOCAL jpeg_scan_info *fill_scans(jpeg_scan_info *scanptr, int ncomps, int Ss,
                                 int Se, int Ah, int Al)
...
LOCAL jpeg_scan_info *fill_dc_scans(jpeg_scan_info *scanptr, int ncomps, int Ah,
                                    int Al)
...
GLOBAL void jpeg_simple_progression(j_compress_ptr cinfo)
{
  ...
  scanptr = (jpeg_scan_info *)(*cinfo->mem->alloc_small)(
      (j_common_ptr)cinfo, JPOOL_PERMANENT, nscans * SIZEOF(jpeg_scan_info));
