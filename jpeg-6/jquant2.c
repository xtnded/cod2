...
LOCAL int median_cut(j_decompress_ptr cinfo, boxptr boxlist, int numboxes,
                     int desired_colors)
...
/* Master routine for color selection */
{
  ...
  boxlist = (boxptr)(*cinfo->mem->alloc_small)((j_common_ptr)cinfo, JPOOL_IMAGE,
                                               desired_colors * SIZEOF(box));
...
LOCAL int find_nearby_colors(j_decompress_ptr cinfo, int minc0, int minc1,
...
LOCAL void find_best_colors(j_decompress_ptr cinfo, int minc0, int minc1,
...
METHODDEF void pass2_no_dither(j_decompress_ptr cinfo, JSAMPARRAY input_buf,
                               JSAMPARRAY output_buf, int num_rows)
...
METHODDEF void pass2_fs_dither(j_decompress_ptr cinfo, JSAMPARRAY input_buf,
                               JSAMPARRAY output_buf, int num_rows)
...
/* Allocate and fill in the error_limiter table */
{
  ...
  table = (int *)(*cinfo->mem->alloc_small)((j_common_ptr)cinfo, JPOOL_IMAGE,
...
METHODDEF void finish_pass2(j_decompress_ptr cinfo) { /* no work */ }
