              ...
              if (retcode == JPEG_REACHED_EOI)
                ...
                if (cinfo->progress != NULL && (retcode == JPEG_ROW_COMPLETED ||
                    ...
                    if (++cinfo->progress->pass_counter >=
                      ...
                      /* jdmaster underestimated number of scans; ratchet up one
                       * scan */
                      cinfo->progress->pass_limit +=
...
GLOBAL JDIMENSION jpeg_read_scanlines(j_decompress_ptr cinfo,
...
GLOBAL JDIMENSION jpeg_read_raw_data(j_decompress_ptr cinfo, JSAMPIMAGE data,
                                     JDIMENSION max_lines)
{
