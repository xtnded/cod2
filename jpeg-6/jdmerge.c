...
METHODDEF void merged_2v_upsample(j_decompress_ptr cinfo, JSAMPIMAGE input_buf,
...
METHODDEF void merged_1v_upsample(j_decompress_ptr cinfo, JSAMPIMAGE input_buf,
                                  JDIMENSION *in_row_group_ctr,
                                  JDIMENSION in_row_groups_avail,
                                  JSAMPARRAY output_buf,
                                  JDIMENSION *out_row_ctr,
