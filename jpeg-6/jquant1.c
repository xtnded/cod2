        ...
        for (ci = 0; ci < nc; ci++) {
          ...
          col_index = 0;
            ...
            for (col = width; col > 0; col--) {
               ...
               * extended the colorindex table to produce the right answers for
               * out-of-range inputs.  The maximum dither is +- MAXJSAMPLE; this
               * sets the required amount of padding.
               */
              *output_ptr +=
...
METHODDEF void quantize3_ord_dither(j_decompress_ptr cinfo,
        ...
        for (ci = 0; ci < nc; ci++) {
          ...
          belowerr = bpreverr = 0;
            ...
            for (col = width; col > 0; col--) {
               ...
               * correct for either sign of the error value. Note: errorptr
               * points to *previous* column's array entry.
               */
