...
METHODDEF void *alloc_small(j_common_ptr cinfo, int pool_id,
                            size_t sizeofobject)
...
METHODDEF void FAR *alloc_large(j_common_ptr cinfo, int pool_id,
                                size_t sizeofobject)
...
METHODDEF jvirt_sarray_ptr request_virt_sarray(j_common_ptr cinfo, int pool_id,
                                               boolean pre_zero,
...
METHODDEF jvirt_barray_ptr request_virt_barray(j_common_ptr cinfo, int pool_id,
                                               boolean pre_zero,
...
LOCAL void do_sarray_io(j_common_ptr cinfo, jvirt_sarray_ptr ptr,
                        boolean writing)
...
LOCAL void do_barray_io(j_common_ptr cinfo, jvirt_barray_ptr ptr,
                        boolean writing)
