                                        ...
                                        JDIMENSION out_rows_avail)
{
  ...
  (*cinfo->post->post_process_data)(cinfo, jmain->buffer, &jmain->rowgroup_ctr,
  ...
  my_main_ptr jmain = (my_main_ptr)cinfo->main;
    ...
    case CTX_POSTPONED_ROW:
      ...
      (*cinfo->post->post_process_data)(
          cinfo, jmain->xbuffer[jmain->whichptr], &jmain->rowgroup_ctr,
          jmain->rowgroups_avail, output_buf, out_row_ctr, out_rows_avail);
...
METHODDEF void process_data_crank_post(j_decompress_ptr cinfo,
                                       ...
                                       JDIMENSION out_rows_avail)
{
  (*cinfo->post->post_process_data)(cinfo, (JSAMPIMAGE)NULL, (JDIMENSION *)NULL,
                                    (JDIMENSION)0, output_buf, out_row_ctr,
                                    out_rows_avail);
}
                                    ...
                                    boolean need_full_buffer)
{
  ...
  jmain = (my_main_ptr)(*cinfo->mem->alloc_small)(
