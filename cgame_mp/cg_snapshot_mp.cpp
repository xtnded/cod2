  ...
  *(_DWORD *)((char *)&loc_2BDE0 + (_DWORD)v9) = *(_DWORD *)&v8->ps.stats[16];
  ...
  if ((v8->ps.pm_flags & 0xC00000) != 0) {
    ...
    if (v9[38639]) {
      ...
      v38 = (_DWORD *)v9[8];
      if (*(_DWORD *)&a3->ps.stats[20] == v38[83] && clientNum == v38[54]) {
        if (!__b[clientNum] ||
...
LABEL_15:
  ...
  LABEL_85:
    if (!*(_DWORD *)(v20[9] + 1968)) {
      ...
      if (*(int *)(v40 + 9908) > 0) {
        ...
        v42 = 0;
        do {
          v43 = (char *)cg_entities + 548 * *(_DWORD *)(v42 + v40 + 9916);
          if (*((_DWORD *)v43 + 61) == 2) {
  ...
  if ((int)a3->numEntities > 0) {
    ...
    v34 = 0;
    do {
      CG_CheckEvents(a2, (centity_s *)cg_entities + v33->entities[0].number);
      ++v34;
...
void __cdecl CG_SetInitialSnapshot(struct snapshot_t *snap) { UNIMPLEMENTED(); }
...
void __cdecl CG_ProcessSnapshots() {
  ...
  if (v5[6] != v66[0]) {
    if (v5[6] > v66[0]) {
      Com_Error(1, "\x15CG_ProcessSnapshots: n < cg->latestSnapshotNum", v60);
      v6 = v66[0];
    }
    v5[6] = v6;
  }
  *((_DWORD *)cg + 229950) = *((_DWORD *)cg + 7);
  while (1) {
    ...
    if (*((_DWORD *)cg + 8)) {
      ...
      while (1) {
        v26 = (char *)cg;
        if (*((_DWORD *)cg + 9) != *((_DWORD *)cg + 8) && !*((_DWORD *)cg + 3))
          goto LABEL_42;
        v27 = *((_DWORD *)cg + 6);
        v28 = cgs;
        v29 = *((_DWORD *)cgs + 6055);
        ...
        LABEL_40:
          ...
          if (*(_DWORD *)((char *)&loc_25BB0 + (_DWORD)cg) - v34 < 0) {
        ...
        if (((*(_BYTE *)v48 ^ LOBYTE(v32->snapFlags)) & 4) != 0) {
          ...
          if ((signed int)(v32->serverTime - *(_DWORD *)(v48 + 8)) < 0)
            Com_Error(1, "\x15CG_ProcessSnapshots: Server time went backwards",
                      v60);
          CG_SetNextSnap(a1, a2, v32);
        LABEL_42:
          v35 = cg;
...
void __cdecl CG_TransitionSnapshot(void) { UNIMPLEMENTED(); }
...
void __cdecl CG_TransitionKillcam(void) { UNIMPLEMENTED(); }
