...
void __cdecl CG_ScoresUp_f() { UNIMPLEMENTED(); }
...
void __cdecl CG_TellTarget_f(void) { UNIMPLEMENTED(); }
...
void __cdecl CG_ToggleScores_f(void) { UNIMPLEMENTED(); }

void __cdecl CG_PlayRumble_f(void) { UNIMPLEMENTED(); }
...
void __cdecl CG_ShellShock_f(void) {
  ...
  LABEL_4:
    ...
    v4 = atof(v5);
    CG_SetShellShockParmsFromDvars((shellshock_parms_t *)((char *)cgs + 26820));
    v1 = cg;
