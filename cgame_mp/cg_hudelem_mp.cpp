      ...
      for (i = 0; i != v5; ++i) {
        ...
        if (*(_DWORD *)v12 == 13) {
          ...
          if (*(_DWORD *)v12 == 13 && *(_BYTE *)(v12 + 35) &&
              CG_ServerMaterialName(*(_DWORD *)(v12 + 60), __dst, 0x40u)) {
  ...
  if (v5 > 0) {
    ...
    while (1) {
      ...
      if ((v12 & 0x40) == 0) {
        ...
        switch (*v11) {
        case 7:
          v37 = v11[26] - *(_DWORD *)((char *)&loc_25BB0 + (_DWORD)cg) + 999;
          goto LABEL_52;
        case 8:
        case 0xA:
        case 0xC:
          ...
          goto LABEL_52;
        case 9:
          v37 = v11[26] - *(_DWORD *)((char *)&loc_25BB0 + (_DWORD)cg) + 99;
          goto LABEL_52;
        case 0xB:
        ...
        v88[0] = 0.0;
        v87 = 0.0;
        CalcScreenPlacement(v88, &v87, &v86, &v85, (v62 >> 3) & 7, v62 & 7);
        CL_DrawStretchPicPhysical(v74, v60, v86, v85, 0.0, 0.0, 1.0, 1.0, v81,
                                  v72);
        v73 = a1;
...
int __cdecl CG_GetHudElemTime(struct hudelem_s const *) { UNIMPLEMENTED(); }

int __cdecl CG_GetSortedHudElems(struct hudelem_s **const) { UNIMPLEMENTED(); }
...
float __cdecl CG_HudElemHeight(struct hudelem_s const *,
                               struct cg_hudelem_t *) {
  UNIMPLEMENTED();
}
...
void __cdecl CG_HudElemPhysicalSize(int, float *, float *) { UNIMPLEMENTED(); }
