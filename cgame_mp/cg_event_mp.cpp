    ...
    if ((unsigned int)(a3 - 93) > 0x16) {
      v14 = a3 - 116;
        if ((unsigned int)(a3 - 116) > 0x16) {
            ...
            case 179:
              ConfigString =
                  CL_GetConfigString(*(_DWORD *)&a2->nextState[160] + 590);
              CG_PlaySoundAliasByName(*(float **)a2->nextState,
                                      (float *)&a2->nextState[24],
                                      ConfigString);
              return;
            case 180:
            ...
            case 183:
              ...
              CG_BulletHitEvent(*(_DWORD *)&a2->nextState[116], lerpOrigin, v91,
                                v90, *(_DWORD *)&a2->nextState[136], a3);
              return;
            case 185:
            case 186:
              CG_BulletHitClientEvent(*(_DWORD *)&a2->nextState[116],
                                      lerpOrigin,
            ...
            case 191:
              ...
              v40 = cg_weapons;
                if (*((_DWORD *)cg_weapons + 109 * v39 + 89)) {
                  ...
                  FX_PlayEffect(
                      (EffectTemplate *)
                          v40[109 * *(_DWORD *)&a2->nextState[200] + 89],
                      lerpOrigin, v91);
            ...
            case 194:
              v41 = *(_DWORD *)&a2->nextState[160];
                if ((unsigned int)(v41 - 1) <= 0x3E) {
                  ...
                  AngleVectors((float *)&a2->nextState[60],
                               (float *)&v86.dobjHandle, 0, v89);
                  FX_PlayEffect(a1, v64, lerpOrigin,
                                (const float *)&v86.dobjHandle, v89);
                }
                else {
                  Com_Printf(
            ...
            case 195:
              ...
              v52 = (EffectTemplate *)*((_DWORD *)cgs + 10 * *v51 + v51[1] +
                                        6112);
            ...
            case 198:
              ...
              v63 = *(_DWORD *)&a2->nextState[160];
                if ((v63 & 0x80u) == 0) {
                  v71 =
                      (_DWORD *)BG_GetWeaponDef(*(_DWORD *)&a2->nextState[160]);
                    if (*(_BYTE *)v71[211]) {
                      __s2 = (char *)v71[211];
                      if (v71[212])
                        v76 = 2.8;
            ...
            LABEL_223:
              if (!*((_DWORD *)cg + 45893))
                CL_DeathMessagePrint(__src, (float *)&v86.dobjHandle, __dst,
                                     v85, __s2, v76, 1.4, v89, v80);
              break;
            default:
              Com_Error(1, "\x15Unknown event: '%s'",
                        *((_DWORD *)&eventnames + a3));
              return;
            }
        }
        else {
          ...
          CG_PlayEntitySoundAlias(nextState->number,
            ...
            if (v5 == *((_DWORD *)cg + 38692)) {
              v15 = (float)((float)((float)v74 * 0.0099999998) *
                ...
                if (v15 > 12.0) {
                  v16 =
                      (int)(float)((float)((float)((float)(v15 - 12.0) / 26.0) *
                                           4.0) +
                                   4.0);
                    if (v16 <= 24) {
                      if (v16 <= 0)
...
void __cdecl CG_ItemPickup(int)
{
  UNIMPLEMENTED();
}

void __cdecl CG_Obituary(struct entityState_s *)
{
  UNIMPLEMENTED();
}

void __cdecl CG_EquipmentSound(int, bool, bool)
{
  UNIMPLEMENTED();
}

void __cdecl CG_PlayFxOnTag(struct centity_s *, int)
{
  UNIMPLEMENTED();
}
