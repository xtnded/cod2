void __cdecl Vec4Copy(float const *const, float *const)
{
  UNIMPLEMENTED();
}
...
void __cdecl CG_CalcCompassPointerRadius(float *, float)
{
  UNIMPLEMENTED();
}
            ...
            if (v74 != 3) {
                ...
                if (v74) {
                  ...
                  v26 = *(_DWORD *)(v18 + 1456);
                    if (v26) {
                      ...
                      v28 = (float)(int)(((*(_DWORD *)(*((_DWORD *)cg + 9) +
                                                       1456) &
                                           0x7FC0u) >>
                                          4) -
                                         1020);
                      v87 = v28;
                      v29 = (float)(int)(((*(_DWORD *)(*((_DWORD *)cg + 9) +
                                                       1456) &
                                           0xFF8000u) >>
                                          13) -
                                         1020);
                  ...
                  if (a3[3] > v73)
                    a3[3] = v73;
                  v36 =
                      _mm_cmplt_ss((__m128)LODWORD(v73), (__m128)LODWORD(v82));
                  LODWORD(v82) =
                      _mm_andnot_ps(v36, (__m128)LODWORD(v82)).u32[0] |
                  ...
                  v62 = 0;
                    do {
                      ...
                      if (*((_DWORD *)v37 - 7) >
                        ...
                        *((_DWORD *)v37 - 7) = 0;
                        if (*((_DWORD *)v37 - 7) >=
                                *(_DWORD *)((char *)&loc_25BB0 + (_DWORD)v38) -
                                    800 &&
                          ...
                          v39 = (__m128)0x3F800000u;
                            if (fabs(v38[v62 + 45431]) <= 1.0 &&
                              ...
                              v88 =
                                  v38[v63 + 4] -
                                  *(float *)((char *)&loc_2858C + (_DWORD)v38);
                              v58 = vectoyaw(&v87);
                              v72 = AngleNormalize360(v58 -
                                                      *((float *)cg + 45422));
                              v39.f32[0] = fsqrt((float)(v87 * v87) +
                                                 (float)(v88 * v88));
                              v82 = v39.f32[0];
                              v40 = *(float *)(cg_hudObjectiveMaxRange + 8);
                                if (v39.f32[0] <= v40) {
                                  v54 = (__m128) *
                                        (unsigned int *)(cg_hudCompassMaxRange +
                                                         8);
                                  v55 = _mm_cmpge_ss(v39, v54);
                                  LODWORD(v42) =
                                      _mm_andnot_ps(v55, v54).u32[0] |
                                      v39.i32[0] & v55.i32[0];
                                  v82 = v42;
                              ...
                              v82 = v42 - *(float *)(v41 + 8);
                              v82 = v82 /
                                    (float)(*(float *)(cg_hudObjectiveMaxRange +
                                                       8) -
                                            *(float *)(v41 + 8));
                              v82 =
                                  (float)(v82 *
                          ...
                          v89 = (float)((float)((float)(v61 * 10.0) * -0.5) +
                                        v70) -
                                (float)(v79 * v67);
                          v91 = (float)((float)(v92 * -0.5) + v71) -
                                (float)(v79 * v66);
                          CG_ApplySplitScreenCompassScale();
                          v47 = cg;
                          v77 = AngleNormalize360(
                              *((float *)cg + 41331) -
                          ...
                          v85 = *((_DWORD *)a3 + 2);
                          v86 = fminf(v73, a3[3]);
                          v53 = _mm_cmplt_ss((__m128)LODWORD(v73),
                                             (__m128)LODWORD(v82));
                          LODWORD(v82) =
                              _mm_andnot_ps(v53, (__m128)LODWORD(v82)).u32[0] |
                              LODWORD(v73) & v53.i32[0];
                            if (v50) {
                              UI_DrawHandlePic(v89, v91, v90, v92,
                                               a1->horzAlign, a1->vertAlign,
                                               v81,
                                               *((Material **)cgs + 12060));
                            }
                            else if (v52 && v82 == 1.0 ||
                                     (CG_DrawRotatedPic(v89, v91, v90, v92,
                                                        a1->horzAlign,
                                                        a1->vertAlign, v77),
                                      v52)) {
                              CG_DrawRotatedPic(v89, v91, v90, v92,
              ...
              v7 = 64;
                do {
                  ...
                  v88 = *((float *)v6 + 2) -
                        *(float *)((char *)&loc_2858C + (_DWORD)cg);
                  v57 = vectoyaw(&v87);
                  ...
                  v89 = (float)((float)((float)(v60 * 10.0) * -0.5) + v70) -
                        (float)(v78 * v65);
                  v91 = (float)((float)((float)(v12.f32[0] * 10.0) * -0.5) +
                                v71) -
                        (float)(v78 * v64);
                  CG_ApplySplitScreenCompassScale();
                  v13 = *((_DWORD *)v6 + 5);
                  ...
                  LODWORD(v82) = _mm_andnot_ps(v15, v12).u32[0] |
                                 LODWORD(v73) & v15.i32[0];
...
void __cdecl CalcCompassFriendlySize(float *, float *)
{
  UNIMPLEMENTED();
}
