int const __cdecl FastFloor(float) { UNIMPLEMENTED(); }

void __cdecl CG_StartShellShock(struct shellshock_parms_t const *, int, int) {
  UNIMPLEMENTED();
}

void __cdecl CG_PerturbCamera() { UNIMPLEMENTED(); }
...
int __cdecl CG_SaveShellShockDvars(char const *name) { UNIMPLEMENTED(); }

void __cdecl CG_PrintPerturbationPoints(void) { UNIMPLEMENTED(); }
...
int __cdecl CG_LoadShellShockDvars(char const *name) {
  ...
  if (v2 >= 0 || (Com_Printf("^1couldn't open '%s'.\n", v1),
    ...
    *(_DWORD *)v6.name = v3;
    ...
    Com_Printf("^1couldn't open 'shock/default.shock'. This is a default shock "
...
void __cdecl CG_UpdateShellShock(struct shellshock_parms_t const *parms,
  ...
  if (a2 && v4 >= 0) {
    if (!a1->sound.use) {
      ...
      if (!v3[45881]) {
        ...
        LABEL_19:
          ...
          if (a3 - v4 < fadeTime) {
            if (v20 <= 0) {
              ...
              *((float *)cg + 45882) =
                  (float)((float)(*(float *)&a1->mouse.sensitivity - 1.0) *
                          v22) +
                  1.0;
          ...
          LABEL_24:
            ...
            LABEL_25:
              ...
              *((float *)cg + 45883) =
              ...
              v35 =
                  (float)((float)(*(float *)&cg_perturbations[v26 + 7] - v32) +
                          v33) -
                  v34;
        ...
        LABEL_23:
          *((_DWORD *)cg + 45882) = v19->mouse.sensitivity;
          CL_CapTurnRate(v19->mouse.maxPitchSpeed, v19->mouse.maxYawSpeed);
          goto LABEL_24;
        }
      LABEL_36:
        *((_DWORD *)cg + 45882) = 1065353216;
      ...
      SND_PlaySoundAlias(v43, (float *)0x3FF, vec3_origin, 0, (const float *)1);
    LABEL_18:
      v18 = a1;
      if (a1->mouse.use)
        goto LABEL_19;
    ...
    if (fadeOutTime <= v6) {
      ...
      LABEL_8:
        ...
        for (i = 1; i != 12; ++i) {
          v48[i - 1] =
              (float)((float)(*(float *)v8->sound.channelvolume - 1.0) * v47) +
              1.0;
  ...
  LABEL_11:
    ...
    if (v11 > 0) {
      ...
      v13 = (const snd_alias_t *)CL_PickSoundAlias("shellshock_loop_silent");
    ...
    if (v16 >= v17) {
      ...
      *((_DWORD *)cg + 45881) = 0;
      ...
      SND_PlaySoundAlias(v42, (float *)0x3FF, vec3_origin, 0, (const float *)1);
    }
    goto LABEL_18;
  }
  SND_DeactivateChannelVolumes(3, 0);
...
void __cdecl CG_EndShellShockCamera(void) { UNIMPLEMENTED(); }

void __cdecl CG_EndShellShockMouse(void) { UNIMPLEMENTED(); }
...
void __cdecl CG_EndShellShockSound(void) { UNIMPLEMENTED(); }

void __cdecl CG_EndShellShock(void) { UNIMPLEMENTED(); }
