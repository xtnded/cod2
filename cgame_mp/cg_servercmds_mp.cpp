...
void __cdecl CG_HudMenuShowAllTimed(void)
{
  UNIMPLEMENTED();
}
...
void __cdecl CG_ParseXboxLiveRanks(void)
{
  UNIMPLEMENTED();
}

void __cdecl CG_ParseXUIDs(void)
{
  UNIMPLEMENTED();
}
                ...
                if ((unsigned int)(v21 - 142) > 0xBF) {
                    ...
                    case 16:
                      v108 = 0;
                        for (j = 0; j <= 255; ++j) {
                          v90 = &v22[j];
                          MapDisplayNameFromPartialLoadNameMatch = (char *)
                      ...
                      v112[255] = 0;
                      v95 = SEH_LocalizeTextMessage(v112, "vote string",
                                                    LOCMSG_SAFE);
        ...
        if (v57 == 2) {
          ...
          v85 = atoi(v84);
            if ((unsigned int)(v85 - 1) <= 0xFF) {
              ...
              Com_Printf(
                  "ERROR: CG_LocalSound called with index %i (should be in "
                  "range[1,%i])\n",
                  v85, 256);
            }
        }
...
void __cdecl CG_SetScriptMainMenu(char const *)
{
  UNIMPLEMENTED();
}

void __cdecl CG_SetDrawHud(int)
{
  UNIMPLEMENTED();
}

void __cdecl CG_SetObjectiveText(char const *)
{
  UNIMPLEMENTED();
}

void __cdecl CG_SetTeamScore(int, int)
{
  UNIMPLEMENTED();
}

void __cdecl CG_RemoveChatEscapeChar(char *)
{
  UNIMPLEMENTED();
}

void __cdecl CG_AddToTeamChat(char const *)
{
  UNIMPLEMENTED();
}

void __cdecl CG_RegisterServerMaterial(int)
{
  UNIMPLEMENTED();
}

void __cdecl CG_ParseScores(void)
{
  UNIMPLEMENTED();
}
...
void __cdecl CG_UpdateVoteString(char const *)
{
  UNIMPLEMENTED();
}

void __cdecl CG_PrecacheScriptMenu(int)
{
  UNIMPLEMENTED();
}
...
void __cdecl CG_DeactivateChannelVolCmd(void)
{
  ...
  v0 = Cmd_Argc();
    if (v0 == 3) {
      ...
      Com_Printf("ERROR: CG_DeactivateChannelVolCmd called with %i args "
                 "(should be 3)\n",
                 v0);
    }
}
...
void __cdecl CG_LocalSound(void)
{
  UNIMPLEMENTED();
}

void __cdecl CG_ReverbCmd(void)
{
  UNIMPLEMENTED();
}

void __cdecl CG_ConfigStringModified(void)
{
  UNIMPLEMENTED();
}
