...
void __cdecl CG_InitMarkPolys() { UNIMPLEMENTED(); }

void __cdecl CG_AddMarks() { UNIMPLEMENTED(); }

void __cdecl CG_FreeMarkPoly(struct MarkPoly *) { UNIMPLEMENTED(); }
  ...
  if (v35 > 0) {
    ...
    do {
      ...
      *(_DWORD *)(v25 + 8) = *(_DWORD *)v26;
      result =
          memcpy((void *)(v25 + 36), &markVerts + *(_DWORD *)(p_pointCount + 2),
                 68 * *p_pointCount);
      ++v19;
      p_pointCount += 12;
    } while (v35 != v19);
