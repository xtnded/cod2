void __cdecl CG_UpdatePlayerDObj(struct centity_s *cent)
{
  ...
  DObj_s *ClientDObj; // eax
    ...
    if (a2->nextValid) {
      ...
      BG_UpdatePlayerDObj(a1, ClientDObj, (entityState_s *)a2->nextState, v2,
                          0);
    }
}
...
void __cdecl CG_ResetPlayerEntity(struct centity_s *)
{
  ...
  v1 = (char *)cg + 1208 * *(_DWORD *)&a1->nextState[144] + 919828;
    if ((*(_DWORD *)&a1->nextState[8] & 0x20000) == 0) {
      v2 = (XAnimTree_s *)*((_DWORD *)cg +
                            302 * *(_DWORD *)&a1->nextState[144] + 230254);
      ...
      XAnimSetCompleteGoalWeight(v2, v5[459881], 0x3F800000u, 0.0, 1065353216,
                                 0, 0, 0);
      ...
      result = (char *)cg + 1208 * *(_DWORD *)(*((_DWORD *)cg + 9) + 216);
        if (*((_DWORD *)result + 229957)) {
          ...
          v3 = *(_DWORD *)&a1->nextState[148];
            if (v3 &&
                ((v4 = *(_DWORD *)&a1->nextState[152]) == 0 || v2 == 3 ||
                 v2 == v4) &&
...
void __cdecl CG_Corpse(struct centity_s *cent)
{
  ...
  nextState = a2->nextState;
    if ((a2->nextState[8] & 0x20) == 0) {
      v8 = (clientInfo_t *)((char *)cgs + 1208 * *(_DWORD *)a2->nextState -
                            27628);
      ClientDObj =
      ...
      v7 = *(_DWORD *)&a1->nextState[116];
        ...
        if (v7 != 1023) {
          ...
          v71 = (int)&v6[1208 * *(_DWORD *)&a1->nextState[144] + 920724];
            if (*(_DWORD
                      *)&v6[1208 * *(_DWORD *)&a1->nextState[144] + 920740]) {
              v8 = *(
                  _DWORD *)&v6[1208 * *(_DWORD *)&a1->nextState[144] + 920744];
              if (!v8)
                goto LABEL_46;
                if ((*(_BYTE *)(v8 + 80) & 4) != 0) {
                  ...
                  v70 = (centity_s *)v9;
                    if (v9[480]) {
                      v10 = Com_GetClientDObj(*((_DWORD *)v9 + 60),
                                              *((_DWORD *)v9 + 136));
                        if (v10) {
                          LocalTagMatrix = (float *)CG_DObjGetLocalTagMatrix(
                            ...
                            if (LocalTagMatrix) {
                                if (*((_DWORD *)v6 + 38635)) {
                                  ...
                                  lerpOrigin = a1->lerpOrigin;
                                  v78 =
                                      (float)((float)(a1->lerpOrigin[2] - v94) *
                                              v91[8]) +
                                      (float)((float)((float)(a1->lerpOrigin
                                                                  [1] -
                                                              v93) *
                                                      v91[7]) +
                                              (float)((float)(a1->lerpOrigin
                                                                  [0] -
                                                              v92) *
                                                      v91[6]));
                                  v74 = v78 - LocalTagMatrix[6];
                                  XAnimClearTreeGoalWeightsStrict(v80, v82,
                                                                  0.0);
                                  NumChildren = XAnimGetNumChildren(v81, v82);
                                    if (!NumChildren) {
                                      AnimDebugName = (unsigned __int8)
                                          XAnimGetAnimDebugName(v81, v82);
                                      Com_Error(1,
                                                "\x15Player anim '%s' has no "
                                                "children",
                                                AnimDebugName);
                                    }
                                  v76 = 0.0;
                                  ...
                                  v66 = 0;
                                    for (i = XAnimGetChildAt(v81, v82, 0);;
                                      ...
                                      v28 = i;
                                      XAnimSetGoalWeight(v80, i, 0x3F800000u,
                                                         1.0, 1065353216, 0, 0,
                                                         0);
                                      v29 = XAnimGetNumChildren(v81, v28);
                                        if (!v29) {
                                          v36 = (unsigned __int8)
                                              XAnimGetAnimDebugName(v81, v28);
                                          Com_Error(1,
                                                    "\x15Player anim '%s' has "
                                                    "no children",
                                                    v36);
                                        }
                                      v30 = (float)((float)v29 * 0.5) -
                                            (float)(v73 / *(float *)(WeaponDef +
                                                                     1380));
                                        if (v30 < 0.0) {
                                          v30 = 0.0;
                                          v27 = 0;
                                      ...
                                      XAnimSetGoalWeight(
                                          ...
                                          1065353216, 0, 0, 0);
                                        if (v88 != 0.0) {
                                          v84 = XAnimGetChildAt(v81, v28,
                                                                v27 + 1);
                                          XAnimSetGoalWeight(
                                              v80, v84, LODWORD(v88), 1.0,
                                              1065353216, 0, 0, 0);
                                        }
                                ...
                                LABEL_49:
                                  ...
                                  if (v37 > 0.0)
                                    v38 = 1.0 / v37;
                                  XAnimSetGoalWeight(v80, ChildAt, LODWORD(v64),
                                                     v38, 1065353216, 0, 0, 0);
                                    if (v88 != 0.0) {
                                      ...
                                      if (v42 > 0.0)
                                        v43 = 1.0 / v42;
                                      XAnimSetGoalWeight(v80, v84, LODWORD(v88),
                                                         v43, 1065353216, 0, 0,
                                                         0);
                                    }
                                    if (v66 && v66 != NumChildren) {
                                      ...
                                      if (v44 > 0.0)
                                        v45 = 1.0 / v44;
                                      XAnimSetGoalWeight(v80, v28, LODWORD(v77),
                                                         v45, 1065353216, 0, 0,
                                                         0);
                                      v46 = XAnimGetChildAt(v81, v82, v66 - 1);
                                      v59 = XAnimGetWeight(v80, v46);
                                      v47 =
                                          fabs(v59 - (float)(1.0 - v77)) *
                                          (float)(1000.0 /
                                                  (float)*((int *)cg + 38635));
                                      v48 = 0.0;
                                      if (v47 > 0.0)
                                      ...
                                      XAnimSetGoalWeight(
                                          v80, v49,
                                          COERCE_UNSIGNED_INT(1.0 - v76), v51,
                                          1065353216, 0, 0, 0);
                                        if (v76 != 0.0) {
                                          v52 = XAnimGetChildAt(v81, v46,
                                                                v68 + 1);
                                      ...
                                      if (v39 > 0.0)
                                        v40 = 1.0 / v39;
                                      XAnimSetGoalWeight(v80, v28, 0x3F800000u,
                                                         v40, 1065353216, 0, 0,
                                                         0);
                                    }
                                  ...
                                  *lerpOrigin = v96;
                                  ...
                                  if (v99.fraction < 1.0)
                                    a1->lerpOrigin[2] =
                                        v107 + (float)(v99.fraction *
                                                       (float)(v104 - v107));
                                  goto LABEL_34;
                                }
                              goto LABEL_46;
                            }
                          Com_Printf("WARNING: aborting player positioning on "
                                     "turret since "
