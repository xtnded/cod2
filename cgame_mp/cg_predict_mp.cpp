    ...
    do {
      ...
      if (*v11 != a5) {
        ...
        if (v12 == &unk_FFFFFF) {
          ...
          if ((float)(*(float *)(v10 + 492) + (float)(1.0 - v14)) >= v24)
            goto LABEL_10;
          ...
          if (v22 >= (float)(*(float *)(v10 + 496) + v31))
            goto LABEL_10;
          v15 = *(float *)(v10 + 500);
          if ((float)((float)(1.0 - (float)(BYTE1(v12) - 1)) + v15) >= v26 ||
              v23 >= (float)(v15 + (float)((float)(BYTE2(v12) - 32) - 1.0))) {
            goto LABEL_10;
          }
        ...
        CM_TransformedBoxTraceExternal(&v20, a1, a4, a2, a3, v19, (float *)a6,
        ...
        if (a8->fraction > v20.fraction) {
          v20.entityNum = *v11;
          *a8 = v20;
          result = (trace_t *)Trace_CalcBounds(a1, a2, a3, fraction, a4, &v21);
...
void __cdecl CG_PredictPlayerState() { UNIMPLEMENTED(); }
...
void __cdecl CG_InterpolatePlayerState(int) { UNIMPLEMENTED(); }

void __cdecl CG_TouchItem(struct centity_s *) { UNIMPLEMENTED(); }

void __cdecl CG_TouchTriggerPrediction(void) { UNIMPLEMENTED(); }

void __cdecl CG_PredictPlayerState_Internal(void) { UNIMPLEMENTED(); }
