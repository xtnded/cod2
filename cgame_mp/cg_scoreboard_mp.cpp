...
void __cdecl CG_ScrollScoreboardUp() { UNIMPLEMENTED(); }

int __cdecl CG_ScoreboardDisplayed() { return *((_DWORD *)cg + 44365); }

bool __cdecl Scoreboard_HandleInputXboxLive(int) { UNIMPLEMENTED(); }

bool __cdecl Scoreboard_HandleInputNonXboxLive(int) { UNIMPLEMENTED(); }
...
bool __cdecl Scoreboard_HandleInput(int) { UNIMPLEMENTED(); }
...
int __cdecl CG_DrawScoreboard() { UNIMPLEMENTED(); }

bool __cdecl Scoreboard_IsValidInput(int) { UNIMPLEMENTED(); }

void __cdecl CG_GetScoreboardInfo(struct listColumnInfo_t const **, int *) {
  UNIMPLEMENTED();
}

float __cdecl CG_BackdropTop(void) { UNIMPLEMENTED(); }

float __cdecl CG_BackdropLeft(void) { UNIMPLEMENTED(); }

float __cdecl CG_BackdropHeight(void) { UNIMPLEMENTED(); }

float __cdecl CG_BackdropWidth(void) { UNIMPLEMENTED(); }

float __cdecl CG_BannerScoreboardScaleMultiplier(void) { UNIMPLEMENTED(); }

float __cdecl CG_ScoreboardScaleMultiplier(void) { UNIMPLEMENTED(); }

int __cdecl CG_CheckDrawScoreboardLine(int *, float, float) { UNIMPLEMENTED(); }

float __cdecl CG_DrawScoreboard_ListHeight(int *) { UNIMPLEMENTED(); }

float __cdecl CG_ObjectiveLineHeight(void) { UNIMPLEMENTED(); }

float __cdecl CG_ObjectiveFontScale(void) { UNIMPLEMENTED(); }

void __cdecl CG_DrawScrollbar(float *const, float, int, int) {
  UNIMPLEMENTED();
}

void __cdecl CG_DrawBackdropMapName(float, char const *) { UNIMPLEMENTED(); }

void __cdecl CG_DrawBackdropGameType(float, char const *) { UNIMPLEMENTED(); }

void __cdecl CG_DrawBackdropMainBorders(float) { UNIMPLEMENTED(); }
...
void __cdecl CG_DrawBackdropBackground(float) { UNIMPLEMENTED(); }
...
void __cdecl CG_DrawScoreboard_Backdrop(float) { UNIMPLEMENTED(); }
...
float __cdecl CG_DrawObjectiveInfo(float *const, float) { UNIMPLEMENTED(); }

void __cdecl CG_DrawScoreboard_ScoresList(float) { UNIMPLEMENTED(); }
