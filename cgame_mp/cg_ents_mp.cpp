    ...
    if (result) {
        if (*(_DWORD *)&a1->nextState[188]) {
          ...
          result = CG_PlaySoundOnCurrentLocalClient();
            if ((_BYTE)result) {
              ConfigString =
                  CL_GetConfigString(*(_DWORD *)&a1->nextState[184] + 590);
                        ...
                        COERCE_INT(
                            *(float *)&a1->currentState[212] +
                            (float)((float)(*(float *)&a1->nextState[212] -
                                            *(float *)&a1->currentState[212]) *
                                    *((float *)cg + 38634))),
                        *(float **)a1->nextState, a1->lerpOrigin, 0,
                        (const float *)1);
                }
            }
        }
  ...
  v1 = *(_DWORD *)&a1->nextState[132];
    if (v1) {
        if (*(_UNKNOWN **)&a1->nextState[156] == &unk_FFFFFF) {
          v4 = (float *)((char *)cgs + 12 * *(_DWORD *)&a1->nextState[140] +
                         33160);
          ...
          v6 = v5[61];
            if (v6 == 1) {
              ...
              if (*((_DWORD *)cg + 302 * v7->clientNum + 229957))
                BG_Player_DoControllers(v8, v7, v9,
                                        (clientInfo_t *)((char *)cg +
                                                         1208 * v7->clientNum +
                                                         919828),
                                        *((_DWORD *)cg + 38635));
            }
    ...
    if (!result) {
      ...
      v4 = *(_DWORD *)&a1->nextState[4];
        if (v4 == 1) {
          ...
          v5 = (clientInfo_t *)((char *)cg +
                                1208 * *(_DWORD *)&a1->nextState[144] + 919828);
          if (*(_DWORD *)v5->infoValid)
            BG_Player_DoControllers(ClientDObj,
                                    (const entityState_s *)a1->nextState, v7,
                                    v5, *((_DWORD *)cg + 38635));
        }
        else if (v4 == 9) {
        ...
        if (DObj) {
            if (*((_DWORD *)v8 + 91)) {
                if (a2->bTrailMade) {
                  ...
                  v10.boneIndex = FX_GetBoneIndex(
                      v10.dobjHandle, (unsigned __int16)word_195B122);
                  lerpOrigin = a2->lerpOrigin;
      ...
      __b.renderFxFlags = 64;
        if (*(_UNKNOWN **)&a2->nextState[156] == &unk_FFFFFF) {
          ...
          R_AddRefEntityToScene(
              &__b,
              *(GfxModel *)((char *)cgs + 4 * *(_DWORD *)&a2->nextState[140] +
                            29068),
              0);
        }
        else {
  ...
  CG_EntityEffects(a1);
    ...
    case 8:
      ...
      v4 = *(float *)&a1->nextState[104];
        if (v4 == 0.0 ||
            (v16 = Vec3DistanceSq((char *)cg + 154584, a1->lerpOrigin),
             v16 < (float)(v4 * v4))) {
                ...
                if ((float)((float)((float)(*(float *)&a1->nextState[92] *
                  ...
                  v7 = *(_DWORD *)&a1->nextState[160];
                    if (v7) {
                      ...
                      v12 = -(
                          float)((float)((float)(*(float *)&__b.reType *
                                                 *(float *)&a1->nextState[92]) +
                                         (float)(*(float *)&a1->nextState[96] *
                                                 *(float *)&__b
                                                      .renderFxFlags)) +
...
void *__cdecl CG_AllocAnimTree(int)
{
  return MT_Alloc(a1, 5);
}
...
void __cdecl CG_LoopFx(struct centity_s *)
{
  UNIMPLEMENTED();
}

void __cdecl CG_mg42(struct centity_s *)
{
  UNIMPLEMENTED();
}
