...
void __cdecl CGScr_LoadAnimTrees() { UNIMPLEMENTED(); }

void __cdecl CG_SafeDObjFree(int iEntNum) { UNIMPLEMENTED(); }

void __cdecl CG_FreeClientDObjInfo() { UNIMPLEMENTED(); }

void __cdecl CG_FreeEntityDObjInfo() { UNIMPLEMENTED(); }
