float __cdecl CG_CalcTracerFinalScale(float, float, float) { UNIMPLEMENTED(); }

void __cdecl CG_HoldBreathInit() { UNIMPLEMENTED(); }

int __cdecl CG_WeaponDObjHandle(int weaponNum) { return a1 + 1024; }
  ...
  while (BG_GetNumWeapons() >= v4) {
    if (((*((int *)cg + (v4 >> 5) + 38978) >> (v4 & 0x1F)) & 1) != 0 &&
        !BG_IsPlayerWeaponInSlot(
            (const playerState_s *)((char *)&loc_25BC4 + (_DWORD)cg), v4, 1) &&
        BG_GetStackSlotForWeapon((const playerState_s *)((char *)cg + 154564),
                                 v4, WEAPSLOT_NONE) == WEAPSLOT_NONE &&
...
int __cdecl CG_SelectFirstWeaponInSlot(int, int) { UNIMPLEMENTED(); }
      ...
      if (result >= *(_DWORD *)(cg_weaponCycleDelay + 8)) {
        *((_DWORD *)cg + 44949) = *(_DWORD *)((char *)&loc_25BB0 + (_DWORD)cg);
        ...
        if ((unsigned int)(WeaponSlotForName - 1) <= 1) {
          result = *((unsigned __int8 *)v0 + WeaponSlotForName + 155928);
          v4 = (char)result;
          if ((_BYTE)result) {
            result = v0[((char)result >> 5) + 38978] >> (result & 0x1F);
            if ((result & 1) != 0) {
              v0[44949] = *(_DWORD *)((char *)&loc_25BB0 + (_DWORD)v0);
              result = v0[44948];
              if (v4 != result) {
                v5 = *(_DWORD *)(BG_GetWeaponDef(v0[44948]) + 876);
                v0[44948] = v4;
...
void __cdecl CG_CycleWeap(int bNext, int bIgnoreEmpty) {
    ...
    if (!IsPlayerWeaponInSlot) {
      ...
      while (1) {
        ...
        if (NumWeapons == v24)
          break;
        v26 = cg;
        if (((*((int *)cg + (v24 >> 5) + 38978) >> (v24 & 0x1F)) & 1) != 0 &&
            !BG_IsPlayerWeaponAnAlt(v24, *((_DWORD *)cg + 44948)) &&
            !BG_IsPlayerWeaponInSlot(
                (const playerState_s *)((char *)&loc_25BC4 + (_DWORD)v26), v24,
                1) &&
            BG_GetStackSlotForWeapon(
                (const playerState_s *)((char *)&loc_25BC4 + (_DWORD)v26), v24,
                WEAPSLOT_NONE) == WEAPSLOT_NONE &&
            (!a2 || BG_WeaponAmmo((const playerState_s *)((char *)&loc_25BC4 +
                                                          (_DWORD)v26),
                                  v24)) &&
          ...
          if ((windowDef_t *)v24 == result)
            return result;
          v27 = v24 && v24 == *(_DWORD *)(BG_GetWeaponDef(v26[44948]) + 876);
          *((_DWORD *)cg + 44948) = v24;
      ...
      *((_DWORD *)cg + 44949) = *(_DWORD *)((char *)&loc_25BB0 + (_DWORD)cg);
      ...
      if ((windowDef_t *)v18 != result) {
        v20 = v18 && v18 == *(_DWORD *)(BG_GetWeaponDef((int)result) + 876);
        *((_DWORD *)cg + 44948) = v19;
        result = CG_MenuShowNotify((windowDef_t *)1);
        if (!v20)
          return (windowDef_t *)CL_SetADS(0);
  ...
  LABEL_32:
    ...
    LABEL_41:
      v23 = cg;
      result =
          (windowDef_t *)(*((int *)cg + (*((int *)cg + 44948) >> 5) + 38978) >>
...
void __cdecl CG_OutOfAmmoChange() { UNIMPLEMENTED(); }

void __cdecl CG_PrevWeapon_f() { UNIMPLEMENTED(); }

void __cdecl CG_NextWeapon_f() { UNIMPLEMENTED(); }
...
void __cdecl CG_AltWeapon_f(void) { UNIMPLEMENTED(); }
  ...
  if (result != (weaponInfo_s *)a2->iPrevAnim) {
    ...
    case 0u:
      ...
      while (XAnimHasFinished(Tree, v12)) {
        if (++v12 == 21) {
          if (*(_DWORD *)&a1
                   ->ammoclip[4 * BG_ClipForWeapon(ViewmodelWeaponIndex)]) {
            ...
            for (i = 1; i != 21; ++i) {
              if ((_WORD)i == 1)
                ...
                XAnimSetGoalWeight(Tree, i, 0, 0.0, *((_DWORD *)v70 + 2), 0, 0,
                                   0);
              v70 += 4;
            }
          } else {
            ...
            do {
              if ((_WORD)v12 == 2)
                ...
                XAnimSetGoalWeight(Tree, v12, 0, 0.0, *((_DWORD *)v68 + 2), 0,
                                   0, 0);
              v68 += 4;
              ++v12;
            } while (v12 != 21);
    ...
    case 2u:
      ...
      for (j = 1; j != 21; ++j) {
        if ((_WORD)j == 3)
          XAnimSetGoalWeight(Tree, 3, 0x3F800000u, 0.0, *((_DWORD *)v64 + 4), 0,
                             1, 1);
        else
          XAnimSetGoalWeight(Tree, j, 0, 0.0, *((_DWORD *)v65 + 2), 0, 0, 0);
        v65 += 4;
      }
      goto LABEL_16;
    case 3u:
      ...
      for (k = 1; k != 21; ++k) {
        if ((_WORD)k == 5)
          XAnimSetGoalWeight(Tree, 5, 0x3F800000u, 0.0, *((_DWORD *)v61 + 6), 0,
                             1, 1);
        else
          XAnimSetGoalWeight(Tree, k, 0, 0.0, *((_DWORD *)v62 + 2), 0, 0, 0);
        v62 += 4;
      }
      goto LABEL_16;
    case 4u:
      ...
      for (m = 1; m != 21; ++m) {
        if ((_WORD)m == 6)
          XAnimSetGoalWeight(Tree, 6, 0x3F800000u, 0.0, *((_DWORD *)v58 + 7), 0,
                             1, 1);
        else
          XAnimSetGoalWeight(Tree, m, 0, 0.0, *((_DWORD *)v59 + 2), 0, 0, 0);
        v59 += 4;
      }
      goto LABEL_16;
    case 5u:
      ...
      for (n = 1; n != 21; ++n) {
        if ((_WORD)n == 18)
          XAnimSetGoalWeight(Tree, 18, 0x3F800000u, 0.0, *((_DWORD *)v55 + 19),
                             0, 1, 1);
        else
          XAnimSetGoalWeight(Tree, n, 0, 0.0, *((_DWORD *)v56 + 2), 0, 0, 0);
        v56 += 4;
      }
      goto LABEL_16;
    case 6u:
      ...
      for (ii = 1; ii != 21; ++ii) {
        if ((_WORD)ii == 19)
          XAnimSetGoalWeight(Tree, 19, 0x3F800000u, 0.0, *((_DWORD *)v52 + 20),
                             0, 1, 1);
        else
          XAnimSetGoalWeight(Tree, ii, 0, 0.0, *((_DWORD *)v53 + 2), 0, 0, 0);
        v53 += 4;
      }
      goto LABEL_16;
    case 7u:
      ...
      for (jj = 1; jj != 21; ++jj) {
        if ((_WORD)jj == 20)
          XAnimSetGoalWeight(Tree, 20, 0x3F800000u, 0.0, *((_DWORD *)v49 + 21),
                             0, 1, 1);
        else
          XAnimSetGoalWeight(Tree, jj, 0, 0.0, *((_DWORD *)v50 + 2), 0, 0, 0);
        v50 += 4;
      }
      goto LABEL_16;
    case 8u:
      ...
      for (kk = 1; kk != 21; ++kk) {
        if ((_WORD)kk == 7)
          XAnimSetGoalWeight(Tree, 7, 0x3F800000u, 0.0, *((_DWORD *)v46 + 8), 0,
                             1, 1);
        else
          XAnimSetGoalWeight(Tree, kk, 0, 0.0, *((_DWORD *)v47 + 2), 0, 0, 0);
        v47 += 4;
      }
      goto LABEL_16;
    case 9u:
      ...
      for (mm = 1; mm != 21; ++mm) {
        if ((_WORD)mm == 13)
          XAnimSetGoalWeight(Tree, 13, 0x3F800000u, 0.0, *((_DWORD *)v43 + 14),
                             0, 1, 1);
        else
          XAnimSetGoalWeight(Tree, mm, 0, 0.0, *((_DWORD *)v44 + 2), 0, 0, 0);
        v44 += 4;
      }
      goto LABEL_16;
    case 0xAu:
      ...
      for (nn = 1; nn != 21; ++nn) {
        if ((_WORD)nn == 12)
          XAnimSetGoalWeight(Tree, 12, 0x3F800000u, 0.0, *((_DWORD *)v40 + 13),
                             0, 1, 1);
        else
          XAnimSetGoalWeight(Tree, nn, 0, 0.0, *((_DWORD *)v41 + 2), 0, 0, 0);
        v41 += 4;
      }
      goto LABEL_16;
    case 0xBu:
      ...
      for (i1 = 1; i1 != 21; ++i1) {
        if ((_WORD)i1 == 8)
          XAnimSetGoalWeight(Tree, 8, 0x3F800000u, 0.0, *((_DWORD *)v37 + 9), 0,
                             1, 1);
        else
          XAnimSetGoalWeight(Tree, i1, 0, 0.0, *((_DWORD *)v38 + 2), 0, 0, 0);
        v38 += 4;
      }
      goto LABEL_16;
    case 0xCu:
      ...
      for (i2 = 1; i2 != 21; ++i2) {
        if ((_WORD)i2 == 9)
          XAnimSetGoalWeight(Tree, 9, 0x3F800000u, 0.0, *((_DWORD *)v34 + 10),
                             0, 1, 1);
        else
          XAnimSetGoalWeight(Tree, i2, 0, 0.0, *((_DWORD *)v35 + 2), 0, 0, 0);
        v35 += 4;
      }
      goto LABEL_16;
    case 0xDu:
      ...
      for (i3 = 1; i3 != 21; ++i3) {
        if ((_WORD)i3 == 10)
          XAnimSetGoalWeight(Tree, 10, 0x3F800000u, 0.0, *((_DWORD *)v31 + 11),
                             0, 1, 1);
        else
          XAnimSetGoalWeight(Tree, i3, 0, 0.0, *((_DWORD *)v32 + 2), 0, 0, 0);
        v32 += 4;
      }
      goto LABEL_16;
    case 0xEu:
      ...
      for (i4 = 1; i4 != 21; ++i4) {
        if ((_WORD)i4 == 11)
          XAnimSetGoalWeight(Tree, 11, 0x3F800000u, 0.0, *((_DWORD *)v28 + 12),
                             0, 1, 1);
        else
          XAnimSetGoalWeight(Tree, i4, 0, 0.0, *((_DWORD *)v29 + 2), 0, 0, 0);
        v29 += 4;
      }
      goto LABEL_16;
    case 0xFu:
      ...
      for (i5 = 1; i5 != 21; ++i5) {
        if ((_WORD)i5 == 15)
          XAnimSetGoalWeight(Tree, 15, 0x3F800000u, 0.0, *((_DWORD *)v25 + 16),
                             0, 1, 1);
        else
          XAnimSetGoalWeight(Tree, i5, 0, 0.0, *((_DWORD *)v26 + 2), 0, 0, 0);
        v26 += 4;
      }
      goto LABEL_16;
    case 0x10u:
      ...
      for (i6 = 1; i6 != 21; ++i6) {
        if ((_WORD)i6 == 14)
          XAnimSetGoalWeight(Tree, 14, 0x3F800000u, 0.0, *((_DWORD *)v22 + 15),
                             0, 1, 1);
        else
          XAnimSetGoalWeight(Tree, i6, 0, 0.0, *((_DWORD *)v23 + 2), 0, 0, 0);
        v23 += 4;
      }
      goto LABEL_16;
    case 0x11u:
      ...
      for (i7 = 1; i7 != 21; ++i7) {
        if ((_WORD)i7 == 17)
          XAnimSetGoalWeight(Tree, 17, 0x3F800000u, 0.0, *((_DWORD *)v19 + 18),
                             0, 1, 1);
        else
          XAnimSetGoalWeight(Tree, i7, 0, 0.0, *((_DWORD *)v20 + 2), 0, 0, 0);
        v20 += 4;
      }
      goto LABEL_16;
    case 0x12u:
      ...
      for (i8 = 1; i8 != 21; ++i8) {
        if ((_WORD)i8 == 16)
          XAnimSetGoalWeight(Tree, 16, 0x3F800000u, 0.0, *((_DWORD *)v16 + 17),
                             0, 1, 1);
        else
          XAnimSetGoalWeight(Tree, i8, 0, 0.0, *((_DWORD *)v17 + 2), 0, 0, 0);
        v17 += 4;
      }
      goto LABEL_16;
    case 0x13u:
      ...
      for (i9 = 1; i9 != 21; ++i9) {
        if ((_WORD)i9 == 4)
          XAnimSetGoalWeight(Tree, 4, 0x3F800000u, 0.0, *((_DWORD *)v13 + 5), 0,
                             1, 1);
        else
          XAnimSetGoalWeight(Tree, i9, 0, 0.0, *((_DWORD *)v14 + 2), 0, 0, 0);
        v14 += 4;
      }
      goto LABEL_16;
    default:
    ...
    do {
      while ((_WORD)v10 != 1) {
        XAnimSetGoalWeight(Tree, v10, 0, 0.0, *((_DWORD *)v9 + 2), 0, 0, 0);
        v9 += 4;
        if (++v10 == 21)
          goto LABEL_15;
      }
      XAnimSetGoalWeight(Tree, 1, 0x3F800000u, 0.0, *((_DWORD *)v8 + 2), 0, 1,
                         1);
      v9 += 4;
      ++v10;
    } while (v10 != 21);
...
void __cdecl CG_WhizbySound(float *const vStart, float *const vEnd) {
  ...
  if (v3 >= 64.0 && (float)(v3 + 64.0) <=
                        (float)((float)((float)(v7 * v10) + (float)(v8 * v11)) +
                                (float)(v9 * v12))) {
    v4 = (float)(v7 * v3) + *a1;
    v5 = (float)(v8 * v3) + a1[1];
    v6 = (float)(v3 * v9) + a1[2];
...
void __cdecl CG_RegisterWeapon(int weaponNum) { UNIMPLEMENTED(); }
...
void __cdecl CG_EjectWeaponBrass(struct entityState_s *ent, int event) {
  ...
  if (!*((_DWORD *)v5 + 88) || a3 != 160) {
    ...
    if ((*(_DWORD *)(v6 + 24) & 0xC00000) != 0) {
      ...
      LABEL_11:
        v13.dobjHandle = v8;
        v13.boneIndex = FX_GetBoneIndex(v8, (unsigned __int16)word_195B114);
...
void __cdecl CG_RegisterItemVisuals(int itemNum) { UNIMPLEMENTED(); }

void __cdecl CG_UpdateHandViewmodels(char const *handModel) { UNIMPLEMENTED(); }
...
void __cdecl CG_FireWeapon(struct centity_s *cent, int event, int barrel) {
  ...
  if (v5) {
    if (v5 > BG_GetNumWeapons()) {
      Com_Error(1, "\x15CG_FireWeapon: ent->weapon > BG_GetNumWeapons()", v18);
      return;
    }
    ...
    if (*(_DWORD *)&a2->nextState[4] == 9) {
      ...
      v17 = (EffectTemplate *)(v14 ? *((_DWORD *)cg_weapons + 109 * v15 + 48)
                                   : *((_DWORD *)cg_weapons + 109 * v15 + 49));
      if (v17) {
    ...
    LABEL_12:
      if (!v7) {
      LABEL_21:
        if (!*(_DWORD *)(BG_GetWeaponDef(*(_DWORD *)&a2->nextState[200]) + 808))
  ...
  LABEL_16:
    if (v10 == *(_DWORD *)(v9 + 216)) {
      if (*(_DWORD *)v19 &&
          CG_DObjGetViewModelTagPos(*(DObj_s **)v19,
                                    (unsigned __int16)word_195B10C, v22)) {
      LABEL_19:
    ...
    LABEL_39:
      BG_EvaluateTrajectory((const trajectory_t *)&a2->nextState[12],
                            *(_DWORD *)((char *)&loc_25BB0 + (_DWORD)cg), v22);
      goto LABEL_19;
    }
  LABEL_17:
    ClientDObj = Com_GetClientDObj(v10, a2->localClientNum);
    if (ClientDObj && CG_DObjGetWorldTagPos(
                          a2, ClientDObj, (unsigned __int16)word_195B10C, v22))
      goto LABEL_19;
    goto LABEL_39;
  }
}
...
void __cdecl CG_AddPlayerWeapon(struct GfxEntity *parent,
  ...
  if (ViewmodelWeaponIndex > 0 && (*(_DWORD *)&a4->nextState[8] & 0x300) == 0) {
    ...
    if (v29) {
      if (a5) {
        ...
        *(float *)&__b[16] = a3->origin[2] + *(float *)&a3->viewHeightCurrent;
        ...
        *((float *)v10 + 45891) =
        ...
        if (v21 < 0) {
          *((_DWORD *)v10 + 45888) = 0;
          if (*((int *)v10 + 45890) <= 0) {
            *((_DWORD *)v10 + 45889) =
                CG_PlayClientSoundAlias(*((snd_alias_list_t **)cgs + 12401));
            *((_DWORD *)v10 + 45890) =
                (int)(float)(1000.0 * *(float *)(player_breath_snd_delay + 8));
          } else {
            *((_DWORD *)v10 + 45889) = 0;
          }
        ...
        *((_DWORD *)cg + 45888) += *((_DWORD *)cg + 38635);
        ...
        if (v12 >= 0) {
          *((_DWORD *)v10 + 45888) = *((_DWORD *)v10 + 38635) + v12;
          if ((int)(float)(*(float *)(player_breath_hold_time + 8) * 1000.0) <
              *((_DWORD *)v10 + 45888)) {
            CG_PlayClientSoundAlias(*((snd_alias_list_t **)cgs + 12403));
          } else if (*((int *)v10 + 45890) <= 0) {
            CG_PlayClientSoundAlias(*((snd_alias_list_t **)cgs + 12402));
            *((_DWORD *)v10 + 45890) =
                (int)(float)(1000.0 * *(float *)(player_breath_snd_delay + 8));
          }
        }
...
void __cdecl CG_RegisterItems() { UNIMPLEMENTED(); }
...
void __cdecl CG_AddViewWeapon(struct playerState_s *ps) {
  ...
  if (*(float *)((char *)&loc_25C10 + (_DWORD)cg) == 0.0) {
    ...
    if (*(float *)((char *)&loc_25CA0 + (_DWORD)cg) < 1.0) {
      ...
      v67 =
          (float)((float)(1.0 - *(float *)((char *)&loc_25CA0 + (_DWORD)v13)) *
                  LeanFraction) *
          1.6;
...
int __cdecl CG_WeaponSelectable(int) { UNIMPLEMENTED(); }

void __cdecl CG_HoldBreathSoundLerp(float) { UNIMPLEMENTED(); }

void __cdecl CG_CalculateWeaponPostion_PositionToADS(void) { UNIMPLEMENTED(); }
...
void __cdecl CG_CalculateWeaponPosition(float *const) { UNIMPLEMENTED(); }

void __cdecl CG_CalculateWeaponPosition_Sway(void) { UNIMPLEMENTED(); }

void __cdecl CG_ParseWeaponDefFiles(char const **, int) { UNIMPLEMENTED(); }
...
void __cdecl CG_HoldBreathUpdate(void) { UNIMPLEMENTED(); }

void __cdecl CG_ProcessWeaponNoteTracks(void) { UNIMPLEMENTED(); }
...
void __cdecl CG_ChangeViewmodelDobj(int, char const *) { UNIMPLEMENTED(); }
