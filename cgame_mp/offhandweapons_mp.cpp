...
void __cdecl CG_SwitchOffHandCmd() { UNIMPLEMENTED(); }
  ...
  if (*((int *)cg + 38642) <= 5 &&
    ...
    if (v13 != 0.0) {
      ...
      if (NumWeapons <= 0) {
        ...
        *(_DWORD *)v14 = 0;
        do {
          if ((((int)v6[(v10 >> 5) + 38978] >> (v10 & 0x1F)) & 1) != 0 &&
      ...
      v11 = va("%i", *(_DWORD *)v14);
      UI_DrawText(v8, v11, 0x7FFFFFFF, a2, *(float *)&a1->x, *(float *)&a1->y,
                  a1->horzAlign, a1->vertAlign, a3);
    }
  }
}
...
void __cdecl CG_DrawOffHandHighlight(struct rectDef_s *rect, float scale,
  ...
  if (*((int *)cg + 38642) <= 5 &&
    ...
    if (v5[44956]) {
      ...
      v14 = floorf((float)(1000.0 * *(float *)(hud_fade_offhand + 8)) + 0.5);
      v17 = CG_FadeHudMenu(v6, v5[45428], (int)v14);
      if (v17 != 0.0 && a5 == *(_DWORD *)(BG_GetWeaponDef(v5[44956]) + 132)) {
        NumWeapons = BG_GetNumWeapons();
        if (NumWeapons <= 0)
          goto LABEL_16;
        v7 = 1;
        ...
        do {
          v8 = cg;
          if (((*((int *)cg + (v7 >> 5) + 38978) >> (v7 & 0x1F)) & 1) != 0 &&
        ...
        UI_DrawHandlePic(*(float *)&a1->x, *(float *)&a1->y, *(float *)&a1->w,
                         *(float *)&a1->h, a1->horzAlign, a1->vertAlign, v18,
                         a4);
      }
    }
  }
      ...
      if ((v11[0] = *a3, v11[1] = a3[1], v11[2] = a3[2], v5[44956]) &&
          ...
          (v7 = (const playerState_s *)((char *)cg + 154564),
           (FirstAvailableOffhand = BG_GetFirstAvailableOffhand(
                (const playerState_s *)((char *)cg + 154564), a5)) != 0) ||
          (FirstAvailableOffhand = BG_GetFirstEquippedOffhand(v7, a5)) != 0) {
        UI_DrawHandlePic(
            *(float *)&a1->x, *(float *)&a1->y, *(float *)&a1->w,
            *(float *)&a1->h, a1->horzAlign, a1->vertAlign, v11,
            *((Material **)cg_weapons + 109 * FirstAvailableOffhand + 78));
      }
    }
  }
}
...
void __cdecl CG_DrawOffHandName(struct rectDef_s *rect, struct Font_s *font,
  ...
  if (*((int *)cg + 38642) <= 5 &&
    ...
    if (v11 != 0.0) {
      ...
      UI_DrawText(v8, v9, 0x7FFFFFFF, a2, *(float *)&a1->x, *(float *)&a1->y,
                  a1->horzAlign, a1->vertAlign, a3);
    }
  }
}

void __cdecl CG_OffhandRegisterDvars() { UNIMPLEMENTED(); }
  ...
  if (result) {
    ...
    if (v5 == *(_DWORD *)(*((_DWORD *)cg + 9) + 216)) {
      ...
      if (ClientDObj && CG_DObjGetWorldTagPos(
                            a1, ClientDObj, (unsigned __int16)word_195B10C, v8))
        return CG_PlaySoundAlias(*(float **)a1->nextState, v8,
                                 *((snd_alias_list_t **)v3 + 55));
    }
...
bool __cdecl CG_IsOffHandDisplayVisible(void) { UNIMPLEMENTED(); }

int __cdecl CG_CalcOffHandAmmo(int) { UNIMPLEMENTED(); }

void __cdecl CG_OffHandFlash(float const *const, float *const) {
  UNIMPLEMENTED();
}

int __cdecl CG_GetBestOffhand(int) { UNIMPLEMENTED(); }
