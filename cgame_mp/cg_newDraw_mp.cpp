  ...
  v2 = ConfigString;
    ...
    if (*(_BYTE *)(loc_warnings + 8)) {
      if (*(_BYTE *)(loc_warningsAsErrors + 8))
        Com_Error(6, "Could not translate map location string \"%s\"",
                  (char)v2);
      else
        Com_Printf(
                          ...
                          int textStyle)
{
  ...
  v169.vertAlign = a7;
    ...
    case 6:
      ...
      v156 =
          floorf((float)(1000.0 * *(float *)(hud_fade_ammodisplay + 8)) + 0.5);
      v45 = v43[45426];
    ...
    case 79:
      ...
      *(float *)(HIDWORD(a15) + 12) = v25;
      ...
      LODWORD(v31) =
          ...
          (_mm_andnot_ps(v28, v20).u32[0] | v28.i32[0] & 0x3F800000) &
              v30.i32[0];
        if (v20.f32[0] > v24.f32[0]) {
          ...
          CL_DrawStretchPic(v32, v33, v34, v35, v169.horzAlign, v169.vertAlign,
                            0.0, 0.0, v20.f32[0], 1.0,
      ...
      v40 = *((float *)cg + 44930);
        if (v40 > v20.f32[0]) {
          ...
          *(_DWORD *)(HIDWORD(a15) + 8) = 0;
          CL_DrawStretchPic(v42, *(float *)&v169.y,
                            v41 * (float)(v40 - v20.f32[0]), *(float *)&v169.h,
                            v169.horzAlign, v169.vertAlign, v20.f32[0], 0.0,
                            v39[44930], 1.0, (const float *)HIDWORD(a15), a16);
        }
      return;
    case 80:
        ...
        if (v102) {
          ...
          v103 = v101[44948];
            if (v103 < 0 || v103 >= BG_GetNumWeapons() ||
                (v104 = v101[44948],
                 (((int)v101[(v104 >> 5) + 38978] >> (v101[44948] & 0x1F)) &
                  1) == 0)) {
            ...
            if (v104) {
              ...
              v107 = (float)((float)(*(float *)&v169.x + *(float *)&v169.w) -
                             (float)UI_TextWidth(a1, v106, 0, a14,
                                                 *(float *)&a15)) -
                     28.0;
        ...
        if (v112 != 0.0) {
          ...
          v114 = *((_DWORD *)cg + 44948);
            if (v114 < 0 || v114 >= BG_GetNumWeapons() ||
                (v115 = v113[44948],
                 (((int)v113[(v115 >> 5) + 38978] >> (v113[44948] & 0x1F)) &
                  1) == 0)) {
            ...
            if (v115) {
              ...
              if (**(_BYTE **)(BG_GetWeaponDef(v115) + 112))
                ...
                v117 = va("%s", v116[44]);
              v141 = (float)((float)UI_TextWidth(a1, v117, 0, a14,
                                                 *(float *)&a15) +
                             28.0) +
                     8.0;
              UI_DrawHandlePic(
                  (float)(*(float *)&v169.x + *(float *)&v169.w) - v141,
                  *(float *)&v169.y, v141, *(float *)&v169.h, v169.horzAlign,
                  v169.vertAlign, (float *)&v172, a16);
            }
        }
      return;
        ...
        if (v51 != 0.0) {
          ...
          v53 = *((_DWORD *)cg + 44948);
            if (v53 < 0 || v53 >= BG_GetNumWeapons() ||
                (v54 = v52[44948],
                 (((int)v52[(v54 >> 5) + 38978] >> (v52[44948] & 0x1F)) & 1) ==
                     0)) {
              v54 = *((_DWORD *)cg + 38694);
            }
          if (v54 && *((_DWORD *)cg_weapons + 109 * v54 + 79))
            UI_DrawHandlePic(*(float *)&v169.x, *(float *)&v169.y,
                             *(float *)&v169.w, *(float *)&v169.h,
                             v169.horzAlign, v169.vertAlign,
                             (float *)HIDWORD(a15),
    ...
    case 84:
      ...
      *(float *)(HIDWORD(a15) + 12) = v59;
        if (v59 != 0.0) {
          ...
          CG_DrawRotatedPic(*(float *)&v169.x,
                            *(float *)&v169.y - (float)((float)(v158 - 1.0) *
                                                        *(float *)&v169.h),
                            v158 * *(float *)&v169.w, *(float *)&v169.h * v158,
                            v169.horzAlign, v169.vertAlign,
                            *(float *)((char *)&loc_2C5B0 + (_DWORD)cg));
        }
      return;
    case 85:
    ...
    case 86:
      ...
      v160 = (float)((float)(*(float *)(cg_hudCompassSize + 8) *
                             *(float *)&v169.w) *
                     0.5) +
             *(float *)&v169.x;
      v161 =
          (float)((float)((float)(0.5 * *(float *)(cg_hudCompassSize + 8)) *
                          *(float *)&v169.h) -
                  (float)(*(float *)&v169.h *
                          (float)(*(float *)(cg_hudCompassSize + 8) - 1.0))) +
          *(float *)&v169.y;
                  ...
                  *((float *)&v172 + 1) = v70 - *((float *)cg + 41315);
                      ...
                      v123 = *(float *)(cg_hudObjectiveMaxRange + 8);
                        if (v72 < v123) {
                          ...
                          *((float *)&v171 + 1) =
                          ...
                          HIDWORD(v171) =
                              *(_DWORD *)(cg_hudObjectiveMinAlpha + 8);
                        }
                    }
                    else {
                  ...
                  v76 = v66[6];
                    if (v76 && (unsigned int)(v76 - 1) <= 0x7E &&
                        (ConfigString = CL_GetConfigString(v76 + 1566),
                         *ConfigString) &&
                  ...
                  v78 = _mm_cmplt_ss((__m128)LODWORD(v163),
                                     (__m128)HIDWORD(v171));
                  HIDWORD(v171) =
                      _mm_andnot_ps(v78, (__m128)HIDWORD(v171)).u32[0] |
                      LODWORD(v163) & v78.i32[0];
                  UI_DrawHandlePic((float)(v160 + (float)(v162 * -0.5)) -
                                       (float)(v148 * v159),
                                   (float)(v161 + (float)(v162 * -0.5)) -
                                       (float)(v153 * v159),
                                   v162, v162, v169.horzAlign, v169.vertAlign,
                                   (float *)&v170, v77);
                }
            }
        }
    ...
    case 94:
      CL_DrawStretchPic(*(float *)&v169.x, *(float *)&v169.y, *(float *)&v169.w,
                        *(float *)&v169.h, v169.horzAlign, a7, 0.0, 0.0, 1.0,
                        1.0, (const float *)HIDWORD(a15), a16);
      return;
    case 95:
      if (!*(_BYTE *)(cg_drawHealth + 8))
        return;
      v82 = (v79 = hud_fade_healthbar,
             v151 = floorf(
                 (float)(1000.0 * *(float *)(hud_fade_healthbar + 8)) + 0.5),
                ...
                if (*(_DWORD *)(*((_DWORD *)cg + 9) + 16) != 6) {
                  v89 = (float)v87 / (float)v88;
                    if (v89 >= 0.0) {
                        ...
                        if (*(float *)(hud_health_startpulse_critical + 8) >
                            v89) {
                          v150 = floorf(
                              (float)(1000.0 *
                                      *(float *)(hud_health_pulserate_critical +
                                                 8)) +
                              0.5);
                          v90 = (int)v150;
                        }
                        else {
                          if (*(float *)(hud_health_startpulse_injured + 8) <=
                              v89)
                            return;
                          v149 = floorf(
                              (float)(1000.0 *
                                      *(float *)(hud_health_pulserate_injured +
                                                 8)) +
                              0.5);
                          v90 = (int)v149;
                        }
                        if (v90) {
                          ...
                          *(float *)(HIDWORD(a15) + 12) = fminf(
                              v167, (float)(*(_DWORD *)((char *)&loc_2BDFC +
                                                        (_DWORD)cg) +
                                            v90 -
                                            *(_DWORD *)((char *)&loc_25BB0 +
                                                        (_DWORD)cg)) /
                                        (float)v90);
                          CL_DrawStretchPic(v165, v166, v84, v85,
                                            v169.horzAlign, v169.vertAlign, 0.0,
                                            0.0, 1.0, 1.0,
                                            (const float *)HIDWORD(a15), a16);
                        }
                    }
    ...
    case 109:
      ...
      v96 = *(_DWORD *)((char *)&loc_25BB0 + (_DWORD)cg) -
            *((_DWORD *)cg + 44933);
      if (v96 < 0)
        v96 = 0;
      ...
      if (v97 <= 0 || v96 >= v97)
        ...
        v98 =
            (float)((float)((float)v96 / (float)v97) *
                    (float)(*((float *)cg + 44932) - *((float *)cg + 44931))) +
            *((float *)cg + 44931);
      *(float *)(HIDWORD(a15) + 12) = v98;
      if (v98 != 0.0)
        CL_DrawStretchPic(*(float *)&v169.x, *(float *)&v169.y,
                          *(float *)&v169.w, *(float *)&v169.h, v169.horzAlign,
          ...
          *(_DWORD *)((char *)&locret_2BE1C + (_DWORD)v3) = 0;
          ...
          result = *(_DWORD *)((char *)&locret_2BE1C + (_DWORD)v3);
            ...
            case 1:
              ...
              v12.i32[0] =
                  _mm_andnot_ps(v12, v10).u32[0] | v12.i32[0] & 0x3F800000;
              v13 = 0;
              v13.f32[0] = 0.0 - v10.f32[0];
              v14 = _mm_cmplt_ss(v13, (__m128)0LL);
              v3[44932] = _mm_andnot_ps(v14, (__m128)0LL).u32[0] |
                          v12.i32[0] & v14.i32[0];
              result =
            ...
            case 2:
              ...
              v15.f32[0] =
                  v15.f32[0] *
                  *(float *)(hud_healthOverlay_phaseThree_toAlphaMultiplier +
                             8);
              v16 = v15;
              v16.f32[0] = v15.f32[0] - 1.0;
              v17 = _mm_cmpge_ss(v16, (__m128)0LL);
              v17.i32[0] =
                  _mm_andnot_ps(v17, v15).u32[0] | v17.i32[0] & 0x3F800000;
              v18 = 0;
              v18.f32[0] = 0.0 - v15.f32[0];
              v19 = _mm_cmplt_ss(v18, (__m128)0LL);
              v3[44932] = _mm_andnot_ps(v19, (__m128)0LL).u32[0] |
                          v17.i32[0] & v19.i32[0];
              ...
              *(_DWORD *)((char *)&locret_2BE1C + (_DWORD)v3) = 0;
              result =
                ...
                if (*(_DWORD *)((char *)&loc_25BB0 + (_DWORD)v3) >=
                    *(_DWORD *)(hud_healthOverlay_regenPauseTime + 8) +
                        v3[44937] - result) {
                  result = v4 + 1;
                  v3[44939] = v4 + 1;
                }
    ...
    if (*(_BYTE *)(cg_hudStanceHintPrints + 8) &&
      ...
      v45 = (float)((float)(*(float *)&a1->h * 0.5) + *(float *)&a1->y) - 1.5;
        if (v43 == 1) {
          ...
          v45 = (float)((float)((float)(*(float *)&a1->h * 0.5) +
                                *(float *)&a1->y) -
                        1.5) -
        ...
        for (j = 1; j != 4; ++j) {
          v31 = *(char **)&v56[4 * j - 4];
            if (v31) {
              ...
              UI_DrawText(v4, v33, 0x7FFFFFFF, (Font_s *)a3,
                          v39 + *(float *)&a1->w, v45, a1->horzAlign,
                          a1->vertAlign, *((float *)&a3 + 1));
  ...
  result = *(_DWORD *)((char *)&loc_2BE38 + (_DWORD)cg) + 1000;
    if (result > *(_DWORD *)((char *)&loc_25BB0 + (_DWORD)cg)) {
      ...
      __src[0] = COERCE_CHAR_(fminf(
          v41, (float)((float)(*(_DWORD *)((char *)&loc_2BE38 + (_DWORD)v16) -
                               *(_DWORD *)((char *)&loc_25BB0 + (_DWORD)v16) +
                               1000) /
                       1000.0) *
                   0.80000001));
