...
float *__cdecl CG_TeamColor(int) { UNIMPLEMENTED(); }
...
bool __cdecl CG_IsFullViewportRendering(void) { UNIMPLEMENTED(); }

void __cdecl CG_ColorForHealth(float *const) { UNIMPLEMENTED(); }

void __cdecl CG_GetColorForHealth(int, int, float *const) { UNIMPLEMENTED(); }
...
void __cdecl CG_UpdateCompassOrientation() {
  ...
  *(_DWORD *)((char *)&loc_2C5A8 + (_DWORD)v0) = v2;
  ...
  LABEL_20:
    v15 = cg;
    *(float *)((char *)&loc_2C5B0 + (_DWORD)v15) = AngleNormalize360(v4 + v18);
    return;
  }
  while (v3 <= 5) {
    v5 = (float)v3;
  ...
  LABEL_9:
    v17 = AngleNormalize180(
        (float)(v6.f32[0] * *(float *)((char *)&loc_2C5B4 + (_DWORD)v8)) + v4);
    v4 = v17;
    v6 = (__m128)v6.u32[0];
    if (v17 <= 0.0) {
      if (v17 < 0.0) {
...
void __cdecl CG_TileClear() { UNIMPLEMENTED(); }
